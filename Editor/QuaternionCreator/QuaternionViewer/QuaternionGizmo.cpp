...
QuaternionGizmo::QuaternionGizmo(void): segments(360), scale(1.51f), xAxisArrow(NIL), yAxisArrow(NIL), zAxisArrow(NIL), font(NIL), showGlobalSpins(true), showGlobalAxises(true)
{
...
void QuaternionGizmo::ShowGlobalSpins(int _state)
{
	showGlobalSpins = _state;
}


void QuaternionGizmo::ShowGlobalAxises(int _state)
{
	showGlobalAxises = _state;
}


QuaternionGizmo::~QuaternionGizmo(void)
{
	delete font; 
...
RGBA QuaternionGizmo::GetXColor(void)const
{
	return xColor;
}


RGBA QuaternionGizmo::GetYColor(void)const
{
	return yColor;
}


RGBA QuaternionGizmo::GetZColor(void)const
{
	return zColor;
}


void QuaternionGizmo::SetRotationMode(RotationMode _mode)
{
	rotationMode = _mode;
}


QuaternionGizmo::RotationMode QuaternionGizmo::GetRotationMode(void)const
{
	return rotationMode;
}


StringANSI QuaternionGizmo::GetRotationModeString(void)const
{
	switch(rotationMode)
	{
...
Quaternion QuaternionGizmo::GetQuaternion(void)const
{ 
	return quaternion;
}
...
void QuaternionGizmo::DrawXAxis(void)
{
...
void QuaternionGizmo::DrawYAxis(void)
{
...
void QuaternionGizmo::DrawZAxis(void)
{
...
void QuaternionGizmo::Draw(void)
{
	if(IsShowEnabled())
	{
		BeginTransform();
...
bool QuaternionGizmo::LoadFromFile(StringANSI _path, bool _auto)
{
	return false;
}


bool QuaternionGizmo::LoadFromFile(File& _file)
{
	return false;
}