#ifndef ACTIVATABLEOBJECTEDITOR_H
#define ACTIVATABLEOBJECTEDITOR_H
...
class ActivatableObjectEditor: public QWidget
{
	Q_OBJECT
    ...
    public: ActivatableObjectEditor(QWidget* _parent = 0);
