#include "TranslatableObjectEditor.h"
...
TranslatableObjectEditor::TranslatableObjectEditor(QWidget* _parent): QWidget(_parent)
{
...
void TranslatableObjectEditor::FocusOut(void)
{
	emit FocusOut(this);
}
...
void TranslatableObjectEditor::SetFileName(QString _fileName)
{
	fileNameEdit->setText(_fileName);
}


QString TranslatableObjectEditor::GetFileName(void)const
{
	return fileNameEdit->text();
}


void TranslatableObjectEditor::NameIsChanged(QString _name)
{
...
void TranslatableObjectEditor::OpenFinder(void)
{
	QFileDialog dialog(this, "Choose translatable object");
...
void TranslatableObjectEditor::CheckArg(void)
{
...
void TranslatableObjectEditor::CreateObject(void)
{  
...
void TranslatableObjectEditor::EditVariable(void)
{
	StringANSI name = fileNameEdit->text().toStdString();
...
void TranslatableObjectEditor::_SetLineEditTextFormat(QLineEdit* _lineEdit, const QList<QTextLayout::FormatRange>& _formats)
{
    if(_lineEdit)
	{
...
void TranslatableObjectEditor::_ClearLineEditTextFormat(QLineEdit* _lineEdit)
{
...
void TranslatableObjectEditor::resizeEvent(QResizeEvent* _event)
{
