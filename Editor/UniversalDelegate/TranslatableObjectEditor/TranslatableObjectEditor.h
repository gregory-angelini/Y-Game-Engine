#ifndef TRANSLATABLEOBJECTEDITOR_H
#define TRANSLATABLEOBJECTEDITOR_H
...
class TranslatableObjectEditor: public QWidget
{
	Q_OBJECT
    ...
    public: TranslatableObjectEditor(QWidget* _parent = 0);
