#include "ColorableObjectEditor.h"
...
ColorableObjectEditor::ColorableObjectEditor(QWidget* _parent): QWidget(_parent)
{
...
void ColorableObjectEditor::FocusOut(void)
{
	emit FocusOut(this);
}
...
void ColorableObjectEditor::SetFileName(QString _fileName)
{
	fileNameEdit->setText(_fileName);
}


QString ColorableObjectEditor::GetFileName(void)const
{
	return fileNameEdit->text();
}


void ColorableObjectEditor::NameIsChanged(QString _name)
{
...
void ColorableObjectEditor::OpenFinder(void)
{
	QFileDialog dialog(this, "Choose colorable object");
...
void ColorableObjectEditor::CheckArg(void)
{
...
void ColorableObjectEditor::CreateObject(void)
{  
...
void ColorableObjectEditor::EditVariable(void)
{
	StringANSI name = fileNameEdit->text().toStdString();
...
void ColorableObjectEditor::_SetLineEditTextFormat(QLineEdit* _lineEdit, const QList<QTextLayout::FormatRange>& _formats)
{
    if(_lineEdit)
	{
...
void ColorableObjectEditor::_ClearLineEditTextFormat(QLineEdit* _lineEdit)
{
...
void ColorableObjectEditor::resizeEvent(QResizeEvent* _event)
{
