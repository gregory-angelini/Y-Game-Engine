...
void EventTableWidget::CHANGE_PLAYING_MODE_GetEditorTypeForCell(const QModelIndex& _index, const QString& _eventType, int& _editor)
{
	if(_eventType == "CHANGE_PLAYING_MODE")
	{
...
bool EventTableWidget::CHANGE_PLAYING_MODE_UpdateRow(const QModelIndex& _index, const QString& _type)
{
...
QString EventTableWidget::CHANGE_PLAYING_MODE_CreateAutoName(void)
{
...
bool EventTableWidget::CHANGE_PLAYING_MODE_UpdateSourceVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_PLAYING_MODE")
	{ 
...
bool EventTableWidget::CHANGE_PLAYING_MODE_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_PLAYING_MODE")
	{
...
void EventTableWidget::CHANGE_PLAYING_MODE_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_PLAYING_MODE")
	{
...
void EventCreator::CHANGE_PLAYING_MODE_SetEvent(int _eventType)
{
	if(_eventType == PlayingObject::CHANGE_PLAYING_MODE_MESSAGE)
	{
		eventTable->SetCellText(EventTableWidget::TYPE_PROPERTY, EventTableWidget::VALUE, "CHANGE_PLAYING_MODE");

		ChangePlayingModeEvent* derived = dynamic_cast<ChangePlayingModeEvent*>(event);
...
void EventCreator::CHANGE_PLAYING_MODE_Create(void)
{
	if(eventTable->GetCellText(EventTableWidget::TYPE_PROPERTY, EventTableWidget::VALUE) == "CHANGE_PLAYING_MODE")
	{
		event = Trigger::_CreateEvent(PlayingObject::CHANGE_PLAYING_MODE_MESSAGE);
