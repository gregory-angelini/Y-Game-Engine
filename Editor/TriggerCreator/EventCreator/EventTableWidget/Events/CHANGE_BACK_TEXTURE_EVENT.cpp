...
void EventTableWidget::CHANGE_BACK_TEXTURE_GetEditorTypeForCell(const QModelIndex& _index, const QString& _eventType, int& _editor)
{
	if(_eventType == "CHANGE_BACK_TEXTURE")
	{
...
bool EventTableWidget::CHANGE_BACK_TEXTURE_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "CHANGE_BACK_TEXTURE") 
	{
...
QString EventTableWidget::CHANGE_BACK_TEXTURE_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BACK_TEXTURE")
	{ 
		QString name;
...
bool EventTableWidget::CHANGE_BACK_TEXTURE_UpdateSourceVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BACK_TEXTURE")
	{ 
...
bool EventTableWidget::CHANGE_BACK_TEXTURE_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BACK_TEXTURE")
	{
...
void EventTableWidget::CHANGE_BACK_TEXTURE_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BACK_TEXTURE")
	{
...
void EventCreator::CHANGE_BACK_TEXTURE_SetEvent(int _eventType)
{
	if(_eventType == TexturingSurface::CHANGE_BACK_TEXTURE_MESSAGE)
	{
		eventTable->SetCellText(EventTableWidget::TYPE_PROPERTY, EventTableWidget::VALUE, "CHANGE_BACK_TEXTURE");

		ChangeBackTextureEvent* derived = dynamic_cast<ChangeBackTextureEvent*>(event);
...
void EventCreator::CHANGE_BACK_TEXTURE_Create(void)
{
	if(eventTable->GetCellText(EventTableWidget::TYPE_PROPERTY, EventTableWidget::VALUE) == "CHANGE_BACK_TEXTURE")
	{
		event = Trigger::_CreateEvent(TexturingSurface::CHANGE_BACK_TEXTURE_MESSAGE);
