...
void EventTableWidget::ADD_TO_RENDER_LIST_GetEditorTypeForCell(const QModelIndex& _index, const QString& _eventType, int& _editor)
{
	if(_eventType == "ADD_TO_RENDER_LIST")
	{
...
bool EventTableWidget::ADD_TO_RENDER_LIST_UpdateRow(const QModelIndex& _index, const QString& _type)
{
...
QString EventTableWidget::ADD_TO_RENDER_LIST_CreateAutoName(void)
{
...
bool EventTableWidget::ADD_TO_RENDER_LIST_UpdateSourceVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ADD_TO_RENDER_LIST")
	{ 
...
bool EventTableWidget::ADD_TO_RENDER_LIST_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ADD_TO_RENDER_LIST")
	{
...
void EventTableWidget::ADD_TO_RENDER_LIST_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ADD_TO_RENDER_LIST")
	{
...
void EventCreator::ADD_TO_RENDER_LIST_SetEvent(int _eventType)
{
	if(_eventType == GraphicsScene::ADD_TO_RENDER_LIST_MESSAGE)
	{
		eventTable->SetCellText(EventTableWidget::TYPE_PROPERTY, EventTableWidget::VALUE, "ADD_TO_RENDER_LIST");

		AddToRenderListEvent* derived = dynamic_cast<AddToRenderListEvent*>(event);
...
void EventCreator::ADD_TO_RENDER_LIST_Create(void)
{
	if(eventTable->GetCellText(EventTableWidget::TYPE_PROPERTY, EventTableWidget::VALUE) == "ADD_TO_RENDER_LIST")
	{
		event = Trigger::_CreateEvent(GraphicsScene::ADD_TO_RENDER_LIST_MESSAGE);
