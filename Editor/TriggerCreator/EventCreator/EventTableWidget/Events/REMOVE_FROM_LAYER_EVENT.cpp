...
void EventTableWidget::REMOVE_FROM_LAYER_GetEditorTypeForCell(const QModelIndex& _index, const QString& _eventType, int& _editor)
{
	if(_eventType == "REMOVE_FROM_LAYER")
	{
...
bool EventTableWidget::REMOVE_FROM_LAYER_UpdateRow(const QModelIndex& _index, const QString& _type)
{
...
QString EventTableWidget::REMOVE_FROM_LAYER_CreateAutoName(void)
{
...
bool EventTableWidget::REMOVE_FROM_LAYER_UpdateSourceVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "REMOVE_FROM_LAYER")
	{ 
...
bool EventTableWidget::REMOVE_FROM_LAYER_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "REMOVE_FROM_LAYER")
	{
...
void EventTableWidget::REMOVE_FROM_LAYER_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "REMOVE_FROM_LAYER")
	{
...
void EventCreator::REMOVE_FROM_LAYER_SetEvent(int _eventType)
{
	if(_eventType == ObjectScene::REMOVE_FROM_LAYER_MESSAGE)
	{
		eventTable->SetCellText(EventTableWidget::TYPE_PROPERTY, EventTableWidget::VALUE, "REMOVE_FROM_LAYER");

		RemoveFromLayerEvent* derived = dynamic_cast<RemoveFromLayerEvent*>(event);
...
void EventCreator::REMOVE_FROM_LAYER_Create(void)
{
	if(eventTable->GetCellText(EventTableWidget::TYPE_PROPERTY, EventTableWidget::VALUE) == "REMOVE_FROM_LAYER")
	{
		event = Trigger::_CreateEvent(ObjectScene::REMOVE_FROM_LAYER_MESSAGE);
