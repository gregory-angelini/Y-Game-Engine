...
void EventTableWidget::CHANGE_ATLAS_GetEditorTypeForCell(const QModelIndex& _index, const QString& _eventType, int& _editor)
{
	if(_eventType == "CHANGE_ATLAS")
	{
...
bool EventTableWidget::CHANGE_ATLAS_UpdateRow(const QModelIndex& _index, const QString& _type)
{
...
QString EventTableWidget::CHANGE_ATLAS_CreateAutoName(void)
{
...
bool EventTableWidget::CHANGE_ATLAS_UpdateSourceVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_ATLAS")
	{ 
...
bool EventTableWidget::CHANGE_ATLAS_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_ATLAS")
	{
...
void EventTableWidget::CHANGE_ATLAS_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_ATLAS")
	{
...
void EventCreator::CHANGE_ATLAS_SetEvent(int _eventType)
{
	if(_eventType == TexturedAnimation::CHANGE_ATLAS_MESSAGE)
	{
		eventTable->SetCellText(EventTableWidget::TYPE_PROPERTY, EventTableWidget::VALUE, "CHANGE_ATLAS");

		ChangeAtlasEvent* derived = dynamic_cast<ChangeAtlasEvent*>(event);
...
void EventCreator::CHANGE_ATLAS_Create(void)
{
	if(eventTable->GetCellText(EventTableWidget::TYPE_PROPERTY, EventTableWidget::VALUE) == "CHANGE_ATLAS")
	{
		event = Trigger::_CreateEvent(TexturedAnimation::CHANGE_ATLAS_MESSAGE);
