...
void EventTableWidget::ADD_TO_UPDATE_LIST_GetEditorTypeForCell(const QModelIndex& _index, const QString& _eventType, int& _editor)
{
	if(_eventType == "ADD_TO_UPDATE_LIST")
	{
...
bool EventTableWidget::ADD_TO_UPDATE_LIST_UpdateRow(const QModelIndex& _index, const QString& _type)
{
...
QString EventTableWidget::ADD_TO_UPDATE_LIST_CreateAutoName(void)
{
...
bool EventTableWidget::ADD_TO_UPDATE_LIST_UpdateSourceVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ADD_TO_UPDATE_LIST")
	{ 
...
bool EventTableWidget::ADD_TO_UPDATE_LIST_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ADD_TO_UPDATE_LIST")
	{
...
void EventTableWidget::ADD_TO_UPDATE_LIST_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ADD_TO_UPDATE_LIST")
	{
...
void EventCreator::ADD_TO_UPDATE_LIST_SetEvent(int _eventType)
{
	if(_eventType == LogicScene::ADD_TO_UPDATE_LIST_MESSAGE)
	{
		eventTable->SetCellText(EventTableWidget::TYPE_PROPERTY, EventTableWidget::VALUE, "ADD_TO_UPDATE_LIST");

		AddToUpdateListEvent* derived = dynamic_cast<AddToUpdateListEvent*>(event);
...
void EventCreator::ADD_TO_UPDATE_LIST_Create(void)
{
	if(eventTable->GetCellText(EventTableWidget::TYPE_PROPERTY, EventTableWidget::VALUE) == "ADD_TO_UPDATE_LIST")
	{
		event = Trigger::_CreateEvent(LogicScene::ADD_TO_UPDATE_LIST_MESSAGE);
