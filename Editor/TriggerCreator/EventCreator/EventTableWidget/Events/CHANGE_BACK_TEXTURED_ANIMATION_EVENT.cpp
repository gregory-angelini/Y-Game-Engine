...
void EventTableWidget::CHANGE_BACK_TEXTURED_ANIMATION_GetEditorTypeForCell(const QModelIndex& _index, const QString& _eventType, int& _editor)
{
	if(_eventType == "CHANGE_BACK_TEXTURED_ANIMATION")
	{
...
bool EventTableWidget::CHANGE_BACK_TEXTURED_ANIMATION_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "CHANGE_BACK_TEXTURED_ANIMATION") 
	{
...
QString EventTableWidget::CHANGE_BACK_TEXTURED_ANIMATION_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BACK_TEXTURED_ANIMATION")
	{ 
		QString name;
...
bool EventTableWidget::CHANGE_BACK_TEXTURED_ANIMATION_UpdateSourceVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BACK_TEXTURED_ANIMATION")
	{ 
...
bool EventTableWidget::CHANGE_BACK_TEXTURED_ANIMATION_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BACK_TEXTURED_ANIMATION")
	{
...
void EventTableWidget::CHANGE_BACK_TEXTURED_ANIMATION_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BACK_TEXTURED_ANIMATION")
	{
...
void EventCreator::CHANGE_BACK_TEXTURED_ANIMATION_SetEvent(int _eventType)
{
	if(_eventType == TexturingSurface::CHANGE_BACK_TEXTURED_ANIMATION_MESSAGE)
	{
		eventTable->SetCellText(EventTableWidget::TYPE_PROPERTY, EventTableWidget::VALUE, "CHANGE_BACK_TEXTURED_ANIMATION");

		ChangeBackTexturedAnimationEvent* derived = dynamic_cast<ChangeBackTexturedAnimationEvent*>(event);
...
void EventCreator::CHANGE_BACK_TEXTURED_ANIMATION_Create(void)
{
	if(eventTable->GetCellText(EventTableWidget::TYPE_PROPERTY, EventTableWidget::VALUE) == "CHANGE_BACK_TEXTURED_ANIMATION")
	{
		event = Trigger::_CreateEvent(TexturingSurface::CHANGE_BACK_TEXTURED_ANIMATION_MESSAGE);
