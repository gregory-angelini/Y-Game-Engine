...
void ActionTableWidget::ADD_TO_LAYER_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "ADD_TO_LAYER")
	{
...
bool ActionTableWidget::ADD_TO_LAYER_UpdateRow(const QModelIndex& _index, const QString& _type)
{
...
QString ActionTableWidget::ADD_TO_LAYER_CreateAutoName(void)
{
...
bool ActionTableWidget::ADD_TO_LAYER_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ADD_TO_LAYER")
	{ 
...
bool ActionTableWidget::ADD_TO_LAYER_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ADD_TO_LAYER")
	{
...
void ActionTableWidget::ADD_TO_LAYER_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ADD_TO_LAYER")
	{
...
void ActionCreator::ADD_TO_LAYER_SetAction(int _actionType)
{
	if(_actionType == ObjectScene::ADD_TO_LAYER_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "ADD_TO_LAYER");

		AddToLayerAction* derived = dynamic_cast<AddToLayerAction*>(action);
...
void ActionCreator::ADD_TO_LAYER_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "ADD_TO_LAYER")
	{
		action = Trigger::_CreateAction(ObjectScene::ADD_TO_LAYER_MESSAGE);
