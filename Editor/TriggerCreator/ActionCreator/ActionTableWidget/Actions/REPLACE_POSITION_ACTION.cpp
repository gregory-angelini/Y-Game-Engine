...
void ActionTableWidget::REPLACE_POSITION_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "REPLACE_POSITION")
	{
...
bool ActionTableWidget::REPLACE_POSITION_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "REPLACE_POSITION") 
	{
...
QString ActionTableWidget::REPLACE_POSITION_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "REPLACE_POSITION")
	{ 
		QString name;
...
bool ActionTableWidget::REPLACE_POSITION_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "REPLACE_POSITION")
	{ 
...
bool ActionTableWidget::REPLACE_POSITION_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "REPLACE_POSITION")
	{
...
void ActionTableWidget::REPLACE_POSITION_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "REPLACE_POSITION")
	{
...
void ActionCreator::REPLACE_POSITION_SetAction(int _actionType)
{
	if(_actionType == TranslatableObject::REPLACE_POSITION_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "REPLACE_POSITION");

		ReplacePositionAction* derived = dynamic_cast<ReplacePositionAction*>(action);
...
void ActionCreator::REPLACE_POSITION_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "REPLACE_POSITION")
	{
		action = Trigger::_CreateAction(TranslatableObject::REPLACE_POSITION_MESSAGE);
