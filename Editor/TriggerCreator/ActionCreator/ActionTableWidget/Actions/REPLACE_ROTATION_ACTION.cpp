...
void ActionTableWidget::REPLACE_ROTATION_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "REPLACE_ROTATION")
	{
...
bool ActionTableWidget::REPLACE_ROTATION_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "REPLACE_ROTATION") 
	{
...
QString ActionTableWidget::REPLACE_ROTATION_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "REPLACE_ROTATION")
	{ 
		QString name;
...
bool ActionTableWidget::REPLACE_ROTATION_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "REPLACE_ROTATION")
	{ 
...
bool ActionTableWidget::REPLACE_ROTATION_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "REPLACE_ROTATION")
	{
...
void ActionTableWidget::REPLACE_ROTATION_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "REPLACE_ROTATION")
	{
...
void ActionCreator::REPLACE_ROTATION_SetAction(int _actionType)
{
	if(_actionType == RotatableObject::REPLACE_ROTATION_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "REPLACE_ROTATION");

		ReplaceRotationAction* derived = dynamic_cast<ReplaceRotationAction*>(action);
...
void ActionCreator::REPLACE_ROTATION_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "REPLACE_ROTATION")
	{
		action = Trigger::_CreateAction(RotatableObject::REPLACE_ROTATION_MESSAGE);
