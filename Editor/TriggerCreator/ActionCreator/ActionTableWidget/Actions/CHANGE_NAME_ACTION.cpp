...
void ActionTableWidget::CHANGE_NAME_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "CHANGE_NAME")
	{
...
bool ActionTableWidget::CHANGE_NAME_UpdateRow(const QModelIndex& _index, const QString& _type)
{
...
QString ActionTableWidget::CHANGE_NAME_CreateAutoName(void)
{
...
bool ActionTableWidget::CHANGE_NAME_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_NAME")
	{ 
...
bool ActionTableWidget::CHANGE_NAME_UpdateArg1KeyPropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_NAME")
	{  
...
bool ActionTableWidget::CHANGE_NAME_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_NAME")
	{
...
void ActionTableWidget::CHANGE_NAME_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_NAME")
	{
...
void ActionCreator::CHANGE_NAME_SetAction(int _actionType)
{
	if(_actionType == AbstractObject::CHANGE_NAME_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "CHANGE_NAME");

		ChangeNameAction* derived = dynamic_cast<ChangeNameAction*>(action);
...
void ActionCreator::CHANGE_NAME_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "CHANGE_NAME")
	{
		action = Trigger::_CreateAction(AbstractObject::CHANGE_NAME_MESSAGE);
