...
void ActionTableWidget::CHANGE_CAMERA_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "CHANGE_CAMERA")
	{
...
bool ActionTableWidget::CHANGE_CAMERA_UpdateRow(const QModelIndex& _index, const QString& _type)
{
...
QString ActionTableWidget::CHANGE_CAMERA_CreateAutoName(void)
{
...
bool ActionTableWidget::CHANGE_CAMERA_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_CAMERA")
	{ 
...
bool ActionTableWidget::CHANGE_CAMERA_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_CAMERA")
	{
...
void ActionTableWidget::CHANGE_CAMERA_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_CAMERA")
	{
...
void ActionCreator::CHANGE_CAMERA_SetAction(int _actionType)
{
	if(_actionType == GraphicsContainer::CHANGE_CAMERA_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "CHANGE_CAMERA");

		ChangeCameraAction* derived = dynamic_cast<ChangeCameraAction*>(action);
...
void ActionCreator::CHANGE_CAMERA_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "CHANGE_CAMERA")
	{
		action = Trigger::_CreateAction(GraphicsContainer::CHANGE_CAMERA_MESSAGE);
