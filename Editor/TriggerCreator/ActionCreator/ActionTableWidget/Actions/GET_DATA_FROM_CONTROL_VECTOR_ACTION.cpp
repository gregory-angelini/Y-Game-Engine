...
void ActionTableWidget::GET_DATA_FROM_CONTROL_VECTOR_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "GET_DATA_FROM_CONTROL_VECTOR")
	{
...
bool ActionTableWidget::GET_DATA_FROM_CONTROL_VECTOR_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "GET_DATA_FROM_CONTROL_VECTOR") 
	{
...
QString ActionTableWidget::GET_DATA_FROM_CONTROL_VECTOR_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_DATA_FROM_CONTROL_VECTOR")
	{ 
		QString name;
...
bool ActionTableWidget::GET_DATA_FROM_CONTROL_VECTOR_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_DATA_FROM_CONTROL_VECTOR")
	{ 
...
bool ActionTableWidget::GET_DATA_FROM_CONTROL_VECTOR_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_DATA_FROM_CONTROL_VECTOR")
	{
...
bool ActionTableWidget::GET_DATA_FROM_CONTROL_VECTOR_UpdateArg2PropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_DATA_FROM_CONTROL_VECTOR")
	{ 
...
bool ActionTableWidget::GET_DATA_FROM_CONTROL_VECTOR_UpdateArg3VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_DATA_FROM_CONTROL_VECTOR")
	{
		if(item(ARG2_PROPERTY, VALUE)->text() == "TRANSLATABLE_OBJECT")
...
void ActionTableWidget::GET_DATA_FROM_CONTROL_VECTOR_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_DATA_FROM_CONTROL_VECTOR")
	{
...
void ActionCreator::GET_DATA_FROM_CONTROL_VECTOR_SetAction(int _actionType)
{
	if(_actionType == VectorLerp::GET_DATA_FROM_CONTROL_VECTOR_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_DATA_FROM_CONTROL_VECTOR");

		GetDataFromControlVectorAction* derived = dynamic_cast<GetDataFromControlVectorAction*>(action);
	...
	else if(_actionType == VectorLerp::GET_DATA_FROM_CONTROL_TRANSLATABLE_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_DATA_FROM_CONTROL_VECTOR");

		GetDataFromControlTranslatableAction* derived = dynamic_cast<GetDataFromControlTranslatableAction*>(action);
	...
	else if(_actionType == VectorLerp::GET_DATA_FROM_CONTROL_SCALABLE_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_DATA_FROM_CONTROL_VECTOR");

		GetDataFromControlScalableAction* derived = dynamic_cast<GetDataFromControlScalableAction*>(action);
	...
	else if(_actionType == VectorLerp::GET_DATA_FROM_CONTROL_COLORABLE_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_DATA_FROM_CONTROL_VECTOR");

		GetDataFromControlColorableAction* derived = dynamic_cast<GetDataFromControlColorableAction*>(action);
...
void ActionCreator::GET_DATA_FROM_CONTROL_VECTOR_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "GET_DATA_FROM_CONTROL_VECTOR")
	{
		if(actionTable->GetCellText(ActionTableWidget::ARG2_PROPERTY, ActionTableWidget::VALUE) == "VECTOR_3")
		{
			action = Trigger::_CreateAction(VectorLerp::GET_DATA_FROM_CONTROL_VECTOR_MESSAGE);
		...
		{  
			action = Trigger::_CreateAction(VectorLerp::GET_DATA_FROM_CONTROL_TRANSLATABLE_MESSAGE);
		...
		{  
			action = Trigger::_CreateAction(VectorLerp::GET_DATA_FROM_CONTROL_SCALABLE_MESSAGE);
		...
		{  
			action = Trigger::_CreateAction(VectorLerp::GET_DATA_FROM_CONTROL_COLORABLE_MESSAGE);
