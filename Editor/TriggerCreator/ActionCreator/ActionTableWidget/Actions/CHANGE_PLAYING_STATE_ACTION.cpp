...
void ActionTableWidget::CHANGE_PLAYING_STATE_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "CHANGE_PLAYING_STATE")
	{
...
bool ActionTableWidget::CHANGE_PLAYING_STATE_UpdateRow(const QModelIndex& _index, const QString& _type)
{
...
QString ActionTableWidget::CHANGE_PLAYING_STATE_CreateAutoName(void)
{
...
bool ActionTableWidget::CHANGE_PLAYING_STATE_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_PLAYING_STATE")
	{ 
...
bool ActionTableWidget::CHANGE_PLAYING_STATE_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_PLAYING_STATE")
	{
...
void ActionTableWidget::CHANGE_PLAYING_STATE_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_PLAYING_STATE")
	{
...
void ActionCreator::CHANGE_PLAYING_STATE_SetAction(int _actionType)
{
	if(_actionType == PlayingObject::CHANGE_PLAYING_STATE_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "CHANGE_PLAYING_STATE");

		ChangePlayingStateAction* derived = dynamic_cast<ChangePlayingStateAction*>(action);
...
void ActionCreator::CHANGE_PLAYING_STATE_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "CHANGE_PLAYING_STATE")
	{
		action = Trigger::_CreateAction(PlayingObject::CHANGE_PLAYING_STATE_MESSAGE);
