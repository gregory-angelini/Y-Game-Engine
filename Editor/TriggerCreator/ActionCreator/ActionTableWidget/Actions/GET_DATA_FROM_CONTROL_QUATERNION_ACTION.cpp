...
void ActionTableWidget::GET_DATA_FROM_CONTROL_QUATERNION_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "GET_DATA_FROM_CONTROL_QUATERNION")
	{
...
bool ActionTableWidget::GET_DATA_FROM_CONTROL_QUATERNION_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "GET_DATA_FROM_CONTROL_QUATERNION") 
	{
...
QString ActionTableWidget::GET_DATA_FROM_CONTROL_QUATERNION_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_DATA_FROM_CONTROL_QUATERNION")
	{ 
		QString name;
...
bool ActionTableWidget::GET_DATA_FROM_CONTROL_QUATERNION_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_DATA_FROM_CONTROL_QUATERNION")
	{ 
...
bool ActionTableWidget::GET_DATA_FROM_CONTROL_QUATERNION_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_DATA_FROM_CONTROL_QUATERNION")
	{
...
bool ActionTableWidget::GET_DATA_FROM_CONTROL_QUATERNION_UpdateArg2PropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_DATA_FROM_CONTROL_QUATERNION")
	{ 
...
bool ActionTableWidget::GET_DATA_FROM_CONTROL_QUATERNION_UpdateArg3VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_DATA_FROM_CONTROL_QUATERNION")
	{
		if(item(ARG2_PROPERTY, VALUE)->text() == "ROTATABLE_OBJECT")
...
void ActionTableWidget::GET_DATA_FROM_CONTROL_QUATERNION_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_DATA_FROM_CONTROL_QUATERNION")
	{
...
void ActionCreator::GET_DATA_FROM_CONTROL_QUATERNION_SetAction(int _actionType)
{
	if(_actionType == QuaternionLerp::GET_DATA_FROM_CONTROL_QUATERNION_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_DATA_FROM_CONTROL_QUATERNION");

		GetDataFromControlQuaternionAction* derived = dynamic_cast<GetDataFromControlQuaternionAction*>(action);
	...
	else if(_actionType == QuaternionLerp::GET_DATA_FROM_CONTROL_ROTATABLE_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_DATA_FROM_CONTROL_QUATERNION");

		GetDataFromControlRotatableAction* derived = dynamic_cast<GetDataFromControlRotatableAction*>(action);
...
void ActionCreator::GET_DATA_FROM_CONTROL_QUATERNION_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "GET_DATA_FROM_CONTROL_QUATERNION")
	{
		if(actionTable->GetCellText(ActionTableWidget::ARG2_PROPERTY, ActionTableWidget::VALUE) == "QUATERNION")
		{
			action = Trigger::_CreateAction(QuaternionLerp::GET_DATA_FROM_CONTROL_QUATERNION_MESSAGE);
		...
		{  
			action = Trigger::_CreateAction(QuaternionLerp::GET_DATA_FROM_CONTROL_ROTATABLE_MESSAGE);
