...
void ActionTableWidget::GET_LINE_ANGLE_Z_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "GET_LINE_ANGLE_Z")
	{
...
bool ActionTableWidget::GET_LINE_ANGLE_Z_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "GET_LINE_ANGLE_Z") 
	{
...
QString ActionTableWidget::GET_LINE_ANGLE_Z_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_LINE_ANGLE_Z")
	{ 
		QString name;
...
bool ActionTableWidget::GET_LINE_ANGLE_Z_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_LINE_ANGLE_Z")
	{
...
bool ActionTableWidget::GET_LINE_ANGLE_Z_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_LINE_ANGLE_Z")
	{
...
bool ActionTableWidget::GET_LINE_ANGLE_Z_UpdateArg3VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_LINE_ANGLE_Z")
	{
...
void ActionTableWidget::GET_LINE_ANGLE_Z_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_LINE_ANGLE_Z")
	{
...
void ActionCreator::GET_LINE_ANGLE_Z_SetAction(int _actionType)
{
	if(_actionType == Line::GET_LINE_ANGLE_Z_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_LINE_ANGLE_Z");

		GetLineAngleZAction* derived = dynamic_cast<GetLineAngleZAction*>(action);
...
void ActionCreator::GET_LINE_ANGLE_Z_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "GET_LINE_ANGLE_Z")
	{
		action = Trigger::_CreateAction(Line::GET_LINE_ANGLE_Z_MESSAGE);
