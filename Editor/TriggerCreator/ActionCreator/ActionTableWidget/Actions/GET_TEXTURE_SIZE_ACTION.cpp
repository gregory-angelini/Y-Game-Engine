...
void ActionTableWidget::GET_TEXTURE_SIZE_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "GET_TEXTURE_SIZE")
	{
...
bool ActionTableWidget::GET_TEXTURE_SIZE_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "GET_TEXTURE_SIZE") 
	{
...
QString ActionTableWidget::GET_TEXTURE_SIZE_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_TEXTURE_SIZE")
	{ 
		QString name;
...
bool ActionTableWidget::GET_TEXTURE_SIZE_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_TEXTURE_SIZE")
	{ 
...
bool ActionTableWidget::GET_TEXTURE_SIZE_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_TEXTURE_SIZE")
	{
...
void ActionTableWidget::GET_TEXTURE_SIZE_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_TEXTURE_SIZE")
	{
...
void ActionCreator::GET_TEXTURE_SIZE_SetAction(int _actionType)
{
	if(_actionType == Texture2D::GET_TEXTURE_SIZE_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_TEXTURE_SIZE");

		GetTextureSizeAction* derived = dynamic_cast<GetTextureSizeAction*>(action);
...
void ActionCreator::GET_TEXTURE_SIZE_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "GET_TEXTURE_SIZE")
	{
		action = Trigger::_CreateAction(Texture2D::GET_TEXTURE_SIZE_MESSAGE);
