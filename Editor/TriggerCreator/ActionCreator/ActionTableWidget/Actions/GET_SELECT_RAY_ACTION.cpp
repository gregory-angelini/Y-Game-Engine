...
void ActionTableWidget::GET_SELECT_RAY_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "GET_SELECT_RAY")
	{
...
bool ActionTableWidget::GET_SELECT_RAY_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "GET_SELECT_RAY") 
	{
...
QString ActionTableWidget::GET_SELECT_RAY_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_SELECT_RAY")
	{ 
		QString name;
...
bool ActionTableWidget::GET_SELECT_RAY_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_SELECT_RAY")
	{ 
...
bool ActionTableWidget::GET_SELECT_RAY_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_SELECT_RAY")
	{
...
bool ActionTableWidget::GET_SELECT_RAY_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_SELECT_RAY")
	{
...
void ActionTableWidget::GET_SELECT_RAY_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_SELECT_RAY")
	{
...
void ActionCreator::GET_SELECT_RAY_SetAction(int _actionType)
{
	if(_actionType == Camera3D::GET_SELECT_RAY_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_SELECT_RAY");

		GetSelectRayAction* derived = dynamic_cast<GetSelectRayAction*>(action);
...
void ActionCreator::GET_SELECT_RAY_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "GET_SELECT_RAY")
	{
		action = Trigger::_CreateAction(Camera3D::GET_SELECT_RAY_MESSAGE);
