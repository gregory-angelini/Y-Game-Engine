...
void ActionTableWidget::SET_DATA_TO_CONTROL_QUATERNION_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "SET_DATA_TO_CONTROL_QUATERNION")
	{
...
bool ActionTableWidget::SET_DATA_TO_CONTROL_QUATERNION_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "SET_DATA_TO_CONTROL_QUATERNION") 
	{
			    ...
			    (_index.row() == ARG3_PROPERTY && _index.column() == ARG_MODE))
		{
			...
			if(item(ARG2_PROPERTY, VALUE)->text() == "ROTATABLE_OBJECT")
			{
				...
				{
					SetCellText(ARG3_PROPERTY, CONTENT, "Valuet"); 
...
QString ActionTableWidget::SET_DATA_TO_CONTROL_QUATERNION_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "SET_DATA_TO_CONTROL_QUATERNION")
	{ 
		QString name;
...
bool ActionTableWidget::SET_DATA_TO_CONTROL_QUATERNION_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "SET_DATA_TO_CONTROL_QUATERNION")
	{ 
...
bool ActionTableWidget::SET_DATA_TO_CONTROL_QUATERNION_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "SET_DATA_TO_CONTROL_QUATERNION")
	{
...
bool ActionTableWidget::SET_DATA_TO_CONTROL_QUATERNION_UpdateArg2PropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "SET_DATA_TO_CONTROL_QUATERNION")
	{ 
...
bool ActionTableWidget::SET_DATA_TO_CONTROL_QUATERNION_UpdateArg3VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "SET_DATA_TO_CONTROL_QUATERNION")
	{
		if(item(ARG2_PROPERTY, VALUE)->text() == "ROTATABLE_OBJECT")
...
void ActionTableWidget::SET_DATA_TO_CONTROL_QUATERNION_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "SET_DATA_TO_CONTROL_QUATERNION")
	{
...
void ActionCreator::SET_DATA_TO_CONTROL_QUATERNION_SetAction(int _actionType)
{
	if(_actionType == QuaternionLerp::SET_DATA_TO_CONTROL_QUATERNION_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "SET_DATA_TO_CONTROL_QUATERNION");

		SetDataToControlQuaternionAction* derived = dynamic_cast<SetDataToControlQuaternionAction*>(action);
	...
	else if(_actionType == QuaternionLerp::SET_DATA_TO_CONTROL_ROTATABLE_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "SET_DATA_TO_CONTROL_QUATERNION");

		SetDataToControlRotatableAction* derived = dynamic_cast<SetDataToControlRotatableAction*>(action);
...
void ActionCreator::SET_DATA_TO_CONTROL_QUATERNION_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "SET_DATA_TO_CONTROL_QUATERNION")
	{
		if(actionTable->GetCellText(ActionTableWidget::ARG2_PROPERTY, ActionTableWidget::VALUE) == "QUATERNION")
		{
			action = Trigger::_CreateAction(QuaternionLerp::SET_DATA_TO_CONTROL_QUATERNION_MESSAGE);
		...
		{  
			action = Trigger::_CreateAction(QuaternionLerp::SET_DATA_TO_CONTROL_ROTATABLE_MESSAGE);
