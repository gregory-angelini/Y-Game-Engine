...
void ActionTableWidget::GET_VECTOR_COMPONENT_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "GET_VECTOR_COMPONENT")
	{
...
bool ActionTableWidget::GET_VECTOR_COMPONENT_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "GET_VECTOR_COMPONENT") 
	{
		...
		else if(_index.row() == ARG1_PROPERTY && _index.column() == VALUE)
		{
			...
			{ 
				...
				SetCellText(ARG2_PROPERTY, CONTENT, "Result X"); 
				SetCellText(ARG2_PROPERTY, DATA_TYPE, "Float variable");
				SetCellText(ARG3_PROPERTY, CONTENT, "Result Y"); 
				SetCellText(ARG3_PROPERTY, DATA_TYPE, "Float variable");
				SetCellText(ARG4_PROPERTY, CONTENT, "Result Z"); 
...
QString ActionTableWidget::GET_VECTOR_COMPONENT_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_VECTOR_COMPONENT")
	{ 
		QString name;
...
bool ActionTableWidget::GET_VECTOR_COMPONENT_UpdateArg1PropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_VECTOR_COMPONENT")
	{ 
...
bool ActionTableWidget::GET_VECTOR_COMPONENT_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_VECTOR_COMPONENT")
	{ 
		if(item(ARG1_PROPERTY, VALUE)->text() == "VECTOR_3")
...
bool ActionTableWidget::GET_VECTOR_COMPONENT_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_VECTOR_COMPONENT")
	{
...
bool ActionTableWidget::GET_VECTOR_COMPONENT_UpdateArg3VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_VECTOR_COMPONENT")
	{
...
bool ActionTableWidget::GET_VECTOR_COMPONENT_UpdateArg4VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_VECTOR_COMPONENT")
	{  
		if(item(ARG1_PROPERTY, VALUE)->text() == "VECTOR_3")
...
void ActionTableWidget::GET_VECTOR_COMPONENT_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_VECTOR_COMPONENT")
	{
...
void ActionCreator::GET_VECTOR_COMPONENT_SetAction(int _actionType)
{
	if(_actionType == Variable<Vector3>::GET_VECTOR_3_COMPONENT_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_VECTOR_COMPONENT");

		GetVector3ComponentAction* derived = dynamic_cast<GetVector3ComponentAction*>(action);
	...
	else if(_actionType == Variable<Vector2>::GET_VECTOR_2_COMPONENT_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_VECTOR_COMPONENT");

		GetVector2ComponentAction* derived = dynamic_cast<GetVector2ComponentAction*>(action);
...
void ActionCreator::GET_VECTOR_COMPONENT_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "GET_VECTOR_COMPONENT")
	{
		if(actionTable->GetCellText(ActionTableWidget::ARG1_PROPERTY, ActionTableWidget::VALUE) == "VECTOR_3")
		{ 
			action = Trigger::_CreateAction(Variable<Vector3>::GET_VECTOR_3_COMPONENT_MESSAGE);
		...
		{ 
			action = Trigger::_CreateAction(Variable<Vector2>::GET_VECTOR_2_COMPONENT_MESSAGE);
