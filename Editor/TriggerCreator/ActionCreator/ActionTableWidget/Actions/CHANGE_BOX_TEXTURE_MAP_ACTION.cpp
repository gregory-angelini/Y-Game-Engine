...
void ActionTableWidget::CHANGE_BOX_TEXTURE_MAP_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "CHANGE_BOX_TEXTURE_MAP")
	{
...
bool ActionTableWidget::CHANGE_BOX_TEXTURE_MAP_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "CHANGE_BOX_TEXTURE_MAP") 
	{
		...
		{ 
			...
			if(item(ARG1_PROPERTY, ARG_MODE)->text() == "KEY")
			{
				SetCellText(ARG1_PROPERTY, CONTENT, "Box face"); 
		...
		{ 
			...
			SetCellText(ARG2_PROPERTY, CONTENT, "Face picture"); 
			SetCellText(ARG2_PROPERTY, DATA_TYPE, "Texture");  
		}
...
QString ActionTableWidget::CHANGE_BOX_TEXTURE_MAP_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BOX_TEXTURE_MAP")
	{ 
		QString name;
...
bool ActionTableWidget::CHANGE_BOX_TEXTURE_MAP_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BOX_TEXTURE_MAP")
	{ 
...
bool ActionTableWidget::CHANGE_BOX_TEXTURE_MAP_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BOX_TEXTURE_MAP")
	{
...
bool ActionTableWidget::CHANGE_BOX_TEXTURE_MAP_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BOX_TEXTURE_MAP")
	{
		UpdateTexture(ARG2_PROPERTY); 
		return true;
	}
	return false;
}
...
void ActionTableWidget::CHANGE_BOX_TEXTURE_MAP_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BOX_TEXTURE_MAP")
	{
...
void ActionCreator::CHANGE_BOX_TEXTURE_MAP_SetAction(int _actionType)
{
	if(_actionType == Texture2D::CHANGE_BOX_TEXTURE_MAP_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "CHANGE_BOX_TEXTURE_MAP");

		ChangeBoxTextureMapAction* derived = dynamic_cast<ChangeBoxTextureMapAction*>(action);
...
void ActionCreator::CHANGE_BOX_TEXTURE_MAP_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "CHANGE_BOX_TEXTURE_MAP")
	{
		action = Trigger::_CreateAction(Texture2D::CHANGE_BOX_TEXTURE_MAP_MESSAGE);
