...
void ActionTableWidget::GET_BRUSH_OF_TILE_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "GET_BRUSH_OF_TILE")
	{
...
bool ActionTableWidget::GET_BRUSH_OF_TILE_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "GET_BRUSH_OF_TILE") 
	{
...
QString ActionTableWidget::GET_BRUSH_OF_TILE_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_BRUSH_OF_TILE")
	{ 
		QString name;
...
bool ActionTableWidget::GET_BRUSH_OF_TILE_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_BRUSH_OF_TILE")
	{ 
...
bool ActionTableWidget::GET_BRUSH_OF_TILE_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_BRUSH_OF_TILE")
	{
...
bool ActionTableWidget::GET_BRUSH_OF_TILE_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_BRUSH_OF_TILE")
	{ 
...
void ActionTableWidget::GET_BRUSH_OF_TILE_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_BRUSH_OF_TILE")
	{
...
void ActionCreator::GET_BRUSH_OF_TILE_SetAction(int _actionType)
{
	if(_actionType == TiledSpace3D::GET_BRUSH_OF_TILE_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_BRUSH_OF_TILE");

		GetBrushOfTileAction* derived = dynamic_cast<GetBrushOfTileAction*>(action);
...
void ActionCreator::GET_BRUSH_OF_TILE_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "GET_BRUSH_OF_TILE")
	{
		action = Trigger::_CreateAction(TiledSpace3D::GET_BRUSH_OF_TILE_MESSAGE);
