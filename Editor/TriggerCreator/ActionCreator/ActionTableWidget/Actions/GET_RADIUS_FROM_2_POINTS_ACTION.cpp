...
void ActionTableWidget::GET_RADIUS_FROM_2_POINTS_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "GET_RADIUS_FROM_2_POINTS")
	{
...
bool ActionTableWidget::GET_RADIUS_FROM_2_POINTS_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "GET_RADIUS_FROM_2_POINTS") 
	{
...
QString ActionTableWidget::GET_RADIUS_FROM_2_POINTS_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_RADIUS_FROM_2_POINTS")
	{ 
		QString name;
...
bool ActionTableWidget::GET_RADIUS_FROM_2_POINTS_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_RADIUS_FROM_2_POINTS")
	{
...
bool ActionTableWidget::GET_RADIUS_FROM_2_POINTS_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_RADIUS_FROM_2_POINTS")
	{
...
bool ActionTableWidget::GET_RADIUS_FROM_2_POINTS_UpdateArg3VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_RADIUS_FROM_2_POINTS")
	{
...
void ActionTableWidget::GET_RADIUS_FROM_2_POINTS_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_RADIUS_FROM_2_POINTS")
	{
...
void ActionCreator::GET_RADIUS_FROM_2_POINTS_SetAction(int _actionType)
{
	if(_actionType == Circle::GET_RADIUS_FROM_2_POINTS_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_RADIUS_FROM_2_POINTS");

		GetRadiusFrom2PointsAction* derived = dynamic_cast<GetRadiusFrom2PointsAction*>(action);
...
void ActionCreator::GET_RADIUS_FROM_2_POINTS_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "GET_RADIUS_FROM_2_POINTS")
	{
		action = Trigger::_CreateAction(Circle::GET_RADIUS_FROM_2_POINTS_MESSAGE);
