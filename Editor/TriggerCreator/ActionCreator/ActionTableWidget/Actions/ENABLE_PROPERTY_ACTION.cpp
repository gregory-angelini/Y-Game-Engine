...
void ActionTableWidget::ENABLE_PROPERTY_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "ENABLE_PROPERTY")
	{
...
bool ActionTableWidget::ENABLE_PROPERTY_UpdateRow(const QModelIndex& _index, const QString& _type)
{
...
QString ActionTableWidget::ENABLE_PROPERTY_CreateAutoName(void)
{
...
bool ActionTableWidget::ENABLE_PROPERTY_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_PROPERTY")
	{ 
...
bool ActionTableWidget::ENABLE_PROPERTY_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_PROPERTY")
	{
...
bool ActionTableWidget::ENABLE_PROPERTY_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_PROPERTY")
	{
...
void ActionTableWidget::ENABLE_PROPERTY_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_PROPERTY")
	{
...
void ActionCreator::ENABLE_PROPERTY_SetAction(int _actionType)
{
	if(_actionType == AbstractObject::ENABLE_PROPERTY_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "ENABLE_PROPERTY");

		EnablePropertyAction* derived = dynamic_cast<EnablePropertyAction*>(action);
...
void ActionCreator::ENABLE_PROPERTY_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "ENABLE_PROPERTY")
	{
		action = Trigger::_CreateAction(AbstractObject::ENABLE_PROPERTY_MESSAGE);
