...
void ActionTableWidget::ENABLE_ROTATION_RANGE_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "ENABLE_ROTATION_RANGE")
	{
...
bool ActionTableWidget::ENABLE_ROTATION_RANGE_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "ENABLE_ROTATION_RANGE") 
	{
...
QString ActionTableWidget::ENABLE_ROTATION_RANGE_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_ROTATION_RANGE")
	{ 
		QString name;
...
bool ActionTableWidget::ENABLE_ROTATION_RANGE_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_ROTATION_RANGE")
	{ 
...
bool ActionTableWidget::ENABLE_ROTATION_RANGE_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_ROTATION_RANGE")
	{
...
bool ActionTableWidget::ENABLE_ROTATION_RANGE_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_ROTATION_RANGE")
	{
...
void ActionTableWidget::ENABLE_ROTATION_RANGE_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_ROTATION_RANGE")
	{
...
void ActionCreator::ENABLE_ROTATION_RANGE_SetAction(int _actionType)
{
	if(_actionType == Camera3D::ENABLE_ROTATION_RANGE_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "ENABLE_ROTATION_RANGE");

		EnableRotationRangeAction* derived = dynamic_cast<EnableRotationRangeAction*>(action);
...
void ActionCreator::ENABLE_ROTATION_RANGE_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "ENABLE_ROTATION_RANGE")
	{
		action = Trigger::_CreateAction(Camera3D::ENABLE_ROTATION_RANGE_MESSAGE);
