...
void ActionTableWidget::CREATE_SOLID_TILE_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "CREATE_SOLID_TILE")
	{
...
bool ActionTableWidget::CREATE_SOLID_TILE_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "CREATE_SOLID_TILE") 
	{
		...
		{ 
			...
			if(item(ARG2_PROPERTY, ARG_MODE)->text() == "KEY")
			{
				SetCellText(ARG2_PROPERTY, CONTENT, "Brush id"); 
...
QString ActionTableWidget::CREATE_SOLID_TILE_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CREATE_SOLID_TILE")
	{ 
		QString name;
...
bool ActionTableWidget::CREATE_SOLID_TILE_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CREATE_SOLID_TILE")
	{ 
...
bool ActionTableWidget::CREATE_SOLID_TILE_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CREATE_SOLID_TILE")
	{
...
bool ActionTableWidget::CREATE_SOLID_TILE_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CREATE_SOLID_TILE")
	{ 
...
void ActionTableWidget::CREATE_SOLID_TILE_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CREATE_SOLID_TILE")
	{
...
void ActionCreator::CREATE_SOLID_TILE_SetAction(int _actionType)
{
	if(_actionType == TiledSpace3D::CREATE_SOLID_TILE_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "CREATE_SOLID_TILE");

		CreateSolidTileAction* derived = dynamic_cast<CreateSolidTileAction*>(action);
...
void ActionCreator::CREATE_SOLID_TILE_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "CREATE_SOLID_TILE")
	{
		action = Trigger::_CreateAction(TiledSpace3D::CREATE_SOLID_TILE_MESSAGE);
