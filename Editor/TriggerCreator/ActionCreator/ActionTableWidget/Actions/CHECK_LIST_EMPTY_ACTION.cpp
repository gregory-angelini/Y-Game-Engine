...
void ActionTableWidget::CHECK_LIST_EMPTY_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "CHECK_LIST_EMPTY")
	{
...
bool ActionTableWidget::CHECK_LIST_EMPTY_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "CHECK_LIST_EMPTY") 
	{
...
QString ActionTableWidget::CHECK_LIST_EMPTY_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHECK_LIST_EMPTY")
	{ 
		QString name;
...
bool ActionTableWidget::CHECK_LIST_EMPTY_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHECK_LIST_EMPTY")
	{ 
...
bool ActionTableWidget::CHECK_LIST_EMPTY_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHECK_LIST_EMPTY")
	{
...
void ActionTableWidget::CHECK_LIST_EMPTY_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHECK_LIST_EMPTY")
	{
...
void ActionCreator::CHECK_LIST_EMPTY_SetAction(int _actionType)
{
	if(_actionType == AbstractList::CHECK_LIST_EMPTY_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "CHECK_LIST_EMPTY");

		CheckListEmptyAction* derived = dynamic_cast<CheckListEmptyAction*>(action);
...
void ActionCreator::CHECK_LIST_EMPTY_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "CHECK_LIST_EMPTY")
	{
		action = Trigger::_CreateAction(AbstractList::CHECK_LIST_EMPTY_MESSAGE);
