...
void ActionTableWidget::GET_QUATERNION_LERP_T_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "GET_QUATERNION_LERP_T")
	{
...
bool ActionTableWidget::GET_QUATERNION_LERP_T_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "GET_QUATERNION_LERP_T") 
	{
...
QString ActionTableWidget::GET_QUATERNION_LERP_T_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_QUATERNION_LERP_T")
	{ 
		QString name;
...
bool ActionTableWidget::GET_QUATERNION_LERP_T_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_QUATERNION_LERP_T")
	{ 
...
bool ActionTableWidget::GET_QUATERNION_LERP_T_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_QUATERNION_LERP_T")
	{
...
bool ActionTableWidget::GET_QUATERNION_LERP_T_UpdateArg2PropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_QUATERNION_LERP_T")
	{ 
...
bool ActionTableWidget::GET_QUATERNION_LERP_T_UpdateArg3VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_QUATERNION_LERP_T")
	{
		if(item(ARG2_PROPERTY, VALUE)->text() == "ROTATABLE_OBJECT")
...
void ActionTableWidget::GET_QUATERNION_LERP_T_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_QUATERNION_LERP_T")
	{
...
void ActionCreator::GET_QUATERNION_LERP_T_SetAction(int _actionType)
{
	if(_actionType == QuaternionLerp::GET_QUATERNION_LERP_T_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_QUATERNION_LERP_T");

		GetQuaternionLerpTAction* derived = dynamic_cast<GetQuaternionLerpTAction*>(action);
	...
	else if(_actionType == QuaternionLerp::GET_ROTATABLE_LERP_T_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_QUATERNION_LERP_T");

		GetRotatableLerpTAction* derived = dynamic_cast<GetRotatableLerpTAction*>(action);
...
void ActionCreator::GET_QUATERNION_LERP_T_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "GET_QUATERNION_LERP_T")
	{
		if(actionTable->GetCellText(ActionTableWidget::ARG2_PROPERTY, ActionTableWidget::VALUE) == "QUATERNION")
		{
			action = Trigger::_CreateAction(QuaternionLerp::GET_QUATERNION_LERP_T_MESSAGE);
		...
		{  
			action = Trigger::_CreateAction(QuaternionLerp::GET_ROTATABLE_LERP_T_MESSAGE);
