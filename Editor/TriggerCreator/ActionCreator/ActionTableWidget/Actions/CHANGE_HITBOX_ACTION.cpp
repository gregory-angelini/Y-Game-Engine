...
void ActionTableWidget::CHANGE_HITBOX_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "CHANGE_HITBOX")
	{
...
bool ActionTableWidget::CHANGE_HITBOX_UpdateRow(const QModelIndex& _index, const QString& _type)
{
...
QString ActionTableWidget::CHANGE_HITBOX_CreateAutoName(void)
{
...
bool ActionTableWidget::CHANGE_HITBOX_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_HITBOX")
	{ 
...
bool ActionTableWidget::CHANGE_HITBOX_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_HITBOX")
	{ 
...
void ActionTableWidget::CHANGE_HITBOX_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_HITBOX")
	{
...
void ActionCreator::CHANGE_HITBOX_SetAction(int _actionType)
{
	if(_actionType == PolygonalSurface::CHANGE_HITBOX_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "CHANGE_HITBOX");

		ChangeHitboxAction* derived = dynamic_cast<ChangeHitboxAction*>(action);
...
void ActionCreator::CHANGE_HITBOX_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "CHANGE_HITBOX")
	{
		action = Trigger::_CreateAction(PolygonalSurface::CHANGE_HITBOX_MESSAGE);
