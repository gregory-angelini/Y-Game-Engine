...
void ActionTableWidget::ENABLE_ROTATION_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "ENABLE_ROTATION")
	{
...
bool ActionTableWidget::ENABLE_ROTATION_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "ENABLE_ROTATION") 
	{
...
QString ActionTableWidget::ENABLE_ROTATION_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_ROTATION")
	{ 
		QString name;
...
bool ActionTableWidget::ENABLE_ROTATION_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_ROTATION")
	{ 
...
bool ActionTableWidget::ENABLE_ROTATION_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_ROTATION")
	{
...
void ActionTableWidget::ENABLE_ROTATION_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_ROTATION")
	{
...
void ActionCreator::ENABLE_ROTATION_SetAction(int _actionType)
{
	if(_actionType == Camera3D::ENABLE_ROTATION_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "ENABLE_ROTATION");

		EnableRotationAction* derived = dynamic_cast<EnableRotationAction*>(action);
...
void ActionCreator::ENABLE_ROTATION_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "ENABLE_ROTATION")
	{
		action = Trigger::_CreateAction(Camera3D::ENABLE_ROTATION_MESSAGE);
