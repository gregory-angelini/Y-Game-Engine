...
void ActionTableWidget::CHECK_TILE_SOLID_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "CHECK_TILE_SOLID")
	{
...
bool ActionTableWidget::CHECK_TILE_SOLID_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "CHECK_TILE_SOLID") 
	{
...
QString ActionTableWidget::CHECK_TILE_SOLID_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHECK_TILE_SOLID")
	{ 
		QString name;
...
bool ActionTableWidget::CHECK_TILE_SOLID_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHECK_TILE_SOLID")
	{ 
...
bool ActionTableWidget::CHECK_TILE_SOLID_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHECK_TILE_SOLID")
	{
...
bool ActionTableWidget::CHECK_TILE_SOLID_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHECK_TILE_SOLID")
	{ 
...
void ActionTableWidget::CHECK_TILE_SOLID_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHECK_TILE_SOLID")
	{
...
void ActionCreator::CHECK_TILE_SOLID_SetAction(int _actionType)
{
	if(_actionType == TiledSpace3D::CHECK_TILE_SOLID_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "CHECK_TILE_SOLID");

		CheckTileSolidAction* derived = dynamic_cast<CheckTileSolidAction*>(action);
...
void ActionCreator::CHECK_TILE_SOLID_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "CHECK_TILE_SOLID")
	{
		action = Trigger::_CreateAction(TiledSpace3D::CHECK_TILE_SOLID_MESSAGE);
