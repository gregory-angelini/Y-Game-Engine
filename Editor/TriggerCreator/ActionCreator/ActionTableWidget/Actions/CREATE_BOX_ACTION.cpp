...
void ActionTableWidget::CREATE_BOX_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "CREATE_BOX")
	{
...
bool ActionTableWidget::CREATE_BOX_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "CREATE_BOX") 
	{
...
QString ActionTableWidget::CREATE_BOX_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CREATE_BOX")
	{ 
		QString name;
...
bool ActionTableWidget::CREATE_BOX_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CREATE_BOX")
	{ 
...
bool ActionTableWidget::CREATE_BOX_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CREATE_BOX")
	{
...
void ActionTableWidget::CREATE_BOX_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CREATE_BOX")
	{
...
void ActionCreator::CREATE_BOX_SetAction(int _actionType) 
{
	if(_actionType == Mesh::CREATE_BOX_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "CREATE_BOX");

		CreateBoxAction* derived = dynamic_cast<CreateBoxAction*>(action);
...
void ActionCreator::CREATE_BOX_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "CREATE_BOX")
	{
		action = Trigger::_CreateAction(Mesh::CREATE_BOX_MESSAGE);
