...
void ActionTableWidget::GET_VIEWING_POINT_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "GET_VIEWING_POINT")
	{
...
bool ActionTableWidget::GET_VIEWING_POINT_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "GET_VIEWING_POINT") 
	{
...
QString ActionTableWidget::GET_VIEWING_POINT_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_VIEWING_POINT")
	{ 
		QString name;
...
bool ActionTableWidget::GET_VIEWING_POINT_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_VIEWING_POINT")
	{ 
...
bool ActionTableWidget::GET_VIEWING_POINT_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_VIEWING_POINT")
	{
...
void ActionTableWidget::GET_VIEWING_POINT_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_VIEWING_POINT")
	{
...
void ActionCreator::GET_VIEWING_POINT_SetAction(int _actionType)
{
	if(_actionType == Camera3D::GET_VIEWING_POINT_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_VIEWING_POINT");

		GetViewingPointAction* derived = dynamic_cast<GetViewingPointAction*>(action);
...
void ActionCreator::GET_VIEWING_POINT_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "GET_VIEWING_POINT")
	{
		action = Trigger::_CreateAction(Camera3D::GET_VIEWING_POINT_MESSAGE);
