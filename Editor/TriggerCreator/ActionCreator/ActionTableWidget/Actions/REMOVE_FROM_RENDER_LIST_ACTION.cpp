...
void ActionTableWidget::REMOVE_FROM_RENDER_LIST_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "REMOVE_FROM_RENDER_LIST")
	{
...
bool ActionTableWidget::REMOVE_FROM_RENDER_LIST_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "REMOVE_FROM_RENDER_LIST") 
	{
...
QString ActionTableWidget::REMOVE_FROM_RENDER_LIST_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "REMOVE_FROM_RENDER_LIST")
	{ 
		QString name;
...
bool ActionTableWidget::REMOVE_FROM_RENDER_LIST_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "REMOVE_FROM_RENDER_LIST")
	{ 
...
bool ActionTableWidget::REMOVE_FROM_RENDER_LIST_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "REMOVE_FROM_RENDER_LIST")
	{
...
void ActionTableWidget::REMOVE_FROM_RENDER_LIST_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "REMOVE_FROM_RENDER_LIST")
	{
...
void ActionCreator::REMOVE_FROM_RENDER_LIST_SetAction(int _actionType)
{
	if(_actionType == GraphicsScene::REMOVE_FROM_RENDER_LIST_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "REMOVE_FROM_RENDER_LIST");

		RemoveFromRenderListAction* derived = dynamic_cast<RemoveFromRenderListAction*>(action);
...
void ActionCreator::REMOVE_FROM_RENDER_LIST_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "REMOVE_FROM_RENDER_LIST")
	{
		action = Trigger::_CreateAction(GraphicsScene::REMOVE_FROM_RENDER_LIST_MESSAGE);
