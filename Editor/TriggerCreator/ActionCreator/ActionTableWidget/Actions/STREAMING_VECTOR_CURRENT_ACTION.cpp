...
void ActionTableWidget::STREAMING_VECTOR_CURRENT_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "STREAMING_VECTOR_CURRENT")
	{
...
bool ActionTableWidget::STREAMING_VECTOR_CURRENT_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "STREAMING_VECTOR_CURRENT") 
	{
...
QString ActionTableWidget::STREAMING_VECTOR_CURRENT_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "STREAMING_VECTOR_CURRENT")
	{ 
		QString name;
...
bool ActionTableWidget::STREAMING_VECTOR_CURRENT_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "STREAMING_VECTOR_CURRENT")
	{ 
...
bool ActionTableWidget::STREAMING_VECTOR_CURRENT_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "STREAMING_VECTOR_CURRENT")
	{
...
bool ActionTableWidget::STREAMING_VECTOR_CURRENT_UpdateArg2PropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "STREAMING_VECTOR_CURRENT")
	{ 
...
bool ActionTableWidget::STREAMING_VECTOR_CURRENT_UpdateArg3VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "STREAMING_VECTOR_CURRENT")
	{
		if(item(ARG2_PROPERTY, VALUE)->text() == "TRANSLATABLE_OBJECT")
...
void ActionTableWidget::STREAMING_VECTOR_CURRENT_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "STREAMING_VECTOR_CURRENT")
	{
...
void ActionCreator::STREAMING_VECTOR_CURRENT_SetAction(int _actionType)
{
	if(_actionType == VectorLerp::STREAMING_VECTOR_CURRENT_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "STREAMING_VECTOR_CURRENT");

		StreamingVectorCurrentAction* derived = dynamic_cast<StreamingVectorCurrentAction*>(action);
	...
	else if(_actionType == VectorLerp::STREAMING_TRANSLATABLE_CURRENT_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "STREAMING_VECTOR_CURRENT");

		StreamingTranslatableCurrentAction* derived = dynamic_cast<StreamingTranslatableCurrentAction*>(action);
	...
	else if(_actionType == VectorLerp::STREAMING_SCALABLE_CURRENT_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "STREAMING_VECTOR_CURRENT");

		StreamingScalableCurrentAction* derived = dynamic_cast<StreamingScalableCurrentAction*>(action);
	...
	else if(_actionType == VectorLerp::STREAMING_COLORABLE_CURRENT_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "STREAMING_VECTOR_CURRENT");

		StreamingColorableCurrentAction* derived = dynamic_cast<StreamingColorableCurrentAction*>(action);
...
void ActionCreator::STREAMING_VECTOR_CURRENT_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "STREAMING_VECTOR_CURRENT")
	{
		if(actionTable->GetCellText(ActionTableWidget::ARG2_PROPERTY, ActionTableWidget::VALUE) == "VECTOR_3")
		{
			action = Trigger::_CreateAction(VectorLerp::STREAMING_VECTOR_CURRENT_MESSAGE);
		...
		{  
			action = Trigger::_CreateAction(VectorLerp::STREAMING_TRANSLATABLE_CURRENT_MESSAGE);
		...
		{  
			action = Trigger::_CreateAction(VectorLerp::STREAMING_SCALABLE_CURRENT_MESSAGE);
		...
		{  
			action = Trigger::_CreateAction(VectorLerp::STREAMING_COLORABLE_CURRENT_MESSAGE);
