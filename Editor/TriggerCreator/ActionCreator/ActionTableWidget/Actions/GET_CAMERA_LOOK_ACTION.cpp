...
void ActionTableWidget::GET_CAMERA_LOOK_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "GET_CAMERA_LOOK")
	{
...
bool ActionTableWidget::GET_CAMERA_LOOK_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "GET_CAMERA_LOOK") 
	{
...
QString ActionTableWidget::GET_CAMERA_LOOK_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_CAMERA_LOOK")
	{ 
		QString name;
...
bool ActionTableWidget::GET_CAMERA_LOOK_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_CAMERA_LOOK")
	{ 
...
bool ActionTableWidget::GET_CAMERA_LOOK_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_CAMERA_LOOK")
	{
...
void ActionTableWidget::GET_CAMERA_LOOK_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_CAMERA_LOOK")
	{
...
void ActionCreator::GET_CAMERA_LOOK_SetAction(int _actionType)
{
	if(_actionType == Camera3D::GET_CAMERA_LOOK_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_CAMERA_LOOK");

		GetCameraLookAction* derived = dynamic_cast<GetCameraLookAction*>(action);
...
void ActionCreator::GET_CAMERA_LOOK_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "GET_CAMERA_LOOK")
	{
		action = Trigger::_CreateAction(Camera3D::GET_CAMERA_LOOK_MESSAGE);
