...
void ActionTableWidget::CREATE_ROTATION_FROM_TO_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "CREATE_ROTATION_FROM_TO")
	{
...
bool ActionTableWidget::CREATE_ROTATION_FROM_TO_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "CREATE_ROTATION_FROM_TO") 
	{
		...
		{ 
			...
			delegate->SetComboValuesForCell(indexFromItem(item(ARG1_PROPERTY, VALUE)), getRotationFromToArgsComboList);
		...
		else if(_index.row() == ARG1_PROPERTY && _index.column() == VALUE)
		{
			...
			else if(item(ARG1_PROPERTY, VALUE)->text() == "QUATERNION")
			{
				...
				SetCellText(TARGET_PROPERTY, DATA_TYPE, "Rotatable object"); 
			}
		}
...
QString ActionTableWidget::CREATE_ROTATION_FROM_TO_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CREATE_ROTATION_FROM_TO")
	{ 
		QString name;
...
bool ActionTableWidget::CREATE_ROTATION_FROM_TO_UpdateArg1PropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CREATE_ROTATION_FROM_TO")
	{ 
...
bool ActionTableWidget::CREATE_ROTATION_FROM_TO_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CREATE_ROTATION_FROM_TO")
	{
		if(item(ARG1_PROPERTY, VALUE)->text() == "VECTOR_3") 
...
bool ActionTableWidget::CREATE_ROTATION_FROM_TO_UpdateArg3VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CREATE_ROTATION_FROM_TO")
	{
		if(item(ARG1_PROPERTY, VALUE)->text() == "VECTOR_3") 
...
bool ActionTableWidget::CREATE_ROTATION_FROM_TO_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CREATE_ROTATION_FROM_TO")
	{
		UpdateRotatableObject(TARGET_PROPERTY);
		return true;
	}
	return false;
}
...
void ActionTableWidget::CREATE_ROTATION_FROM_TO_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CREATE_ROTATION_FROM_TO")
	{
...
void ActionCreator::CREATE_ROTATION_FROM_TO_SetAction(int _actionType)
{
	if(_actionType == Variable<Quaternion>::CREATE_ROTATION_FROM_VECTOR_3_TO_VECTOR_3_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "CREATE_ROTATION_FROM_TO");

		CreateRotationFromVector3ToVector3Action* derived = dynamic_cast<CreateRotationFromVector3ToVector3Action*>(action);
	...
	else if(_actionType == Variable<Quaternion>::CREATE_ROTATION_FROM_QUATERNION_TO_QUATERNION_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "CREATE_ROTATION_FROM_TO");

		CreateRotationFromQuaternionToQuaternionAction* derived = dynamic_cast<CreateRotationFromQuaternionToQuaternionAction*>(action);
...
void ActionCreator::CREATE_ROTATION_FROM_TO_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "CREATE_ROTATION_FROM_TO")
	{
		if(actionTable->GetCellText(ActionTableWidget::ARG1_PROPERTY, ActionTableWidget::VALUE) == "VECTOR_3")
		{
			action = Trigger::_CreateAction(Variable<Quaternion>::CREATE_ROTATION_FROM_VECTOR_3_TO_VECTOR_3_MESSAGE);
		...
		{  
			action = Trigger::_CreateAction(Variable<Quaternion>::CREATE_ROTATION_FROM_QUATERNION_TO_QUATERNION_MESSAGE);
