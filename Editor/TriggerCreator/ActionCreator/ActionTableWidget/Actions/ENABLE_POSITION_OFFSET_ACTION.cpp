...
void ActionTableWidget::ENABLE_POSITION_OFFSET_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "ENABLE_POSITION_OFFSET")
	{
...
bool ActionTableWidget::ENABLE_POSITION_OFFSET_UpdateRow(const QModelIndex& _index, const QString& _type)
{
...
QString ActionTableWidget::ENABLE_POSITION_OFFSET_CreateAutoName(void)
{
...
bool ActionTableWidget::ENABLE_POSITION_OFFSET_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_POSITION_OFFSET")
	{ 
...
bool ActionTableWidget::ENABLE_POSITION_OFFSET_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_POSITION_OFFSET")
	{
...
void ActionTableWidget::ENABLE_POSITION_OFFSET_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_POSITION_OFFSET")
	{
...
void ActionCreator::ENABLE_POSITION_OFFSET_SetAction(int _actionType)
{
	if(_actionType == TexturedAnimation::ENABLE_POSITION_OFFSET_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "ENABLE_POSITION_OFFSET");

		EnablePositionOffsetAction* derived = dynamic_cast<EnablePositionOffsetAction*>(action);
...
void ActionCreator::ENABLE_POSITION_OFFSET_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "ENABLE_POSITION_OFFSET")
	{
		action = Trigger::_CreateAction(TexturedAnimation::ENABLE_POSITION_OFFSET_MESSAGE);
