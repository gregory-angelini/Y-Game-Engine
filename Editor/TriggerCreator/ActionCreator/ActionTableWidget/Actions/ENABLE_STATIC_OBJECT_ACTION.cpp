...
void ActionTableWidget::ENABLE_STATIC_OBJECT_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "ENABLE_STATIC_OBJECT")
	{
...
bool ActionTableWidget::ENABLE_STATIC_OBJECT_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "ENABLE_STATIC_OBJECT") 
	{
...
QString ActionTableWidget::ENABLE_STATIC_OBJECT_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_STATIC_OBJECT")
	{ 
		QString name;
...
bool ActionTableWidget::ENABLE_STATIC_OBJECT_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_STATIC_OBJECT")
	{ 
...
bool ActionTableWidget::ENABLE_STATIC_OBJECT_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_STATIC_OBJECT")
	{
...
void ActionTableWidget::ENABLE_STATIC_OBJECT_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "ENABLE_STATIC_OBJECT")
	{
...
void ActionCreator::ENABLE_STATIC_OBJECT_SetAction(int _actionType)
{
	if(_actionType == GraphicsSurface::ENABLE_STATIC_OBJECT_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "ENABLE_STATIC_OBJECT");

		EnableStaticObjectAction* derived = dynamic_cast<EnableStaticObjectAction*>(action);
...
void ActionCreator::ENABLE_STATIC_OBJECT_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "ENABLE_STATIC_OBJECT")
	{
		action = Trigger::_CreateAction(GraphicsSurface::ENABLE_STATIC_OBJECT_MESSAGE);
