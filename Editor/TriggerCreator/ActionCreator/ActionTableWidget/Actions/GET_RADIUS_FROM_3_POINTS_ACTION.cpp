...
void ActionTableWidget::GET_RADIUS_FROM_3_POINTS_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "GET_RADIUS_FROM_3_POINTS")
	{
...
bool ActionTableWidget::GET_RADIUS_FROM_3_POINTS_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "GET_RADIUS_FROM_3_POINTS") 
	{
		...
		{ 
			...
			if(item(ARG1_PROPERTY, ARG_MODE)->text() == "KEY")
			{
				SetCellText(ARG1_PROPERTY, CONTENT, "Point1"); 
		...
		{ 
			...
			if(item(ARG2_PROPERTY, ARG_MODE)->text() == "KEY")
			{
				SetCellText(ARG2_PROPERTY, CONTENT, "Point2"); 
		...
		{ 
			...
			if(item(ARG3_PROPERTY, ARG_MODE)->text() == "KEY")
			{
				SetCellText(ARG3_PROPERTY, CONTENT, "Point3"); 
...
QString ActionTableWidget::GET_RADIUS_FROM_3_POINTS_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_RADIUS_FROM_3_POINTS")
	{ 
		QString name;
...
bool ActionTableWidget::GET_RADIUS_FROM_3_POINTS_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_RADIUS_FROM_3_POINTS")
	{
...
bool ActionTableWidget::GET_RADIUS_FROM_3_POINTS_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_RADIUS_FROM_3_POINTS")
	{
...
bool ActionTableWidget::GET_RADIUS_FROM_3_POINTS_UpdateArg3VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_RADIUS_FROM_3_POINTS")
	{
...
bool ActionTableWidget::GET_RADIUS_FROM_3_POINTS_UpdateArg4VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_RADIUS_FROM_3_POINTS")
	{
...
void ActionTableWidget::GET_RADIUS_FROM_3_POINTS_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_RADIUS_FROM_3_POINTS")
	{
...
void ActionCreator::GET_RADIUS_FROM_3_POINTS_SetAction(int _actionType)
{
	if(_actionType == Circle::GET_RADIUS_FROM_3_POINTS_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_RADIUS_FROM_3_POINTS");

		GetRadiusFrom3PointsAction* derived = dynamic_cast<GetRadiusFrom3PointsAction*>(action);
		...
		if(derived)
		{
			...
			if(derived->GetArgState(AbstractAction::KEY, AbstractAction::ARG3))
			{
				...
				actionTable->SetCellText(ActionTableWidget::ARG3_PROPERTY, ActionTableWidget::VALUE, Vector3ToString(derived->GetVector3KeyArg(AbstractAction::ARG3)));
			}
...
void ActionCreator::GET_RADIUS_FROM_3_POINTS_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "GET_RADIUS_FROM_3_POINTS")
	{
		action = Trigger::_CreateAction(Circle::GET_RADIUS_FROM_3_POINTS_MESSAGE);
		...
		if(action)
		{
			...
			{
				action->SetVector3KeyArg(AbstractAction::ARG3, StringToVector3(actionTable->GetCellText(ActionTableWidget::ARG3_PROPERTY, ActionTableWidget::VALUE)));
			}
