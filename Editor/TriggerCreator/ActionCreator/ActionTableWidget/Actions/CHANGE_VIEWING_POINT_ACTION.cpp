...
void ActionTableWidget::CHANGE_VIEWING_POINT_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "CHANGE_VIEWING_POINT")
	{
...
bool ActionTableWidget::CHANGE_VIEWING_POINT_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "CHANGE_VIEWING_POINT") 
	{
...
QString ActionTableWidget::CHANGE_VIEWING_POINT_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_VIEWING_POINT")
	{ 
		QString name;
...
bool ActionTableWidget::CHANGE_VIEWING_POINT_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_VIEWING_POINT")
	{  
...
bool ActionTableWidget::CHANGE_VIEWING_POINT_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_VIEWING_POINT")
	{
...
void ActionTableWidget::CHANGE_VIEWING_POINT_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_VIEWING_POINT")
	{
...
void ActionCreator::CHANGE_VIEWING_POINT_SetAction(int _actionType)
{
	if(_actionType == Camera3D::CHANGE_VIEWING_POINT_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "CHANGE_VIEWING_POINT");

		ChangeViewingPointAction* derived = dynamic_cast<ChangeViewingPointAction*>(action);
...
void ActionCreator::CHANGE_VIEWING_POINT_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "CHANGE_VIEWING_POINT")
	{
		action = Trigger::_CreateAction(Camera3D::CHANGE_VIEWING_POINT_MESSAGE);
