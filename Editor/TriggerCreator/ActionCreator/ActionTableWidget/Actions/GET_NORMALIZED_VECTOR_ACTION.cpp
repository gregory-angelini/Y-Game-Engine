...
void ActionTableWidget::GET_NORMALIZED_VECTOR_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "GET_NORMALIZED_VECTOR")
	{
...
bool ActionTableWidget::GET_NORMALIZED_VECTOR_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "GET_NORMALIZED_VECTOR") 
	{
...
QString ActionTableWidget::GET_NORMALIZED_VECTOR_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_NORMALIZED_VECTOR")
	{ 
		QString name;
...
bool ActionTableWidget::GET_NORMALIZED_VECTOR_UpdateArg1PropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_NORMALIZED_VECTOR")
	{ 
...
bool ActionTableWidget::GET_NORMALIZED_VECTOR_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_NORMALIZED_VECTOR")
	{ 
		if(item(ARG1_PROPERTY, VALUE)->text() == "VECTOR_3")
...
bool ActionTableWidget::GET_NORMALIZED_VECTOR_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_NORMALIZED_VECTOR")
	{
		if(item(ARG1_PROPERTY, VALUE)->text() == "VECTOR_3")
...
void ActionTableWidget::GET_NORMALIZED_VECTOR_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_NORMALIZED_VECTOR")
	{
...
void ActionCreator::GET_NORMALIZED_VECTOR_SetAction(int _actionType)
{
	if(_actionType == Variable<Vector3>::GET_NORMALIZED_VECTOR_3_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_NORMALIZED_VECTOR");

		GetNormalizedVector3Action* derived = dynamic_cast<GetNormalizedVector3Action*>(action);
	...
	else if(_actionType == Variable<Vector2>::GET_NORMALIZED_VECTOR_2_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_NORMALIZED_VECTOR");

		GetNormalizedVector2Action* derived = dynamic_cast<GetNormalizedVector2Action*>(action);
...
void ActionCreator::GET_NORMALIZED_VECTOR_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "GET_NORMALIZED_VECTOR")
	{
		if(actionTable->GetCellText(ActionTableWidget::ARG1_PROPERTY, ActionTableWidget::VALUE) == "VECTOR_3")
		{ 
			action = Trigger::_CreateAction(Variable<Vector3>::GET_NORMALIZED_VECTOR_3_MESSAGE);
		...
		{ 
			action = Trigger::_CreateAction(Variable<Vector2>::GET_NORMALIZED_VECTOR_2_MESSAGE);
