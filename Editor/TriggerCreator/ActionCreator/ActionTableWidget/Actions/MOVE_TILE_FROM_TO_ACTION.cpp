...
void ActionTableWidget::MOVE_TILE_FROM_TO_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "MOVE_TILE_FROM_TO")
	{
...
bool ActionTableWidget::MOVE_TILE_FROM_TO_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "MOVE_TILE_FROM_TO") 
	{
		...
		{ 
			...
			if(item(ARG1_PROPERTY, ARG_MODE)->text() == "KEY")
			{
				SetCellText(ARG1_PROPERTY, CONTENT, "From tile"); 
		...
		{ 
			...
			if(item(ARG2_PROPERTY, ARG_MODE)->text() == "KEY")
			{
				SetCellText(ARG2_PROPERTY, CONTENT, "To tile"); 
		...
		{ 
			...
			SetCellText(ARG3_PROPERTY, CONTENT, "Move result"); 
...
QString ActionTableWidget::MOVE_TILE_FROM_TO_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "MOVE_TILE_FROM_TO")
	{ 
		QString name;
...
bool ActionTableWidget::MOVE_TILE_FROM_TO_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "MOVE_TILE_FROM_TO")
	{ 
...
bool ActionTableWidget::MOVE_TILE_FROM_TO_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "MOVE_TILE_FROM_TO")
	{
...
bool ActionTableWidget::MOVE_TILE_FROM_TO_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "MOVE_TILE_FROM_TO")
	{ 
...
bool ActionTableWidget::MOVE_TILE_FROM_TO_UpdateArg3VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "MOVE_TILE_FROM_TO")
	{
...
void ActionTableWidget::MOVE_TILE_FROM_TO_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "MOVE_TILE_FROM_TO")
	{
...
void ActionCreator::MOVE_TILE_FROM_TO_SetAction(int _actionType)
{
	if(_actionType == TiledSpace3D::MOVE_TILE_FROM_TO_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "MOVE_TILE_FROM_TO");

		MoveTileFromToAction* derived = dynamic_cast<MoveTileFromToAction*>(action);
...
void ActionCreator::MOVE_TILE_FROM_TO_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "MOVE_TILE_FROM_TO")
	{
		action = Trigger::_CreateAction(TiledSpace3D::MOVE_TILE_FROM_TO_MESSAGE);
