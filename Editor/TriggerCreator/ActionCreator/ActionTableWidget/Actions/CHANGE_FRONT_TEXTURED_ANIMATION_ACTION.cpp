...
void ActionTableWidget::CHANGE_FRONT_TEXTURED_ANIMATION_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "CHANGE_FRONT_TEXTURED_ANIMATION")
	{
...
bool ActionTableWidget::CHANGE_FRONT_TEXTURED_ANIMATION_UpdateRow(const QModelIndex& _index, const QString& _type)
{
...
QString ActionTableWidget::CHANGE_FRONT_TEXTURED_ANIMATION_CreateAutoName(void)
{
...
bool ActionTableWidget::CHANGE_FRONT_TEXTURED_ANIMATION_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_FRONT_TEXTURED_ANIMATION")
	{ 
...
bool ActionTableWidget::CHANGE_FRONT_TEXTURED_ANIMATION_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_FRONT_TEXTURED_ANIMATION")
	{
...
void ActionTableWidget::CHANGE_FRONT_TEXTURED_ANIMATION_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_FRONT_TEXTURED_ANIMATION")
	{
...
void ActionCreator::CHANGE_FRONT_TEXTURED_ANIMATION_SetAction(int _actionType)
{
	if(_actionType == TexturingSurface::CHANGE_FRONT_TEXTURED_ANIMATION_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "CHANGE_FRONT_TEXTURED_ANIMATION");

		ChangeFrontTexturedAnimationAction* derived = dynamic_cast<ChangeFrontTexturedAnimationAction*>(action);
...
void ActionCreator::CHANGE_FRONT_TEXTURED_ANIMATION_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "CHANGE_FRONT_TEXTURED_ANIMATION")
	{
		action = Trigger::_CreateAction(TexturingSurface::CHANGE_FRONT_TEXTURED_ANIMATION_MESSAGE);
