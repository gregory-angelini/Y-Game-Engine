...
void ActionTableWidget::CHANGE_BACK_TEXTURED_ANIMATION_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "CHANGE_BACK_TEXTURED_ANIMATION")
	{
...
bool ActionTableWidget::CHANGE_BACK_TEXTURED_ANIMATION_UpdateRow(const QModelIndex& _index, const QString& _type)
{
...
QString ActionTableWidget::CHANGE_BACK_TEXTURED_ANIMATION_CreateAutoName(void)
{
...
bool ActionTableWidget::CHANGE_BACK_TEXTURED_ANIMATION_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BACK_TEXTURED_ANIMATION")
	{ 
...
bool ActionTableWidget::CHANGE_BACK_TEXTURED_ANIMATION_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BACK_TEXTURED_ANIMATION")
	{
...
void ActionTableWidget::CHANGE_BACK_TEXTURED_ANIMATION_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BACK_TEXTURED_ANIMATION")
	{
...
void ActionCreator::CHANGE_BACK_TEXTURED_ANIMATION_SetAction(int _actionType)
{
	if(_actionType == TexturingSurface::CHANGE_BACK_TEXTURED_ANIMATION_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "CHANGE_BACK_TEXTURED_ANIMATION");

		ChangeBackTexturedAnimationAction* derived = dynamic_cast<ChangeBackTexturedAnimationAction*>(action);
...
void ActionCreator::CHANGE_BACK_TEXTURED_ANIMATION_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "CHANGE_BACK_TEXTURED_ANIMATION")
	{
		action = Trigger::_CreateAction(TexturingSurface::CHANGE_BACK_TEXTURED_ANIMATION_MESSAGE);
