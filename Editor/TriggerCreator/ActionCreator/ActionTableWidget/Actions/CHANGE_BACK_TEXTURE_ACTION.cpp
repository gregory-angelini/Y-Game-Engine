...
void ActionTableWidget::CHANGE_BACK_TEXTURE_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "CHANGE_BACK_TEXTURE")
	{
...
bool ActionTableWidget::CHANGE_BACK_TEXTURE_UpdateRow(const QModelIndex& _index, const QString& _type)
{
...
QString ActionTableWidget::CHANGE_BACK_TEXTURE_CreateAutoName(void)
{
...
bool ActionTableWidget::CHANGE_BACK_TEXTURE_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BACK_TEXTURE")
	{ 
...
bool ActionTableWidget::CHANGE_BACK_TEXTURE_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BACK_TEXTURE")
	{
...
void ActionTableWidget::CHANGE_BACK_TEXTURE_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_BACK_TEXTURE")
	{
...
void ActionCreator::CHANGE_BACK_TEXTURE_SetAction(int _actionType)
{
	if(_actionType == TexturingSurface::CHANGE_BACK_TEXTURE_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "CHANGE_BACK_TEXTURE");

		ChangeBackTextureAction* derived = dynamic_cast<ChangeBackTextureAction*>(action);
...
void ActionCreator::CHANGE_BACK_TEXTURE_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "CHANGE_BACK_TEXTURE")
	{
		action = Trigger::_CreateAction(TexturingSurface::CHANGE_BACK_TEXTURE_MESSAGE);
