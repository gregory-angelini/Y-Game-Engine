...
void ActionTableWidget::DISPLACE_SCALE_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "DISPLACE_SCALE")
	{
...
bool ActionTableWidget::DISPLACE_SCALE_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "DISPLACE_SCALE") 
	{
...
QString ActionTableWidget::DISPLACE_SCALE_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "DISPLACE_SCALE")
	{ 
		QString name;
...
bool ActionTableWidget::DISPLACE_SCALE_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "DISPLACE_SCALE")
	{ 
...
bool ActionTableWidget::DISPLACE_SCALE_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "DISPLACE_SCALE")
	{
...
void ActionTableWidget::DISPLACE_SCALE_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "DISPLACE_SCALE")
	{
...
void ActionCreator::DISPLACE_SCALE_SetAction(int _actionType)
{
	if(_actionType == ScalableObject::DISPLACE_SCALE_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "DISPLACE_SCALE");

		DisplaceScaleAction* derived = dynamic_cast<DisplaceScaleAction*>(action);
...
void ActionCreator::DISPLACE_SCALE_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "DISPLACE_SCALE")
	{
		action = Trigger::_CreateAction(ScalableObject::DISPLACE_SCALE_MESSAGE);
