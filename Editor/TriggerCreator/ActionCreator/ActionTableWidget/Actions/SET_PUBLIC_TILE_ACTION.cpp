...
void ActionTableWidget::SET_PUBLIC_TILE_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "SET_PUBLIC_TILE")
	{
...
bool ActionTableWidget::SET_PUBLIC_TILE_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "SET_PUBLIC_TILE") 
	{
		...
		{ 
			...
			if(item(ARG2_PROPERTY, ARG_MODE)->text() == "KEY")
			{
				SetCellText(ARG2_PROPERTY, CONTENT, "New name"); 
...
QString ActionTableWidget::SET_PUBLIC_TILE_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "SET_PUBLIC_TILE")
	{ 
		QString name;
...
bool ActionTableWidget::SET_PUBLIC_TILE_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "SET_PUBLIC_TILE")
	{ 
...
bool ActionTableWidget::SET_PUBLIC_TILE_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "SET_PUBLIC_TILE")
	{
...
bool ActionTableWidget::SET_PUBLIC_TILE_UpdateArg2KeyPropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "SET_PUBLIC_TILE")
	{ 
...
bool ActionTableWidget::SET_PUBLIC_TILE_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "SET_PUBLIC_TILE")
	{ 
...
void ActionTableWidget::SET_PUBLIC_TILE_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "SET_PUBLIC_TILE")
	{
...
void ActionCreator::SET_PUBLIC_TILE_SetAction(int _actionType)
{
	if(_actionType == TiledSpace3D::SET_PUBLIC_TILE_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "SET_PUBLIC_TILE");

		SetPublicTileAction* derived = dynamic_cast<SetPublicTileAction*>(action);
...
void ActionCreator::SET_PUBLIC_TILE_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "SET_PUBLIC_TILE")
	{
		action = Trigger::_CreateAction(TiledSpace3D::SET_PUBLIC_TILE_MESSAGE);
