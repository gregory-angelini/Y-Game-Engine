...
void ActionTableWidget::GET_POSITION_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "GET_POSITION")
	{
...
bool ActionTableWidget::GET_POSITION_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "GET_POSITION") 
	{
...
QString ActionTableWidget::GET_POSITION_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_POSITION")
	{ 
		QString name;
...
bool ActionTableWidget::GET_POSITION_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_POSITION")
	{ 
...
bool ActionTableWidget::GET_POSITION_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_POSITION")
	{
...
bool ActionTableWidget::GET_POSITION_UpdateArg2VariablePropertyStatus(void)
{
...
void ActionTableWidget::GET_POSITION_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_POSITION")
	{
...
void ActionCreator::GET_POSITION_SetAction(int _actionType)
{
	if(_actionType == TranslatableObject::GET_POSITION_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_POSITION");

		GetPositionAction* derived = dynamic_cast<GetPositionAction*>(action);
...
void ActionCreator::GET_POSITION_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "GET_POSITION")
	{
		action = Trigger::_CreateAction(TranslatableObject::GET_POSITION_MESSAGE);
