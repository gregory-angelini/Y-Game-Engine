...
void ActionTableWidget::CHANGE_PLAYING_DURATION_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "CHANGE_PLAYING_DURATION")
	{
...
bool ActionTableWidget::CHANGE_PLAYING_DURATION_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "CHANGE_PLAYING_DURATION") 
	{
...
QString ActionTableWidget::CHANGE_PLAYING_DURATION_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_PLAYING_DURATION")
	{ 
		QString name;
...
bool ActionTableWidget::CHANGE_PLAYING_DURATION_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_PLAYING_DURATION")
	{ 
...
bool ActionTableWidget::CHANGE_PLAYING_DURATION_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_PLAYING_DURATION")
	{
...
void ActionTableWidget::CHANGE_PLAYING_DURATION_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "CHANGE_PLAYING_DURATION")
	{
...
void ActionCreator::CHANGE_PLAYING_DURATION_SetAction(int _actionType)
{
	if(_actionType == PlayingObject::CHANGE_PLAYING_DURATION_IN_SEC_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "CHANGE_PLAYING_DURATION");

		ChangePlayingDurationInSecAction* derived = dynamic_cast<ChangePlayingDurationInSecAction*>(action);
...
void ActionCreator::CHANGE_PLAYING_DURATION_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "CHANGE_PLAYING_DURATION")
	{
		action = Trigger::_CreateAction(PlayingObject::CHANGE_PLAYING_DURATION_IN_SEC_MESSAGE);
