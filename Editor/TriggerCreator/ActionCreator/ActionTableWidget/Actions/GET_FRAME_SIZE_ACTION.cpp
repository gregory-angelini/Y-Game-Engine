...
void ActionTableWidget::GET_FRAME_SIZE_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "GET_FRAME_SIZE")
	{
...
bool ActionTableWidget::GET_FRAME_SIZE_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "GET_FRAME_SIZE") 
	{
...
QString ActionTableWidget::GET_FRAME_SIZE_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_FRAME_SIZE")
	{ 
		QString name;
...
bool ActionTableWidget::GET_FRAME_SIZE_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_FRAME_SIZE")
	{ 
...
bool ActionTableWidget::GET_FRAME_SIZE_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_FRAME_SIZE")
	{
...
void ActionTableWidget::GET_FRAME_SIZE_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_FRAME_SIZE")
	{
...
void ActionCreator::GET_FRAME_SIZE_SetAction(int _actionType)
{
	if(_actionType == TexturedAnimation::GET_FRAME_SIZE_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_FRAME_SIZE");

		GetFrameSizeAction* derived = dynamic_cast<GetFrameSizeAction*>(action);
...
void ActionCreator::GET_FRAME_SIZE_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "GET_FRAME_SIZE")
	{
		action = Trigger::_CreateAction(TexturedAnimation::GET_FRAME_SIZE_MESSAGE);
