...
void ActionTableWidget::GET_LINE_DIRECTION_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "GET_LINE_DIRECTION")
	{
...
bool ActionTableWidget::GET_LINE_DIRECTION_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "GET_LINE_DIRECTION") 
	{
...
QString ActionTableWidget::GET_LINE_DIRECTION_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_LINE_DIRECTION")
	{ 
		QString name;
...
bool ActionTableWidget::GET_LINE_DIRECTION_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_LINE_DIRECTION")
	{
...
bool ActionTableWidget::GET_LINE_DIRECTION_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_LINE_DIRECTION")
	{
...
bool ActionTableWidget::GET_LINE_DIRECTION_UpdateArg3VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_LINE_DIRECTION")
	{
...
void ActionTableWidget::GET_LINE_DIRECTION_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "GET_LINE_DIRECTION")
	{
...
void ActionCreator::GET_LINE_DIRECTION_SetAction(int _actionType)
{
	if(_actionType == Line::GET_LINE_DIRECTION_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "GET_LINE_DIRECTION");

		GetLineDirectionAction* derived = dynamic_cast<GetLineDirectionAction*>(action);
...
void ActionCreator::GET_LINE_DIRECTION_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "GET_LINE_DIRECTION")
	{
		action = Trigger::_CreateAction(Line::GET_LINE_DIRECTION_MESSAGE);
