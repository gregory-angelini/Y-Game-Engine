...
void ActionTableWidget::STREAMING_FLOAT_DELTA_GetEditorTypeForCell(const QModelIndex& _index, const QString& _actionType, int& _editor)
{
	if(_actionType == "STREAMING_FLOAT_DELTA")
	{
...
bool ActionTableWidget::STREAMING_FLOAT_DELTA_UpdateRow(const QModelIndex& _index, const QString& _type)
{
	if(_type == "STREAMING_FLOAT_DELTA") 
	{
...
QString ActionTableWidget::STREAMING_FLOAT_DELTA_CreateAutoName(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "STREAMING_FLOAT_DELTA")
	{ 
		QString name;
...
bool ActionTableWidget::STREAMING_FLOAT_DELTA_UpdateTargetVariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "STREAMING_FLOAT_DELTA")
	{ 
...
bool ActionTableWidget::STREAMING_FLOAT_DELTA_UpdateArg1VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "STREAMING_FLOAT_DELTA")
	{
...
bool ActionTableWidget::STREAMING_FLOAT_DELTA_UpdateArg2VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "STREAMING_FLOAT_DELTA")
	{
...
bool ActionTableWidget::STREAMING_FLOAT_DELTA_UpdateArg3VariablePropertyStatus(void)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "STREAMING_FLOAT_DELTA")
	{
...
void ActionTableWidget::STREAMING_FLOAT_DELTA_DropEvent(QTableWidgetItem* _it, const QModelIndex& _index, const QString& _suffix, QString& _fileName)
{
	if(item(TYPE_PROPERTY, VALUE)->text() == "STREAMING_FLOAT_DELTA")
	{
...
void ActionCreator::STREAMING_FLOAT_DELTA_SetAction(int _actionType)
{
	if(_actionType == FloatLerp::STREAMING_FLOAT_DELTA_MESSAGE)
	{
		actionTable->SetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE, "STREAMING_FLOAT_DELTA");

		StreamingFloatDeltaAction* derived = dynamic_cast<StreamingFloatDeltaAction*>(action);
...
void ActionCreator::STREAMING_FLOAT_DELTA_Create(void)
{
	if(actionTable->GetCellText(ActionTableWidget::TYPE_PROPERTY, ActionTableWidget::VALUE) == "STREAMING_FLOAT_DELTA")
	{
		action = Trigger::_CreateAction(FloatLerp::STREAMING_FLOAT_DELTA_MESSAGE);
