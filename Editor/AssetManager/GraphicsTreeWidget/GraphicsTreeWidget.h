#ifndef GRAPHICSTREEWIDGET_H
#define GRAPHICSTREEWIDGET_H
#include <Editor/ErrorDialog/ErrorDialog.h>
#include <Editor/AssetManager/GraphicsTreeWidget/GraphicsSceneItem.h>
#include <Engine/Output/Graphics/Object/GraphicsObject/GraphicsObject.h>
class GraphicsTreeWidget: public QTreeWidget,
			              public MessageHandler<int32>::Receiver
{
	...
	friend class GraphicsSceneItem;
	...
	private: GraphicsSceneItem* root;
	private: int scrollTimerId;
    private: QTreeWidgetItem* dropItem;
    private: bool autoParentEnable;
	public: GraphicsTreeWidget(QWidget* _parent = 0);
	public: virtual ~GraphicsTreeWidget(void);
	private: GraphicsSceneItem::Type GetAssetType(AbstractObject* _object);
	...
	public: GraphicsSceneItem* AddAsset(QString _name, GraphicsSceneItem::Type _assetType, int64 _objectClass, GraphicsObject* _object, GraphicsSceneItem* _parent = 0);
	public: QPixmap GetIcon(int _assetType);
	public: QString GetStringOfAssetType(GraphicsSceneItem::Type _assetType)const;
	public: void CreateRoot(void);
	public: GraphicsSceneItem* FindItem(QString _name);
	private: GraphicsSceneItem* FindItem(QTreeWidgetItem* _it, QString _name);
	public: GraphicsSceneItem* FindItem(QString _name, QString _parent);
	private: GraphicsSceneItem* FindItem(QTreeWidgetItem* _it, QString _name, QString _parent);
	private: GraphicsSceneItem* FindLeaf(QTreeWidgetItem* _item);
