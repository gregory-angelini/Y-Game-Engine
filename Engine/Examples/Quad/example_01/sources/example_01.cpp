...
class GraphicsQuad2D: public Quad<Vector3D>, // квад
...
class Application: public Renderer
{
	...
	private: Vector3D point;// координаты графической точки
	...
	public: virtual void Draw(float _delta)
	{
		...
		scene->Draw();
		GraphicsPoint<Vector3D>::_Draw(point, RGBA::WHITE_COLOR);// отобразить точку
