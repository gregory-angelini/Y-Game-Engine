#ifndef ROTATABLEOBJECTLIST_H
#define ROTATABLEOBJECTLIST_H
...
template<>
class List<RotatableObject>: public AbstractList,
	                         public MagicList<RotatableObject>
{
	public: enum: int64 
	{
		ROTATABLE_LIST_CLASS = 36028797018963968
	};
	...
	protected: void SaveItemToFile(MagicList<RotatableObject>::AddressDerived* _address, File& _file);
