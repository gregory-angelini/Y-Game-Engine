...
template<>
class List<StringANSI>: public AbstractList,
	                    public MagicList<Variable<StringANSI>>
{
	public: enum: int64 
	{
		STRING_LIST_CLASS = 70368744177664
	};
	...
	protected: void SaveItemToFile(MagicList<Variable<StringANSI>>::AddressDerived* _address, File& _file);
