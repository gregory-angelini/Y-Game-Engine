...
template<>
class List<float>: public AbstractList,
	               public MagicList<Variable<float>>
{
	public: enum: int64 
	{
		FLOAT_LIST_CLASS = 17592186044416
	};
	...
	protected: void SaveItemToFile(MagicList<Variable<float>>::AddressDerived* _address, File& _file);
