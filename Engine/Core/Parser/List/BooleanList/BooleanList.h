#ifndef BOOLEANLIST_H
#define BOOLEANLIST_H
#include <Engine/Core/Parser/List/List.h>
#include <Engine/Core/Parser/List/AbstractObjectList/AbstractObjectList.h>
template<>
class List<bool>: public AbstractList,
	              public MagicList<Variable<bool>>
{
	public: enum: int64 
	{
		BOOLEAN_LIST_CLASS = 35184372088832
	};
	...
	protected: void SaveItemToFile(MagicList<Variable<bool>>::AddressDerived* _address, File& _file);
