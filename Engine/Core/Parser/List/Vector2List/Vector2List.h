#ifndef VECTOR2LIST_H
#define VECTOR2LIST_H
...
template<>
class List<Vector2>: public AbstractList,
	                 public MagicList<Variable<Vector2>>
{
	public: enum: int64 
	{
		VECTOR_2_LIST_CLASS = 281474976710656
	};
	...
	protected: void SaveItemToFile(MagicList<Variable<Vector2>>::AddressDerived* _address, File& _file);
