#ifndef COLORABLEOBJECTLIST_H
#define COLORABLEOBJECTLIST_H
...
template<>
class List<ColorableObject>: public AbstractList,
	                         public MagicList<ColorableObject>
{
	public: enum: int64 
	{
		COLORABLE_LIST_CLASS = 72057594037927936
	};
	...
	public: virtual void SetItemValue(int32 _index, Vector4 _value);
	...
	protected: void SaveItemToFile(MagicList<ColorableObject>::AddressDerived* _address, File& _file);
