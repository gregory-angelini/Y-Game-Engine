#ifndef CHANGEINTERSECTIONMODEACTION_H
#define CHANGEINTERSECTIONMODEACTION_H
...
class ChangeIntersectionModeAction: public AbstractAction
{
	...
	private: ChangeIntersectionModeAction(void);
	private: ChangeIntersectionModeAction(int32 _type);
	public: virtual ~ChangeIntersectionModeAction(void);
