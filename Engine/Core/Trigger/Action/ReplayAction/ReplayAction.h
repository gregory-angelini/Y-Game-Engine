#ifndef REPLAYACTION_H
#define REPLAYACTION_H
...
class ReplayAction: public AbstractAction
{
	...
	private: ReplayAction(void);
	private: ReplayAction(int32 _type);
	public: virtual ~ReplayAction(void);
