#ifndef GETCAMERALOOKACTION_H
#define GETCAMERALOOKACTION_H
...
class GetCameraLookAction: public AbstractAction
{
	...
	private: GetCameraLookAction(void);
	private: GetCameraLookAction(int32 _type);
	public: virtual ~GetCameraLookAction(void);
