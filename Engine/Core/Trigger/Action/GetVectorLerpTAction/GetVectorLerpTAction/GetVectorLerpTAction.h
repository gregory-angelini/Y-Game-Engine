#ifndef GETVECTORLERPTACTION_H
#define GETVECTORLERPTACTION_H
...
class GetVectorLerpTAction: public AbstractAction
{
	...
	private: GetVectorLerpTAction(void);
	private: GetVectorLerpTAction(int32 _type);
	public: virtual ~GetVectorLerpTAction(void);
