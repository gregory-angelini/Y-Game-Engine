#ifndef GETSCALABLELERPTACTION_H
#define GETSCALABLELERPTACTION_H
...
class GetScalableLerpTAction: public AbstractAction
{
	...
	private: GetScalableLerpTAction(void);
	private: GetScalableLerpTAction(int32 _type);
	public: virtual ~GetScalableLerpTAction(void);
