#ifndef GETCOLORABLELERPTACTION_H
#define GETCOLORABLELERPTACTION_H
...
class GetColorableLerpTAction: public AbstractAction
{
	...
	private: GetColorableLerpTAction(void);
	private: GetColorableLerpTAction(int32 _type);
	public: virtual ~GetColorableLerpTAction(void);
