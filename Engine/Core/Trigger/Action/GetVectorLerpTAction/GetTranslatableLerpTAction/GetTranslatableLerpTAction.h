#ifndef GETTRANSLATABLELERPTACTION_H
#define GETTRANSLATABLELERPTACTION_H
...
class GetTranslatableLerpTAction: public AbstractAction
{
	...
	private: GetTranslatableLerpTAction(void);
	private: GetTranslatableLerpTAction(int32 _type);
	public: virtual ~GetTranslatableLerpTAction(void);
