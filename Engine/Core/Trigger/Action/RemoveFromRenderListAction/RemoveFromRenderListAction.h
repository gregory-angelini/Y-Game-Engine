#ifndef REMOVEFROMRENDERLISTACTION_H
#define REMOVEFROMRENDERLISTACTION_H
...
class RemoveFromRenderListAction: public AbstractAction
{
	...
	private: RemoveFromRenderListAction(void);
	private: RemoveFromRenderListAction(int32 _type);
	public: virtual ~RemoveFromRenderListAction(void);
