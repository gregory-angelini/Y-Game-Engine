#ifndef CHECKTILEPASSACTION_H
#define CHECKTILEPASSACTION_H
...
class CheckTilePassAction: public AbstractAction
{
	...
	private: CheckTilePassAction(void);
	private: CheckTilePassAction(int32 _type);
	public: virtual ~CheckTilePassAction(void);
