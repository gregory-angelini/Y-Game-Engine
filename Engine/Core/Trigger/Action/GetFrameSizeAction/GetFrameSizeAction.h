#ifndef GETFRAMESIZEACTION_H
#define GETFRAMESIZEACTION_H
...
class GetFrameSizeAction: public AbstractAction
{
	...
	private: GetFrameSizeAction(void);
	private: GetFrameSizeAction(int32 _type);
	public: virtual ~GetFrameSizeAction(void);
