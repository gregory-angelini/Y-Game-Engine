#ifndef CHANGECONTROLQUATERNIONSACTION_H
#define CHANGECONTROLQUATERNIONSACTION_H
...
class ChangeControlQuaternionsAction: public AbstractAction
{
	friend class Trigger;
	friend class AbstractAction;
	private: StringANSI argName;
    private: StringExprParserEx templateArg;
    private: MagicPointer<List<Quaternion>> arg;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<QuaternionLerp> target;
	private: ChangeControlQuaternionsAction(void);
	private: ChangeControlQuaternionsAction(int32 _type);
	public: virtual ~ChangeControlQuaternionsAction(void);
