#ifndef DISPLACEPOSITIONACTION_H
#define DISPLACEPOSITIONACTION_H
...
class DisplacePositionAction: public AbstractAction
{
	...
	private: MagicPointer<TranslatableObject> target;
	private: DisplacePositionAction(void);
	private: DisplacePositionAction(int32 _type);
	public: virtual ~DisplacePositionAction(void);
