#ifndef GETVECTORLERPPATHACTION_H
#define GETVECTORLERPPATHACTION_H
...
class GetVectorLerpPathAction: public AbstractAction
{
	...
	private: GetVectorLerpPathAction(void);
	private: GetVectorLerpPathAction(int32 _type);
	public: virtual ~GetVectorLerpPathAction(void);
