#ifndef CREATEBRUSHACTION_H
#define CREATEBRUSHACTION_H
...
class CreateBrushAction: public AbstractAction
{
	...
	private: CreateBrushAction(void);
	private: CreateBrushAction(int32 _type);
	public: virtual ~CreateBrushAction(void);
