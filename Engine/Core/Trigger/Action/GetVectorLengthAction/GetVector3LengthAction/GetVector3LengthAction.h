#ifndef GETVECTOR3LENGTHACTION_H
#define GETVECTOR3LENGTHACTION_H
...
class GetVector3LengthAction: public AbstractAction
{
	...
	private: GetVector3LengthAction(void);
	private: GetVector3LengthAction(int32 _type);
	public: virtual ~GetVector3LengthAction(void);
