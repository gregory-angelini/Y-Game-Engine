#ifndef PICKSCENEACTION_H
#define PICKSCENEACTION_H
...
class PickSceneAction: public AbstractAction
{
	friend class Trigger;
	friend class AbstractAction;
	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<Scene> target;
	private: PickSceneAction(void);
	private: PickSceneAction(int32 _type);
	public: virtual ~PickSceneAction(void);
