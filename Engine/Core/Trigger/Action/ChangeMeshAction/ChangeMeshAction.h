#ifndef CHANGEMESHACTION_H
#define CHANGEMESHACTION_H
...
class ChangeMeshAction: public AbstractAction
{
	...
	private: ChangeMeshAction(void);
	private: ChangeMeshAction(int32 _type);
	public: virtual ~ChangeMeshAction(void);
