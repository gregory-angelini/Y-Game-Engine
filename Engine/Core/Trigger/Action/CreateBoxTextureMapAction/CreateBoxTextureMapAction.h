#ifndef CREATEBOXTEXTUREMAPACTION_H
#define CREATEBOXTEXTUREMAPACTION_H
...
class CreateBoxTextureMapAction: public AbstractAction
{
	...
	private: MagicPointer<Texture2D> target;
	private: CreateBoxTextureMapAction(void);
	private: CreateBoxTextureMapAction(int32 _type);
	public: virtual ~CreateBoxTextureMapAction(void);
