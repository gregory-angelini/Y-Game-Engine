#ifndef GETNAMEACTION_H
#define GETNAMEACTION_H
...
class GetNameAction: public AbstractAction
{
	...
	private: GetNameAction(void);
	private: GetNameAction(int32 _type);
	public: virtual ~GetNameAction(void);
