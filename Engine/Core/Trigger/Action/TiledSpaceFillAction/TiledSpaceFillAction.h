#ifndef TILEDSPACEFILLACTION_H
#define TILEDSPACEFILLACTION_H
...
class TiledSpaceFillAction: public AbstractAction
{
	...
	private: TiledSpaceFillAction(void);
	private: TiledSpaceFillAction(int32 _type);
	public: virtual ~TiledSpaceFillAction(void);
