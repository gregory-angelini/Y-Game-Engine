#include "TiledSpaceFillAction.h"
...
TiledSpaceFillAction::TiledSpaceFillAction(void)
{}


TiledSpaceFillAction::TiledSpaceFillAction(int32 _type): AbstractAction(_type)
{}
...
void TiledSpaceFillAction::UpdateValid(void)
{
	valid = false; 
...
void TiledSpaceFillAction::SetVariableArg(int32 _index, StringANSI _name)
{
	switch(_index)
	{
		case ARG1:
			...
			if(arg1.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(Variable<int32>::INTEGER_VARIABLE_CLASS))
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::Arg1IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg2.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(Variable<int32>::INTEGER_VARIABLE_CLASS))
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::Arg2IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg3.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(Variable<int32>::INTEGER_VARIABLE_CLASS)) 
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::Arg3IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(target.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(TiledSpace3D::TILED_SPACE_3D_CLASS)) 
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::TargetIsRenamed));
							UpdateValid();
						}
						return;
					}
...
void TiledSpaceFillAction::SetTemplateArg(int32 _index, StringANSI _expr)
{
	switch(_index)
	{
		case ARG1:
		{
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::TemplateArg1IsCompleted));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::Arg1IsLost));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::TemplateArg1IsChanged));
		...
		case ARG2:
		{ 
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::TemplateArg2IsCompleted));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::Arg2IsLost));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::TemplateArg2IsChanged));
		...
		case ARG3:
		{
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::TemplateArg3IsCompleted));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::Arg3IsLost));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::TemplateArg3IsChanged));
		...
		case TARGET:
		{
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::TemplateTargetIsCompleted));
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::TargetIsLost));
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::TemplateTargetIsChanged));
...
void TiledSpaceFillAction::TemplateArg1IsCompleted(void)
{
...
void TiledSpaceFillAction::Arg1IsLost(void)
{
	if(arg1.IsNotEmpty())
	{ 
	...
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::ObjectIsCreated));
	valid = false;
}



void TiledSpaceFillAction::TemplateArg1IsChanged(void)
{
	Arg1IsLost();
...
void TiledSpaceFillAction::TemplateArg2IsCompleted(void)
{
...
void TiledSpaceFillAction::Arg2IsLost(void)
{
	if(arg2.IsNotEmpty())
	{ 
...
void TiledSpaceFillAction::TemplateArg2IsChanged(void)
{
	Arg2IsLost();
...
void TiledSpaceFillAction::TemplateArg3IsCompleted(void)
{
...
void TiledSpaceFillAction::Arg3IsLost(void)
{
	if(arg3.IsNotEmpty())
	{ 
...
void TiledSpaceFillAction::TemplateArg3IsChanged(void)
{
	Arg3IsLost();
...
void TiledSpaceFillAction::TemplateTargetIsCompleted(void)
{
...
void TiledSpaceFillAction::TargetIsLost(void)
{
...
void TiledSpaceFillAction::TemplateTargetIsChanged(void)
{
	TargetIsLost();
...
StringANSI TiledSpaceFillAction::GetTemplateArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI TiledSpaceFillAction::GetVariableArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
int32 TiledSpaceFillAction::GetIntegerKeyArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
void TiledSpaceFillAction::SetIntegerKeyArg(int32 _index, int32 _value)
{
	switch(_index)
	{
		case ARG1:
...
void TiledSpaceFillAction::operator () (void)
{
	if(IsValid()) 
	{
		target.Get()->Fill(arg1.Get()->GetValue(), arg2.Get()->GetValue(), arg3.Get()->GetValue());			
	}
}



void TiledSpaceFillAction::ObjectIsDestroyed(AbstractObject* _object)
{
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::ObjectIsCreated));
	valid = false;
}
...
void TiledSpaceFillAction::TargetIsRenamed(AbstractObject::NameInfo* _info)
{
	TargetIsLost();
}
...
void TiledSpaceFillAction::Arg1IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg1IsLost();
}


void TiledSpaceFillAction::Arg2IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg2IsLost();
}


void TiledSpaceFillAction::Arg3IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg3IsLost();
}


void TiledSpaceFillAction::ObjectIsCreated(AbstractObject* _object)
{
	if(target.IsEmpty())
	{
		if(state[TEMPLATE][TARGET])
		{
			...
			{ 
				if(templateTarget.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateTarget.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::TargetIsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG1])
		{
			if(_object->IsClassPropertyExist(Variable<int32>::INTEGER_VARIABLE_CLASS))
			{
				if(templateArg1.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg1.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::Arg1IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG2])
		{
			if(_object->IsClassPropertyExist(Variable<int32>::INTEGER_VARIABLE_CLASS))
			{
				if(templateArg2.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg2.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::Arg2IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG3])
		{
			if(_object->IsClassPropertyExist(Variable<int32>::INTEGER_VARIABLE_CLASS))
			{
				if(templateArg3.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg3.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &TiledSpaceFillAction::Arg3IsRenamed));
						UpdateValid();
					}
					return;
				}
...
bool TiledSpaceFillAction::SaveToFile(StringANSI _path)			
{
	if(_path.empty())
	{
...
bool TiledSpaceFillAction::SaveToFile(File& _file)
{
...
AbstractAction* TiledSpaceFillAction::_LoadFromFile(File& _file)
{
	TiledSpaceFillAction* action = new TiledSpaceFillAction(TiledSpace3D::TILED_SPACE_FILL_MESSAGE);
	StringANSI name;
	int32 length;
	_file.Read(length);
