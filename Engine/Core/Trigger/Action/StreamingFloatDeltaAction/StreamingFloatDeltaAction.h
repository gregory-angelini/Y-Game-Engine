#ifndef STREAMINGFLOATDELTAACTION_H
#define STREAMINGFLOATDELTAACTION_H
...
class StreamingFloatDeltaAction: public AbstractAction
{
	...
	private: StreamingFloatDeltaAction(void);
	private: StreamingFloatDeltaAction(int32 _type);
	public: virtual ~StreamingFloatDeltaAction(void);
