#ifndef CHANGEFRONTTEXTUREACTION_H
#define CHANGEFRONTTEXTUREACTION_H
...
class ChangeFrontTextureAction: public AbstractAction
{
	...
	private: ChangeFrontTextureAction(void);
	private: ChangeFrontTextureAction(int32 _type);
	public: virtual ~ChangeFrontTextureAction(void);
