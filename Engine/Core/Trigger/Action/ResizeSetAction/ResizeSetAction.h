#ifndef RESIZESETACTION_H
#define RESIZESETACTION_H
...
class ResizeSetAction: public AbstractAction
{
	...
	private: ResizeSetAction(void);
	private: ResizeSetAction(int32 _type);
	public: virtual ~ResizeSetAction(void);
