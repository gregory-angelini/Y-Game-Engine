#ifndef ADDTORENDERLISTACTION_H
#define ADDTORENDERLISTACTION_H
...
class AddToRenderListAction: public AbstractAction
{
	friend class Trigger;
	friend class AbstractAction;
	private: StringANSI arg1Name;
    private: StringExprParserEx templateArg1;
    private: MagicPointer<GraphicsObject> arg1;

	private: StringANSI arg2Name;
    private: StringExprParserEx templateArg2;
    private: MagicPointer<GraphicsObject> arg2;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<GraphicsScene> target;
	private: AddToRenderListAction(void);
	private: AddToRenderListAction(int32 _type);
	public: virtual ~AddToRenderListAction(void);
