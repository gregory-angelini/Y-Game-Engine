#ifndef CREATEQUATERNIONVARIABLEACTION_H
#define CREATEQUATERNIONVARIABLEACTION_H
...
class CreateQuaternionVariableAction: public AbstractAction
{
	...
	private: CreateQuaternionVariableAction(void);
	private: CreateQuaternionVariableAction(int32 _type);
	public: virtual ~CreateQuaternionVariableAction(void);
