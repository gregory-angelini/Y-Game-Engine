#ifndef CREATEBOOLEANVARIABLEACTION_H
#define CREATEBOOLEANVARIABLEACTION_H
...
class CreateBooleanVariableAction: public AbstractAction
{
	...
	private: CreateBooleanVariableAction(void);
	private: CreateBooleanVariableAction(int32 _type);
	public: virtual ~CreateBooleanVariableAction(void);
