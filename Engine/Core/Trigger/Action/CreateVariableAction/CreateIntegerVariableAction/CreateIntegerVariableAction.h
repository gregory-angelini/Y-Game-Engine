#ifndef CREATEINTEGERVARIABLEACTION_H
#define CREATEINTEGERVARIABLEACTION_H
...
class CreateIntegerVariableAction: public AbstractAction
{
	...
	private: CreateIntegerVariableAction(void);
	private: CreateIntegerVariableAction(int32 _type);
	public: virtual ~CreateIntegerVariableAction(void);
