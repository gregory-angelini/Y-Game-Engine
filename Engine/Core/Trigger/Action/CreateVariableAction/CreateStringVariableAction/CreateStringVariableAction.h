#ifndef CHANGESTRINGVARIABLEACTION_H
#define CHANGESTRINGVARIABLEACTION_H
...
class CreateStringVariableAction: public AbstractAction
{
	...
	private: CreateStringVariableAction(void);
	private: CreateStringVariableAction(int32 _type);
	public: virtual ~CreateStringVariableAction(void);
