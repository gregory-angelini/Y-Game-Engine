#include "CreateStringVariableAction.h"
#include <Engine/Core/AssetLibrary/AssetLibrary.h>
#include <Engine/Core/Trigger/Trigger.h>


CreateStringVariableAction::CreateStringVariableAction(void)
{}


CreateStringVariableAction::CreateStringVariableAction(int32 _type): AbstractAction(_type)
{}
...
void CreateStringVariableAction::UpdateValid(void)
{
	valid = false; 
...
void CreateStringVariableAction::SetVariableArg(int32 _index, StringANSI _name)
{
	switch(_index)
	{
		case ARG1:
			...
			if(arg1.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(Variable<StringANSI>::STRING_VARIABLE_CLASS)) 
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CreateStringVariableAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CreateStringVariableAction::Arg1IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg2.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(Variable<StringANSI>::STRING_VARIABLE_CLASS)) 
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CreateStringVariableAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CreateStringVariableAction::Arg2IsRenamed));
							UpdateValid();
						} 
						return;
					}
...
void CreateStringVariableAction::SetExpressionArg(int32 _index, StringANSI _expr)
{
	switch(_index)
	{
		case ARG2: 
...
void CreateStringVariableAction::SetTemplateArg(int32 _index, StringANSI _expr)
{
	switch(_index)
	{
		case ARG1:
		{
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CreateStringVariableAction::TemplateArg1IsCompleted));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CreateStringVariableAction::Arg1IsLost));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CreateStringVariableAction::TemplateArg1IsChanged));
		...
		case ARG2: 
		{
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CreateStringVariableAction::TemplateArg2IsCompleted));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CreateStringVariableAction::Arg2IsLost));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CreateStringVariableAction::TemplateArg2IsChanged));
...
void CreateStringVariableAction::SetStringKeyArg(int32 _index, StringANSI _value)
{
	switch(_index)
	{
		case ARG1:
...
void CreateStringVariableAction::TemplateArg2IsCompleted(void)
{
...
void CreateStringVariableAction::TemplateArg2IsChanged(void)
{
	Arg2IsLost();
...
void CreateStringVariableAction::Arg2IsLost(void)
{
	if(arg2.IsNotEmpty())
	{ 
	...
	expr.Destroy();
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &CreateStringVariableAction::ObjectIsCreated));
	valid = false;
}



void CreateStringVariableAction::TemplateArg1IsCompleted(void)
{
...
void CreateStringVariableAction::TemplateArg1IsChanged(void)
{
	Arg1IsLost();
...
void CreateStringVariableAction::Arg1IsLost(void)
{
	if(arg1.IsNotEmpty())
	{ 
...
StringANSI CreateStringVariableAction::GetExpressionArg(int32 _index)
{
	switch(_index)
	{
		case ARG2:
...
StringANSI CreateStringVariableAction::GetTemplateArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI CreateStringVariableAction::GetVariableArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI CreateStringVariableAction::GetStringKeyArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
void CreateStringVariableAction::operator () (void)
{
	if(IsValid()) 
	{
		if(state[KEY][ARG2])
		{
			Variable<StringANSI>* variable = new Variable<StringANSI>(arg2Value);
		...
		{
			if(expr.Calculate() == StringExprParser::NO_ERRORS)
			{  
				Variable<StringANSI>* variable = new Variable<StringANSI>(expr.GetResult());
		...
		{
			Variable<StringANSI>* variable = new Variable<StringANSI>(arg2.Get()->GetValue());
...
void CreateStringVariableAction::ObjectIsDestroyed(AbstractObject* _object)
{
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &CreateStringVariableAction::ObjectIsCreated));
	valid = false;
}
...
void CreateStringVariableAction::Arg1IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg1IsLost();
}


void CreateStringVariableAction::Arg2IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg2IsLost();
}


void CreateStringVariableAction::ObjectIsCreated(AbstractObject* _object)
{
	if(arg1.IsEmpty())
	{ 
		if(state[TEMPLATE][ARG1])
		{
			if(_object->IsClassPropertyExist(Variable<StringANSI>::STRING_VARIABLE_CLASS))
			{
				if(templateArg1.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg1.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CreateStringVariableAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CreateStringVariableAction::Arg1IsRenamed));
						UpdateValid(); 
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG2])
		{
			...
			{ 
				if(templateArg2.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg2.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CreateStringVariableAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CreateStringVariableAction::Arg2IsRenamed));
						UpdateValid();
					}
					return;
				}
...
bool CreateStringVariableAction::SaveToFile(StringANSI _path)			
{
	if(_path.empty())
	{
...
bool CreateStringVariableAction::SaveToFile(File& _file)
{
...
AbstractAction* CreateStringVariableAction::_LoadFromFile(File& _file)
{
	CreateStringVariableAction* action = new CreateStringVariableAction(AbstractVariable::CREATE_STRING_VARIABLE_MESSAGE);
	StringANSI name;
	int32 length;
	_file.Read(length);
