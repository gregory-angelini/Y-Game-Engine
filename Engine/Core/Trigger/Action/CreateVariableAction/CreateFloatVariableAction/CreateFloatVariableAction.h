#ifndef CREATEFLOATVARIABLEACTION_H
#define CREATEFLOATVARIABLEACTION_H
...
class CreateFloatVariableAction: public AbstractAction
{
	...
	private: CreateFloatVariableAction(void);
	private: CreateFloatVariableAction(int32 _type);
	public: virtual ~CreateFloatVariableAction(void);
