#include "CreateFloatVariableAction.h"
#include <Engine/Core/AssetLibrary/AssetLibrary.h>
#include <Engine/Core/Trigger/Trigger.h>


CreateFloatVariableAction::CreateFloatVariableAction(void)
{}


CreateFloatVariableAction::CreateFloatVariableAction(int32 _type): AbstractAction(_type), arg2Value(0.0f)
{}
...
void CreateFloatVariableAction::UpdateValid(void)
{
	valid = false; 
...
void CreateFloatVariableAction::SetVariableArg(int32 _index, StringANSI _name)
{
	switch(_index)
	{
		case ARG1:
			...
			if(arg1.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(Variable<StringANSI>::STRING_VARIABLE_CLASS)) 
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CreateFloatVariableAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CreateFloatVariableAction::Arg1IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg2.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(Variable<float>::FLOAT_VARIABLE_CLASS)) 
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CreateFloatVariableAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CreateFloatVariableAction::Arg2IsRenamed));
							UpdateValid();
						} 
						return;
					}
...
void CreateFloatVariableAction::SetExpressionArg(int32 _index, StringANSI _expr)
{
	switch(_index)
	{
		case ARG2: 
...
void CreateFloatVariableAction::SetTemplateArg(int32 _index, StringANSI _expr)
{
	switch(_index)
	{
		case ARG1:
		{
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CreateFloatVariableAction::TemplateArg1IsCompleted));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CreateFloatVariableAction::Arg1IsLost));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CreateFloatVariableAction::TemplateArg1IsChanged));
		...
		case ARG2: 
		{
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CreateFloatVariableAction::TemplateArg2IsCompleted));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CreateFloatVariableAction::Arg2IsLost));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CreateFloatVariableAction::TemplateArg2IsChanged));
...
void CreateFloatVariableAction::SetStringKeyArg(int32 _index, StringANSI _value)
{
	switch(_index)
	{
		case ARG1:
...
void CreateFloatVariableAction::SetFloatKeyArg(int32 _index, float _value)
{
	switch(_index)
	{
		case ARG2:  
...
void CreateFloatVariableAction::TemplateArg2IsCompleted(void)
{
...
void CreateFloatVariableAction::TemplateArg2IsChanged(void)
{
	Arg2IsLost();
...
void CreateFloatVariableAction::Arg2IsLost(void)
{
	if(arg2.IsNotEmpty())
	{ 
	...
	expr.Destroy();
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &CreateFloatVariableAction::ObjectIsCreated));
	valid = false;
}
 

void CreateFloatVariableAction::TemplateArg1IsCompleted(void)
{
...
void CreateFloatVariableAction::TemplateArg1IsChanged(void)
{
	Arg1IsLost();
...
void CreateFloatVariableAction::Arg1IsLost(void)
{
	if(arg1.IsNotEmpty())
	{ 
...
StringANSI CreateFloatVariableAction::GetExpressionArg(int32 _index)
{
	switch(_index)
	{
		case ARG2:
...
StringANSI CreateFloatVariableAction::GetTemplateArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI CreateFloatVariableAction::GetVariableArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI CreateFloatVariableAction::GetStringKeyArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
float CreateFloatVariableAction::GetFloatKeyArg(int32 _index)
{
	switch(_index)
	{
		case ARG2:
...
void CreateFloatVariableAction::operator () (void)
{
	if(IsValid()) 
	{
		if(state[KEY][ARG2])
		{
			Variable<float>* variable = new Variable<float>(arg2Value);
		...
		else if(state[EXPRESSION][ARG2])
		{
			...
			{  
				Variable<float>* variable = new Variable<float>(expr.GetResult());
		...
		{
			Variable<float>* variable = new Variable<float>(arg2.Get()->GetValue());
...
void CreateFloatVariableAction::ObjectIsDestroyed(AbstractObject* _object)
{
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &CreateFloatVariableAction::ObjectIsCreated));
	valid = false;
}
...
void CreateFloatVariableAction::Arg1IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg1IsLost();
}


void CreateFloatVariableAction::Arg2IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg2IsLost();
}


void CreateFloatVariableAction::ObjectIsCreated(AbstractObject* _object)
{
	if(arg1.IsEmpty())
	{ 
		if(state[TEMPLATE][ARG1])
		{
			if(_object->IsClassPropertyExist(Variable<StringANSI>::STRING_VARIABLE_CLASS))
			{
				if(templateArg1.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg1.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CreateFloatVariableAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CreateFloatVariableAction::Arg1IsRenamed));
						UpdateValid(); 
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG2])
		{
			...
			{ 
				if(templateArg2.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg2.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CreateFloatVariableAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CreateFloatVariableAction::Arg2IsRenamed));
						UpdateValid();
					}
					return;
				}
...
bool CreateFloatVariableAction::SaveToFile(StringANSI _path)			
{
	if(_path.empty())
	{
...
bool CreateFloatVariableAction::SaveToFile(File& _file)
{
...
AbstractAction* CreateFloatVariableAction::_LoadFromFile(File& _file)
{
	CreateFloatVariableAction* action = new CreateFloatVariableAction(AbstractVariable::CREATE_FLOAT_VARIABLE_MESSAGE);
	StringANSI name;
	int32 length;
	_file.Read(length);
