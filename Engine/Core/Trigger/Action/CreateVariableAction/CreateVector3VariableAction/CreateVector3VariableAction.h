#ifndef CREATEVECTOR3VARIABLEACTION_H
#define CREATEVECTOR3VARIABLEACTION_H
...
class CreateVector3VariableAction: public AbstractAction
{
	...
	private: CreateVector3VariableAction(void);
	private: CreateVector3VariableAction(int32 _type);
	public: virtual ~CreateVector3VariableAction(void);
