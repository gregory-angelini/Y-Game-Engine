#ifndef CHANGECONTROLCOLORABLESACTION_H
#define CHANGECONTROLCOLORABLESACTION_H
...
class ChangeControlColorablesAction: public AbstractAction
{
	friend class Trigger;
	friend class AbstractAction;
	private: StringANSI argName;
    private: StringExprParserEx templateArg;
    private: MagicPointer<List<ColorableObject>> arg;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<VectorLerp> target;
	private: ChangeControlColorablesAction(void);
	private: ChangeControlColorablesAction(int32 _type);
	public: virtual ~ChangeControlColorablesAction(void);
