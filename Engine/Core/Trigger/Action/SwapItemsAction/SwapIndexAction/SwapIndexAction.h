#ifndef SWAPINDEXACTION_H
#define SWAPINDEXACTION_H
...
class SwapIndexAction: public AbstractAction
{
	...
	private: SwapIndexAction(void);
	private: SwapIndexAction(int32 _type);
	public: virtual ~SwapIndexAction(void);
