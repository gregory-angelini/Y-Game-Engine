#ifndef GETSYSTEMTIMEACTION_H
#define GETSYSTEMTIMEACTION_H
...
class GetSystemTimeAction: public AbstractAction
{
	...
	private: GetSystemTimeAction(void);
	private: GetSystemTimeAction(int32 _type);
	public: virtual ~GetSystemTimeAction(void);
