#ifndef STREAMINGSCALABLECURRENTACTION_H
#define STREAMINGSCALABLECURRENTACTION_H
...
class StreamingScalableCurrentAction: public AbstractAction
{
	...
	private: StreamingScalableCurrentAction(void);
	private: StreamingScalableCurrentAction(int32 _type);
	public: virtual ~StreamingScalableCurrentAction(void);
