#ifndef STREAMINGVECTORCURRENTACTION_H
#define STREAMINGVECTORCURRENTACTION_H
...
class StreamingVectorCurrentAction: public AbstractAction
{
	...
	private: StreamingVectorCurrentAction(void);
	private: StreamingVectorCurrentAction(int32 _type);
	public: virtual ~StreamingVectorCurrentAction(void);
