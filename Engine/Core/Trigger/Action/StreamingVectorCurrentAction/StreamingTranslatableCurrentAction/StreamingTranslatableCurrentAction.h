#ifndef STREAMINGTRANSLATABLECURRENTACTION_H
#define STREAMINGTRANSLATABLECURRENTACTION_H
...
class StreamingTranslatableCurrentAction: public AbstractAction
{
	...
	private: StreamingTranslatableCurrentAction(void);
	private: StreamingTranslatableCurrentAction(int32 _type);
	public: virtual ~StreamingTranslatableCurrentAction(void);
