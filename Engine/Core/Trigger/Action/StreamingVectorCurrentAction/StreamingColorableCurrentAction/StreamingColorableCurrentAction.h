#ifndef STREAMINGCOLORABLECURRENTACTION_H
#define STREAMINGCOLORABLECURRENTACTION_H
...
class StreamingColorableCurrentAction: public AbstractAction
{
	...
	private: StreamingColorableCurrentAction(void);
	private: StreamingColorableCurrentAction(int32 _type);
	public: virtual ~StreamingColorableCurrentAction(void);
