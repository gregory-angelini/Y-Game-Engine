#ifndef STREAMINGROTATABLECURRENTACTION_H
#define STREAMINGROTATABLECURRENTACTION_H
...
class StreamingRotatableCurrentAction: public AbstractAction
{
	...
	private: StreamingRotatableCurrentAction(void);
	private: StreamingRotatableCurrentAction(int32 _type);
	public: virtual ~StreamingRotatableCurrentAction(void);
