#ifndef STREAMINGQUATERNIONCURRENTACTION_H
#define STREAMINGQUATERNIONCURRENTACTION_H
...
class StreamingQuaternionCurrentAction: public AbstractAction
{
	...
	private: StreamingQuaternionCurrentAction(void);
	private: StreamingQuaternionCurrentAction(int32 _type);
	public: virtual ~StreamingQuaternionCurrentAction(void);
