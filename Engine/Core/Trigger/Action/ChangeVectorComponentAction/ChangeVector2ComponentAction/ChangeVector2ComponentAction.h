#ifndef CHANGEVECTOR2COMPONENTACTION_H
#define CHANGEVECTOR2COMPONENTACTION_H
...
class ChangeVector2ComponentAction: public AbstractAction
{
	...
	private: ChangeVector2ComponentAction(void);
	private: ChangeVector2ComponentAction(int32 _type);
	public: virtual ~ChangeVector2ComponentAction(void);
