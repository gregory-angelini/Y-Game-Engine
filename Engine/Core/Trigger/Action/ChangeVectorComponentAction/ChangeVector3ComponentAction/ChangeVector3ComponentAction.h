#ifndef CHANGEVECTOR3COMPONENTACTION_H
#define CHANGEVECTOR3COMPONENTACTION_H
...
class ChangeVector3ComponentAction: public AbstractAction
{
	...
	private: ChangeVector3ComponentAction(void);
	private: ChangeVector3ComponentAction(int32 _type);
	public: virtual ~ChangeVector3ComponentAction(void);
