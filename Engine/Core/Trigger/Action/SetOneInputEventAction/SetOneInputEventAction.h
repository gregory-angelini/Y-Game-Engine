#ifndef SETONEINPUTEVENTACTION_H
#define SETONEINPUTEVENTACTION_H
...
class SetOneInputEventAction: public AbstractAction
{
    ...
    private: MagicPointer<Variable<int32>> arg3;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<PlayerControl> target;
	private: SetOneInputEventAction(void);
	private: SetOneInputEventAction(int32 _type);
	public: virtual ~SetOneInputEventAction(void);
