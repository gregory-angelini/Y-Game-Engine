#ifndef CHANGEFLOATLERPMODEACTION_H
#define CHANGEFLOATLERPMODEACTION_H
...
class ChangeFloatLerpModeAction: public AbstractAction
{
	...
	private: ChangeFloatLerpModeAction(void);
	private: ChangeFloatLerpModeAction(int32 _type);
	public: virtual ~ChangeFloatLerpModeAction(void);
