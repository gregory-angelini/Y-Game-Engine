#ifndef CHANGEBACKTEXTUREDANIMATIONACTION_H
#define CHANGEBACKTEXTUREDANIMATIONACTION_H
...
class ChangeBackTexturedAnimationAction: public AbstractAction
{
	...
	private: ChangeBackTexturedAnimationAction(void);
	private: ChangeBackTexturedAnimationAction(int32 _type);
	public: virtual ~ChangeBackTexturedAnimationAction(void);
