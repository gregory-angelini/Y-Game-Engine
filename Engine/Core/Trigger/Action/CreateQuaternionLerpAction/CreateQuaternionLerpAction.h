#ifndef CREATEQUATERNIONLERPACTION_H
#define CREATEQUATERNIONLERPACTION_H
...
class CreateQuaternionLerpAction: public AbstractAction
{
	...
	private: CreateQuaternionLerpAction(void);
	private: CreateQuaternionLerpAction(int32 _type);
	public: virtual ~CreateQuaternionLerpAction(void);
