#ifndef CHANGEITEMQUATERNIONACTION_H
#define CHANGEITEMQUATERNIONACTION_H
...
class ChangeItemQuaternionAction: public AbstractAction
{
	...
	private: MagicPointer<List<Quaternion>> target;
	private: ChangeItemQuaternionAction(void);
	private: ChangeItemQuaternionAction(int32 _type);
	public: virtual ~ChangeItemQuaternionAction(void);
