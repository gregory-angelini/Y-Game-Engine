#ifndef CHANGEITEMCOLORABLEACTION_H
#define CHANGEITEMCOLORABLEACTION_H
...
class ChangeItemColorableAction: public AbstractAction
{
	...
	private: MagicPointer<List<ColorableObject>> target;
	private: ChangeItemColorableAction(void);
	private: ChangeItemColorableAction(int32 _type);
	public: virtual ~ChangeItemColorableAction(void);
