#ifndef CHANGEITEMVECTOR3ACTION_H
#define CHANGEITEMVECTOR3ACTION_H
...
class ChangeItemVector3Action: public AbstractAction
{
	...
	private: MagicPointer<List<Vector3>> target;
	private: ChangeItemVector3Action(void);
	private: ChangeItemVector3Action(int32 _type);
	public: virtual ~ChangeItemVector3Action(void);
