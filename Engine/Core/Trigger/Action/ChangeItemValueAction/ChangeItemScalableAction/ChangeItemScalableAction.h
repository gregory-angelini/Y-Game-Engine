#ifndef CHANGEITEMSCALABLEACTION_H
#define CHANGEITEMSCALABLEACTION_H
...
class ChangeItemScalableAction: public AbstractAction
{
	...
	private: ChangeItemScalableAction(void);
	private: ChangeItemScalableAction(int32 _type);
	public: virtual ~ChangeItemScalableAction(void);
