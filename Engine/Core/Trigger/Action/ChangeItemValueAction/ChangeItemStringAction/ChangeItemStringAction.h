#ifndef CHANGEITEMSTRINGACTION_H
#define CHANGEITEMSTRINGACTION_H
...
class ChangeItemStringAction: public AbstractAction
{
	...
	private: MagicPointer<List<StringANSI>> target;
	private: ChangeItemStringAction(void);
	private: ChangeItemStringAction(int32 _type);
	public: virtual ~ChangeItemStringAction(void);
