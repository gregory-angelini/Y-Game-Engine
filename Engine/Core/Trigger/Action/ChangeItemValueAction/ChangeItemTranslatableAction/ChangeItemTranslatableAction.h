#ifndef CHANGEITEMTRANSLATABLEACTION_H
#define CHANGEITEMTRANSLATABLEACTION_H
...
class ChangeItemTranslatableAction: public AbstractAction
{
	...
	private: ChangeItemTranslatableAction(void);
	private: ChangeItemTranslatableAction(int32 _type);
	public: virtual ~ChangeItemTranslatableAction(void);
