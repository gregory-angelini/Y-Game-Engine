#ifndef CHANGEITEMVECTOR2ACTION_H
#define CHANGEITEMVECTOR2ACTION_H
...
class ChangeItemVector2Action: public AbstractAction
{
	...
	private: ChangeItemVector2Action(void);
	private: ChangeItemVector2Action(int32 _type);
	public: virtual ~ChangeItemVector2Action(void);
