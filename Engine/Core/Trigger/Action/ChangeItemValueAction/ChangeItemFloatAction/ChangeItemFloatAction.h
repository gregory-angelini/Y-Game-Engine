#ifndef CHANGEITEMFLOATACTION_H
#define CHANGEITEMFLOATACTION_H
...
class ChangeItemFloatAction: public AbstractAction
{
	...
	private: ChangeItemFloatAction(void);
	private: ChangeItemFloatAction(int32 _type);
	public: virtual ~ChangeItemFloatAction(void);
