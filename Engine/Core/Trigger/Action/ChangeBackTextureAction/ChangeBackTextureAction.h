#ifndef CHANGEBACKTEXTUREACTION_H
#define CHANGEBACKTEXTUREACTION_H
...
class ChangeBackTextureAction: public AbstractAction
{
	...
	private: ChangeBackTextureAction(void);
	private: ChangeBackTextureAction(int32 _type);
	public: virtual ~ChangeBackTextureAction(void);
