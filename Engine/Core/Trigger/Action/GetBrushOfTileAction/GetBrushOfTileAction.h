#ifndef GETBRUSHOFTILEACTION_H
#define GETBRUSHOFTILEACTION_H
...
class GetBrushOfTileAction: public AbstractAction
{
	...
	private: GetBrushOfTileAction(void);
	private: GetBrushOfTileAction(int32 _type);
	public: virtual ~GetBrushOfTileAction(void);
