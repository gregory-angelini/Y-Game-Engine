#ifndef GETRADIUSFROM2POINTSACTION_H
#define GETRADIUSFROM2POINTSACTION_H
...
class GetRadiusFrom2PointsAction: public AbstractAction
{
	...
	private: GetRadiusFrom2PointsAction(void);
	private: GetRadiusFrom2PointsAction(int32 _type);
	public: virtual ~GetRadiusFrom2PointsAction(void);
