#include "GetRadiusFrom2PointsAction.h"
...
GetRadiusFrom2PointsAction::GetRadiusFrom2PointsAction(void)
{}


GetRadiusFrom2PointsAction::GetRadiusFrom2PointsAction(int32 _type): AbstractAction(_type)
{}
...
void GetRadiusFrom2PointsAction::UpdateValid(void)
{
	valid = false; 
...
void GetRadiusFrom2PointsAction::SetVariableArg(int32 _index, StringANSI _name)
{
	switch(_index)
	{
		case ARG1:
			...
			if(arg1.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::Arg1IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg2.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::Arg2IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg3.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(Variable<float>::FLOAT_VARIABLE_CLASS)) 
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::Arg3IsRenamed));
							UpdateValid();
						}
						return;
					}
...
void GetRadiusFrom2PointsAction::SetTemplateArg(int32 _index, StringANSI _expr)
{
	switch(_index)
	{
		case ARG1:
		{
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::TemplateArg1IsCompleted));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::Arg1IsLost));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::TemplateArg1IsChanged));
		...
		case ARG2:
		{
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::TemplateArg2IsCompleted));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::Arg2IsLost));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::TemplateArg2IsChanged));
		...
		case ARG3:
		{ 
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::TemplateArg3IsCompleted));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::Arg3IsLost));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::TemplateArg3IsChanged));
...
void GetRadiusFrom2PointsAction::SetVector3KeyArg(int32 _index, Vector3 _value)
{
	switch(_index)
	{
		case ARG1:
...
void GetRadiusFrom2PointsAction::TemplateArg1IsCompleted(void)
{
...
void GetRadiusFrom2PointsAction::Arg1IsLost(void)
{
	if(arg1.IsNotEmpty())
	{ 
	...
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::ObjectIsCreated));
	valid = false;
}



void GetRadiusFrom2PointsAction::TemplateArg1IsChanged(void)
{
	Arg1IsLost();
...
void GetRadiusFrom2PointsAction::TemplateArg2IsCompleted(void)
{
...
void GetRadiusFrom2PointsAction::Arg2IsLost(void)
{
	if(arg2.IsNotEmpty())
	{ 
...
void GetRadiusFrom2PointsAction::TemplateArg2IsChanged(void)
{
	Arg2IsLost();
...
void GetRadiusFrom2PointsAction::TemplateArg3IsCompleted(void)
{
...
void GetRadiusFrom2PointsAction::Arg3IsLost(void)
{
	if(arg3.IsNotEmpty())
	{ 
...
void GetRadiusFrom2PointsAction::TemplateArg3IsChanged(void)
{
	Arg3IsLost();
...
StringANSI GetRadiusFrom2PointsAction::GetTemplateArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
Vector3 GetRadiusFrom2PointsAction::GetVector3KeyArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI GetRadiusFrom2PointsAction::GetVariableArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
void GetRadiusFrom2PointsAction::operator () (void)
{
	if(IsValid())
	{
		Circle circle(arg1.Get()->GetPosition(), arg2.Get()->GetPosition());

		arg3.Get()->SetValue(circle.radius);
	}
}



void GetRadiusFrom2PointsAction::ObjectIsDestroyed(AbstractObject* _object)
{
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::ObjectIsCreated));
	valid = false;
}
...
void GetRadiusFrom2PointsAction::Arg1IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg1IsLost();
}
...
void GetRadiusFrom2PointsAction::Arg2IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg2IsLost();
}
...
void GetRadiusFrom2PointsAction::Arg3IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg3IsLost();
}


void GetRadiusFrom2PointsAction::ObjectIsCreated(AbstractObject* _object)
{
	if(arg1.IsEmpty())
	{ 
		if(state[TEMPLATE][ARG1])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg1.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg1.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::Arg1IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG2])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg2.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg2.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::Arg2IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG3])
		{
			if(_object->IsClassPropertyExist(Variable<float>::FLOAT_VARIABLE_CLASS))
			{
				if(templateArg3.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg3.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetRadiusFrom2PointsAction::Arg3IsRenamed));
						UpdateValid();
					}
					return;
				}
...
bool GetRadiusFrom2PointsAction::SaveToFile(StringANSI _path)			
{
	if(_path.empty())
	{
...
bool GetRadiusFrom2PointsAction::SaveToFile(File& _file)
{
...
AbstractAction* GetRadiusFrom2PointsAction::_LoadFromFile(File& _file)
{
	GetRadiusFrom2PointsAction* action = new GetRadiusFrom2PointsAction(Circle::GET_RADIUS_FROM_2_POINTS_MESSAGE);
	StringANSI name;
	int32 length;
	_file.Read(length);
