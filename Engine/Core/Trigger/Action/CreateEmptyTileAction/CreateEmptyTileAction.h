#ifndef CREATEEMPTYTILEACTION_H
#define CREATEEMPTYTILEACTION_H
...
class CreateEmptyTileAction: public AbstractAction
{
	...
	private: CreateEmptyTileAction(void);
	private: CreateEmptyTileAction(int32 _type);
	public: virtual ~CreateEmptyTileAction(void);
