#ifndef RANDOMIZELISTACTION_H
#define RANDOMIZELISTACTION_H
...
class RandomizeListAction: public AbstractAction
{
	...
	private: RandomizeListAction(void);
	private: RandomizeListAction(int32 _type);
	public: virtual ~RandomizeListAction(void);
