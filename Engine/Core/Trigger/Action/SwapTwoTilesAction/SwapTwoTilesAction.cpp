...
SwapTwoTilesAction::SwapTwoTilesAction(void)
{}


SwapTwoTilesAction::SwapTwoTilesAction(int32 _type): AbstractAction(_type)
{}
...
void SwapTwoTilesAction::UpdateValid(void)
{
	valid = false; 
...
void SwapTwoTilesAction::SetVariableArg(int32 _index, StringANSI _name)
{
	switch(_index)
	{
		case ARG1:
			...
			if(arg1.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::Arg1IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg2.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::Arg2IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg3.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::Arg3IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(target.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(TiledSpace3D::TILED_SPACE_3D_CLASS)) 
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::TargetIsRenamed));
							UpdateValid();
						}
						return;
					}
...
void SwapTwoTilesAction::SetTemplateArg(int32 _index, StringANSI _expr)
{
	switch(_index)
	{
		case ARG1:
		{
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::TemplateArg1IsCompleted));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::Arg1IsLost));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::TemplateArg1IsChanged));
		...
		case ARG2:
		{
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::TemplateArg2IsCompleted));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::Arg2IsLost));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::TemplateArg2IsChanged));
		...
		case ARG3:
		{ 
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::TemplateArg3IsCompleted));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::Arg3IsLost));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::TemplateArg3IsChanged));
		...
		case TARGET:
		{
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::TemplateTargetIsCompleted));
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::TargetIsLost));
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::TemplateTargetIsChanged));
...
void SwapTwoTilesAction::SetVector3KeyArg(int32 _index, Vector3 _value)
{
	switch(_index)
	{
		case ARG1:
...
void SwapTwoTilesAction::TemplateArg1IsCompleted(void)
{
...
void SwapTwoTilesAction::Arg1IsLost(void)
{
	if(arg1.IsNotEmpty())
	{ 
	...
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::ObjectIsCreated));
	valid = false;
}



void SwapTwoTilesAction::TemplateArg1IsChanged(void)
{
	Arg1IsLost();
...
void SwapTwoTilesAction::TemplateArg2IsCompleted(void)
{
...
void SwapTwoTilesAction::Arg2IsLost(void)
{
	if(arg2.IsNotEmpty())
	{ 
...
void SwapTwoTilesAction::TemplateArg2IsChanged(void)
{
	Arg2IsLost();
...
void SwapTwoTilesAction::TemplateArg3IsCompleted(void)
{
...
void SwapTwoTilesAction::Arg3IsLost(void)
{
	if(arg3.IsNotEmpty())
	{ 
...
void SwapTwoTilesAction::TemplateArg3IsChanged(void)
{
	Arg3IsLost();
...
void SwapTwoTilesAction::TemplateTargetIsCompleted(void)
{
...
void SwapTwoTilesAction::TargetIsLost(void)
{
...
void SwapTwoTilesAction::TemplateTargetIsChanged(void)
{
	TargetIsLost();
...
StringANSI SwapTwoTilesAction::GetTemplateArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
Vector3 SwapTwoTilesAction::GetVector3KeyArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI SwapTwoTilesAction::GetVariableArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
void SwapTwoTilesAction::operator () (void)
{
	if(IsValid())
	{
		arg3.Get()->SetValue(target.Get()->SwapTile(arg1.Get()->GetPosition(), arg2.Get()->GetPosition()));
	} 
	else if(target.IsNotEmpty() && arg1.IsNotEmpty() && arg2.IsNotEmpty())
	{
		target.Get()->SwapTile(arg1.Get()->GetPosition(), arg2.Get()->GetPosition());
	}
}



void SwapTwoTilesAction::ObjectIsDestroyed(AbstractObject* _object)
{
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::ObjectIsCreated));
	valid = false;
}
...
void SwapTwoTilesAction::Arg1IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg1IsLost();
}
...
void SwapTwoTilesAction::Arg2IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg2IsLost();
}


void SwapTwoTilesAction::Arg3IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg3IsLost();
}


void SwapTwoTilesAction::TargetIsRenamed(AbstractObject::NameInfo* _info)
{
	TargetIsLost();
}


void SwapTwoTilesAction::ObjectIsCreated(AbstractObject* _object)
{
	if(target.IsEmpty())
	{
		if(state[TEMPLATE][TARGET])
		{
			...
			{ 
				if(templateTarget.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateTarget.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::TargetIsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG1])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg1.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg1.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::Arg1IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG2])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg2.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg2.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::Arg2IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG3])
		{
			if(_object->IsClassPropertyExist(Variable<bool>::BOOLEAN_VARIABLE_CLASS))
			{
				if(templateArg3.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg3.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &SwapTwoTilesAction::Arg3IsRenamed));
						UpdateValid();
					}
					return;
				}
...
bool SwapTwoTilesAction::SaveToFile(StringANSI _path)			
{
	if(_path.empty())
	{
...
bool SwapTwoTilesAction::SaveToFile(File& _file)
{
...
AbstractAction* SwapTwoTilesAction::_LoadFromFile(File& _file)
{
	SwapTwoTilesAction* action = new SwapTwoTilesAction(TiledSpace3D::SWAP_TWO_TILES_MESSAGE);
	StringANSI name;
	int32 length;
	_file.Read(length);
