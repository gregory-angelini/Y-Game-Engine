#ifndef SWAPTWOTILESACTION_H
#define SWAPTWOTILESACTION_H
...
class SwapTwoTilesAction: public AbstractAction
{
	...
	private: SwapTwoTilesAction(void);
	private: SwapTwoTilesAction(int32 _type);
	public: virtual ~SwapTwoTilesAction(void);
