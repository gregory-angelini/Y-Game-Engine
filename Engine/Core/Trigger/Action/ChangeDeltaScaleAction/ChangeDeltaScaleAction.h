#ifndef CHANGEDELTASCALEACTION_H
#define CHANGEDELTASCALEACTION_H
...
class ChangeDeltaScaleAction: public AbstractAction
{
	...
	private: MagicPointer<LogicObject> target;
	private: ChangeDeltaScaleAction(void);
	private: ChangeDeltaScaleAction(int32 _type);
	public: virtual ~ChangeDeltaScaleAction(void);
