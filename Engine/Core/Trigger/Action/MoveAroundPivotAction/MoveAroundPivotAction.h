#ifndef MOVEAROUNDPIVOTACTION_H
#define MOVEAROUNDPIVOTACTION_H
...
class MoveAroundPivotAction: public AbstractAction
{
	...
	private: MoveAroundPivotAction(void);
	private: MoveAroundPivotAction(int32 _type);
	public: virtual ~MoveAroundPivotAction(void);
