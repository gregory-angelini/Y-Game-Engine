#ifndef REMOVEITEMFROMLISTACTION_H
#define REMOVEITEMFROMLISTCTION_H
...
class RemoveItemFromListAction: public AbstractAction
{
	...
	private: RemoveItemFromListAction(void);
	private: RemoveItemFromListAction(int32 _type);
	public: virtual ~RemoveItemFromListAction(void);
