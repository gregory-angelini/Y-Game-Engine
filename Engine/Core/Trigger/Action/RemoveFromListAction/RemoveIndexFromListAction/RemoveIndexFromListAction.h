#ifndef REMOVEINDEXFROMLISTACTION_H
#define REMOVEINDEXFROMLISTACTION_H
...
class RemoveIndexFromListAction: public AbstractAction
{
	...
	private: RemoveIndexFromListAction(void);
	private: RemoveIndexFromListAction(int32 _type);
	public: virtual ~RemoveIndexFromListAction(void);
