#ifndef SETTWOCOLORABLESACTION_H
#define SETTWOCOLORABLESACTION_H
...
class SetTwoColorablesAction: public AbstractAction
{
	...
	private: SetTwoColorablesAction(void);
	private: SetTwoColorablesAction(int32 _type);
	public: virtual ~SetTwoColorablesAction(void);
