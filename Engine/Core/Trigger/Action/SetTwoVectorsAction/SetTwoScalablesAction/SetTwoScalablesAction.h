#ifndef SETTWOSCALABLESACTION_H
#define SETTWOSCALABLESACTION_H
...
class SetTwoScalablesAction: public AbstractAction
{
	...
	private: SetTwoScalablesAction(void);
	private: SetTwoScalablesAction(int32 _type);
	public: virtual ~SetTwoScalablesAction(void);
