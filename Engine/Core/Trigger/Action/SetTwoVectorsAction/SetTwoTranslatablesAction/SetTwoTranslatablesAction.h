#ifndef SETTWOTRANSLATABLESACTION_H
#define SETTWOTRANSLATABLESACTION_H
...
class SetTwoTranslatablesAction: public AbstractAction
{
	...
	private: SetTwoTranslatablesAction(void);
	private: SetTwoTranslatablesAction(int32 _type);
	public: virtual ~SetTwoTranslatablesAction(void);
