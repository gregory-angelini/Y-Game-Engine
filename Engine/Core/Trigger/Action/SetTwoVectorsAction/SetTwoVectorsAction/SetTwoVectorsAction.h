#ifndef SETTWOVECTORSACTION_H
#define SETTWOVECTORSACTION_H
...
class SetTwoVectorsAction: public AbstractAction
{
	...
	private: SetTwoVectorsAction(void);
	private: SetTwoVectorsAction(int32 _type);
	public: virtual ~SetTwoVectorsAction(void);
