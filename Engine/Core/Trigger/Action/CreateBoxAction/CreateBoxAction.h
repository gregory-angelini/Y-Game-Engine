#ifndef CREATEBOXACTION_H
#define CREATEBOXACTION_H
...
#include <Engine/Core/Container/MagicPointer/MagicPointer.h>
#include <Engine/Core/Trigger/StringExprParserEx/StringExprParserEx.h>
class CreateBoxAction: public AbstractAction
{
	...
	private: CreateBoxAction(void);
	private: CreateBoxAction(int32 _type);
	public: virtual ~CreateBoxAction(void);
