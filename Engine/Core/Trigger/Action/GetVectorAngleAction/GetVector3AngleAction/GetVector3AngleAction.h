#ifndef GETVECTOR3ANGLEACTION_H
#define GETVECTOR3ANGLEACTION_H
...
class GetVector3AngleAction: public AbstractAction
{
	...
	private: GetVector3AngleAction(void);
	private: GetVector3AngleAction(int32 _type);
	public: virtual ~GetVector3AngleAction(void);
