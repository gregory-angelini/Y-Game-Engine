#ifndef ADDTOLISTACTION_H
#define ADDTOLISTACTION_H
...
class AddToListAction: public AbstractAction
{
	...
	private: AddToListAction(void);
	private: AddToListAction(int32 _type);
	public: virtual ~AddToListAction(void);
