#ifndef REPLACESCALEACTION_H
#define REPLACESCALEACTION_H
...
class ReplaceScaleAction: public AbstractAction
{
	...
	private: ReplaceScaleAction(void);
	private: ReplaceScaleAction(int32 _type);
	public: virtual ~ReplaceScaleAction(void);
