#ifndef GETAMOUNTOFSLOTSACTION_H
#define GETAMOUNTOFSLOTSACTION_H
...
class GetAmountOfSlotsAction: public AbstractAction
{
	...
	private: GetAmountOfSlotsAction(void);
	private: GetAmountOfSlotsAction(int32 _type);
	public: virtual ~GetAmountOfSlotsAction(void);
