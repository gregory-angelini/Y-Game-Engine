#ifndef CHECKLINEINPOLYGONACTION_H
#define CHECKLINEINPOLYGONACTION_H
...
class CheckLineInPolygonAction: public AbstractAction
{
	...
	private: CheckLineInPolygonAction(void);
	private: CheckLineInPolygonAction(int32 _type);
	public: virtual ~CheckLineInPolygonAction(void);
