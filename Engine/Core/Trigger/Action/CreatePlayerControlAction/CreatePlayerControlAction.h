#ifndef CREATEPLAYERCONTROLACTION_H
#define CREATEPLAYERCONTROLACTION_H
...
class CreatePlayerControlAction: public AbstractAction
{
	...
	private: CreatePlayerControlAction(void);
	private: CreatePlayerControlAction(int32 _type);
	public: virtual ~CreatePlayerControlAction(void);
