#ifndef ROTATELISTACTION_H
#define ROTATELISTACTION_H
...
class RotateListAction: public AbstractAction
{
	...
	private: RotateListAction(void);
	private: RotateListAction(int32 _type);
	public: virtual ~RotateListAction(void);
