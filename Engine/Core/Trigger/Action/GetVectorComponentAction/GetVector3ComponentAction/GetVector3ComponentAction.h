#ifndef GETVECTOR3COMPONENTACTION_H
#define GETVECTOR3COMPONENTACTION_H
...
class GetVector3ComponentAction: public AbstractAction
{
	...
	private: GetVector3ComponentAction(void);
	private: GetVector3ComponentAction(int32 _type);
	public: virtual ~GetVector3ComponentAction(void);
