#ifndef GETVECTOR2COMPONENTACTION_H
#define GETVECTOR2COMPONENTACTION_H
...
class GetVector2ComponentAction: public AbstractAction
{
	...
	private: GetVector2ComponentAction(void);
	private: GetVector2ComponentAction(int32 _type);
	public: virtual ~GetVector2ComponentAction(void);
