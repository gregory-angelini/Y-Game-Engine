#ifndef SETDATATOCONTROLVECTORACTION_H
#define SETDATATOCONTROLVECTORACTION_H
...
class SetDataToControlVectorAction: public AbstractAction
{
	...
	private: SetDataToControlVectorAction(void);
	private: SetDataToControlVectorAction(int32 _type);
	public: virtual ~SetDataToControlVectorAction(void);
