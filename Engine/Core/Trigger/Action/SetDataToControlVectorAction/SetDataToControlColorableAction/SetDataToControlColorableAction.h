#ifndef SETDATATOCONTROLCOLORABLEACTION_H
#define SETDATATOCONTROLCOLORABLEACTION_H
...
class SetDataToControlColorableAction: public AbstractAction
{
	...
	private: SetDataToControlColorableAction(void);
	private: SetDataToControlColorableAction(int32 _type);
	public: virtual ~SetDataToControlColorableAction(void);
