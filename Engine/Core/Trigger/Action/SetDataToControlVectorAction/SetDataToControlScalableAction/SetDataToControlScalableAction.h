#ifndef SETDATATOCONTROLSCALABLEACTION_H
#define SETDATATOCONTROLSCALABLEACTION_H
...
class SetDataToControlScalableAction: public AbstractAction
{
	...
	private: SetDataToControlScalableAction(void);
	private: SetDataToControlScalableAction(int32 _type);
	public: virtual ~SetDataToControlScalableAction(void);
