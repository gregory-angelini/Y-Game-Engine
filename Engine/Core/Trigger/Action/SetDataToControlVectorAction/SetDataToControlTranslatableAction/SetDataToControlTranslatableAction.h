#ifndef SETDATATOCONTROLTRANSLATABLEACTION_H
#define SETDATATOCONTROLTRANSLATABLEACTION_H
...
class SetDataToControlTranslatableAction: public AbstractAction
{
	...
	private: SetDataToControlTranslatableAction(void);
	private: SetDataToControlTranslatableAction(int32 _type);
	public: virtual ~SetDataToControlTranslatableAction(void);
