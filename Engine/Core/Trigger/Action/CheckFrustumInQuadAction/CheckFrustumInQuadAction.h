#ifndef CHECKFRUSTUMINQUADACTION_H
#define CHECKFRUSTUMINQUADACTION_H
...
class CheckFrustumInQuadAction: public AbstractAction
{
    ...
    private: MagicPointer<Variable<Vector2>> arg3;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<Camera3D> target;
	private: CheckFrustumInQuadAction(void);
	private: CheckFrustumInQuadAction(int32 _type);
	public: virtual ~CheckFrustumInQuadAction(void);
