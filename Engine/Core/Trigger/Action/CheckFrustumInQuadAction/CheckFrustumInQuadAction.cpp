#include "CheckFrustumInQuadAction.h"
#include <Engine/Core/AssetLibrary/AssetLibrary.h>
#include <Engine/Core/Trigger/Trigger.h>


CheckFrustumInQuadAction::CheckFrustumInQuadAction(void)
{}


CheckFrustumInQuadAction::CheckFrustumInQuadAction(int32 _type): AbstractAction(_type)
{}
...
void CheckFrustumInQuadAction::UpdateValid(void)
{
	valid = false; 
...
void CheckFrustumInQuadAction::SetVariableArg(int32 _index, StringANSI _name)
{
	switch(_index)
	{
		case ARG1:
			...
			if(arg1.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::Arg1IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg2.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::Arg2IsRenamed));
							UpdateValid();
						}
						return;
					}
		...
		case ARG3:
		{
			...
			if(arg3.IsEmpty())
			{
				if(object)
				{
					...
					{
						if(arg3.Attach(dynamic_cast<Variable<Vector2>*>(object)))
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::Arg3IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(target.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(Camera3D::CAMERA_3D_CLASS))
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::TargetIsRenamed));
							UpdateValid();
						}
						return;
					}
...
void CheckFrustumInQuadAction::SetTemplateArg(int32 _index, StringANSI _expr)
{
	switch(_index)
	{
		case ARG1:
		{
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::TemplateArg1IsCompleted));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::Arg1IsLost));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::TemplateArg1IsChanged));
		...
		case ARG2:
		{
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::TemplateArg2IsCompleted));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::Arg2IsLost));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::TemplateArg2IsChanged));
		...
		case ARG3:
		{
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::TemplateArg3IsCompleted));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::Arg3IsLost));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::TemplateArg3IsChanged));
		...
		case TARGET:
		{
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::TemplateTargetIsCompleted));
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::TargetIsLost));
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::TemplateTargetIsChanged));
...
void CheckFrustumInQuadAction::TemplateArg1IsCompleted(void)
{
...
void CheckFrustumInQuadAction::SetVector2KeyArg(int32 _index, Vector2 _value)
{
	switch(_index)
	{
		case ARG3:
...
Vector2 CheckFrustumInQuadAction::GetVector2KeyArg(int32 _index)
{
	switch(_index)
	{
		case ARG3:
...
void CheckFrustumInQuadAction::SetVector3KeyArg(int32 _index, Vector3 _value)
{
	switch(_index)
	{ 
		case ARG2:
...
void CheckFrustumInQuadAction::TemplateArg2IsCompleted(void)
{
...
void CheckFrustumInQuadAction::TemplateArg3IsCompleted(void)
{
...
void CheckFrustumInQuadAction::Arg1IsLost(void)
{
	if(arg1.IsNotEmpty())
	{ 
	...
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::ObjectIsCreated));
	valid = false;
}


void CheckFrustumInQuadAction::Arg2IsLost(void)
{
	if(arg2.IsNotEmpty())
	{ 
...
void CheckFrustumInQuadAction::Arg3IsLost(void)
{
	if(arg3.IsNotEmpty())
	{ 
...
void CheckFrustumInQuadAction::TemplateArg1IsChanged(void)
{
	Arg1IsLost();
...
void CheckFrustumInQuadAction::TemplateArg2IsChanged(void)
{
	Arg2IsLost();
...
void CheckFrustumInQuadAction::TemplateArg3IsChanged(void)
{
	Arg3IsLost();
...
void CheckFrustumInQuadAction::TemplateTargetIsCompleted(void)
{
...
void CheckFrustumInQuadAction::TargetIsLost(void)
{
...
void CheckFrustumInQuadAction::TemplateTargetIsChanged(void)
{
	TargetIsLost();
...
StringANSI CheckFrustumInQuadAction::GetTemplateArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI CheckFrustumInQuadAction::GetVariableArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
Vector3 CheckFrustumInQuadAction::GetVector3KeyArg(int32 _index)
{
	switch(_index)
	{			
		case ARG2:
...
void CheckFrustumInQuadAction::operator () (void)
{
	if(IsValid())
	{
		arg1.Get()->SetValue(target.Get()->IsFrustumInQuad(Quad(arg2.Get()->GetPosition(), arg3.Get()->GetValue())));
	}
}



void CheckFrustumInQuadAction::ObjectIsDestroyed(AbstractObject* _object)
{
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::ObjectIsCreated));
	valid = false;
}
...
void CheckFrustumInQuadAction::TargetIsRenamed(AbstractObject::NameInfo* _info)
{
	TargetIsLost();
}
...
void CheckFrustumInQuadAction::Arg1IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg1IsLost();
}


void CheckFrustumInQuadAction::Arg2IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg2IsLost();
}


void CheckFrustumInQuadAction::Arg3IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg3IsLost();
}
...
void CheckFrustumInQuadAction::ObjectIsCreated(AbstractObject* _object)
{
	if(target.IsEmpty())
	{
		if(state[TEMPLATE][TARGET])
		{
			if(_object->IsClassPropertyExist(Camera3D::CAMERA_3D_CLASS))
			{
				if(templateTarget.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateTarget.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::TargetIsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG1])
		{
			if(_object->IsClassPropertyExist(Variable<bool>::BOOLEAN_VARIABLE_CLASS))
			{
				if(templateArg1.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg1.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::Arg1IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG2])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg2.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg2.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::Arg2IsRenamed));
						UpdateValid();
					}
					return;
				}
	...
	{ 
		if(state[TEMPLATE][ARG3])
		{
			if(_object->IsClassPropertyExist(Variable<Vector2>::VECTOR_2_VARIABLE_CLASS))
			{
				...
				{
					if(arg3.Attach(dynamic_cast<Variable<Vector2>*>(_object)))
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckFrustumInQuadAction::Arg3IsRenamed));
						UpdateValid();
					}
					return;
				}
...
bool CheckFrustumInQuadAction::SaveToFile(StringANSI _path)			
{
	if(_path.empty())
	{
...
bool CheckFrustumInQuadAction::SaveToFile(File& _file)
{
	if(_file.IsOpened() && (_file.GetAccessMode() == File::WRITE || _file.GetAccessMode() == File::REWRITE))
	{
		...
		{
			_file.Write(GetVector2KeyArg(ARG3));
		}
		if(state[TEMPLATE][TARGET])
		{
...
AbstractAction* CheckFrustumInQuadAction::_LoadFromFile(File& _file)
{
	CheckFrustumInQuadAction* action = new CheckFrustumInQuadAction(Camera3D::CHECK_FRUSTUM_IN_QUAD_MESSAGE);
	StringANSI name;
	int32 length;
	_file.Read(length);
	...
	else if(action->state[KEY][ARG3])
	{
		Vector2 arg; 
		_file.Read(arg); 
		action->SetVector2KeyArg(ARG3, arg);
	}
