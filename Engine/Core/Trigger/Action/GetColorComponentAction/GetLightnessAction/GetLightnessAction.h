#ifndef GETLIGHTNESSACTION_H
#define GETLIGHTNESSACTION_H
...
class GetLightnessAction: public AbstractAction
{
	...
	private: GetLightnessAction(void);
	private: GetLightnessAction(int32 _type);
	public: virtual ~GetLightnessAction(void);
