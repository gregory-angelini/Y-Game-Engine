#ifndef GETGREENACTION_H
#define GETGREENACTION_H
...
class GetGreenAction: public AbstractAction
{
	...
	private: GetGreenAction(void);
	private: GetGreenAction(int32 _type);
	public: virtual ~GetGreenAction(void);
