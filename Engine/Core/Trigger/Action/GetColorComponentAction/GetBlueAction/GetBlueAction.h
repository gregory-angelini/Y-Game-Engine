#ifndef GETBLUEACTION_H
#define GETBLUEACTION_H
...
class GetBlueAction: public AbstractAction
{
	...
	private: GetBlueAction(void);
	private: GetBlueAction(int32 _type);
	public: virtual ~GetBlueAction(void);
