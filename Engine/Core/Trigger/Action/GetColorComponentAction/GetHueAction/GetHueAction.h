#ifndef GETHUEACTION_H
#define GETHUEACTION_H
...
class GetHueAction: public AbstractAction
{
	...
	private: GetHueAction(void);
	private: GetHueAction(int32 _type);
	public: virtual ~GetHueAction(void);
