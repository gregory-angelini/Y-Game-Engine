#ifndef GETREDACTION_H
#define GETREDACTION_H
...
class GetRedAction: public AbstractAction
{
	...
	private: GetRedAction(void);
	private: GetRedAction(int32 _type);
	public: virtual ~GetRedAction(void);
