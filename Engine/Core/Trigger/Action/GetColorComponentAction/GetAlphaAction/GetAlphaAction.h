#ifndef GETALPHAACTION_H
#define GETALPHAACTION_H
...
class GetAlphaAction: public AbstractAction
{
	...
	private: GetAlphaAction(void);
	private: GetAlphaAction(int32 _type);
	public: virtual ~GetAlphaAction(void);
