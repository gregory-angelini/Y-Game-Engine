#ifndef CHANGEDEACTIVATIONMODEACTION_H
#define CHANGEDEACTIVATIONMODEACTION_H
...
class ChangeDeactivationModeAction: public AbstractAction
{
	...
	private: MagicPointer<ActivatableObject> target;
	private: ChangeDeactivationModeAction(void);
	private: ChangeDeactivationModeAction(int32 _type);
	public: virtual ~ChangeDeactivationModeAction(void);
