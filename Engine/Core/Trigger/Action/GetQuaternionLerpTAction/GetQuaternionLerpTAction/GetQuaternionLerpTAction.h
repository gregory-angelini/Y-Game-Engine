#ifndef GETQUATERNIONLERPTACTION_H
#define GETQUATERNIONLERPTACTION_H
...
class GetQuaternionLerpTAction: public AbstractAction
{
	...
	private: GetQuaternionLerpTAction(void);
	private: GetQuaternionLerpTAction(int32 _type);
	public: virtual ~GetQuaternionLerpTAction(void);
