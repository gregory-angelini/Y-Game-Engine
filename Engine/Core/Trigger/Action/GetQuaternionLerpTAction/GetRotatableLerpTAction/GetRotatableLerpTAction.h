#ifndef GETROTATABLELERPTACTION_H
#define GETROTATABLELERPTACTION_H
...
class GetRotatableLerpTAction: public AbstractAction
{
	...
	private: GetRotatableLerpTAction(void);
	private: GetRotatableLerpTAction(int32 _type);
	public: virtual ~GetRotatableLerpTAction(void);
