#include "StreamingScalableDeltaAction.h"
#include <Engine/Core/AssetLibrary/AssetLibrary.h>
#include <Engine/Core/Trigger/Trigger.h>


StreamingScalableDeltaAction::StreamingScalableDeltaAction(void)
{}


StreamingScalableDeltaAction::StreamingScalableDeltaAction(int32 _type): AbstractAction(_type)
{}
...
void StreamingScalableDeltaAction::UpdateValid(void)
{
	valid = false; 
...
void StreamingScalableDeltaAction::SetVariableArg(int32 _index, StringANSI _name)
{
	switch(_index)
	{
		case ARG1:
			...
			if(arg1.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::Arg1IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg2.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::Arg2IsRenamed));
							UpdateValid();
						}
						return;
					}
		...
		case ARG3:
		{
			...
			if(arg3.IsEmpty())
			{
				if(object)
				{
					...
					{  
						if(loadArgsEnable) { state[ASSET_TYPE][_index] = AssetLibrary::_GetAssetType(object->GetClassProperties()); }
						if(arg3.Attach(dynamic_cast<ScalableObject*>(object)))
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::Arg3IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(target.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(VectorLerp::VECTOR_LERP_CLASS)) 
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::TargetIsRenamed));
							UpdateValid();
						}
						return;
					}
...
void StreamingScalableDeltaAction::SetTemplateArg(int32 _index, StringANSI _expr)
{
	switch(_index)
	{
		case ARG1:
		{
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::TemplateArg1IsCompleted));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::Arg1IsLost));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::TemplateArg1IsChanged));
		...
		case ARG2:
		{
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::TemplateArg2IsCompleted));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::Arg2IsLost));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::TemplateArg2IsChanged));
		...
		case ARG3:
		{
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::TemplateArg3IsCompleted));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::Arg3IsLost));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::TemplateArg3IsChanged));
		...
		case TARGET:
		{
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::TemplateTargetIsCompleted));
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::TargetIsLost));
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::TemplateTargetIsChanged));
...
void StreamingScalableDeltaAction::SetBooleanKeyArg(int32 _index, bool _value)
{
	switch(_index)
	{
		case ARG1:
...
void StreamingScalableDeltaAction::TemplateArg1IsCompleted(void)
{
...
void StreamingScalableDeltaAction::TemplateArg2IsCompleted(void)
{
...
void StreamingScalableDeltaAction::TemplateArg3IsCompleted(void)
{
...
void StreamingScalableDeltaAction::Arg1IsLost(void)
{
	if(arg1.IsNotEmpty())
	{ 
	...
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::ObjectIsCreated));
	valid = false;
}



void StreamingScalableDeltaAction::Arg2IsLost(void)
{
	if(arg2.IsNotEmpty())
	{ 
...
void StreamingScalableDeltaAction::Arg3IsLost(void)
{
	if(arg3.IsNotEmpty())
	{ 
...
void StreamingScalableDeltaAction::TemplateArg1IsChanged(void)
{
	Arg1IsLost();
...
void StreamingScalableDeltaAction::TemplateArg2IsChanged(void)
{
	Arg2IsLost();
...
void StreamingScalableDeltaAction::TemplateArg3IsChanged(void)
{
	Arg3IsLost();
...
void StreamingScalableDeltaAction::TemplateTargetIsCompleted(void)
{
...
void StreamingScalableDeltaAction::TargetIsLost(void)
{
	if(target.IsNotEmpty())
	{
		if(arg3.IsNotEmpty())
...
void StreamingScalableDeltaAction::TemplateTargetIsChanged(void)
{
	TargetIsLost();
...
StringANSI StreamingScalableDeltaAction::GetTemplateArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI StreamingScalableDeltaAction::GetVariableArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
bool StreamingScalableDeltaAction::GetBooleanKeyArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
void StreamingScalableDeltaAction::operator () (void)
{
	if(IsValid()) 
	{ 
		if(arg2.Get()->GetValue())
		{
			...
			{
				target.Get()->Connect(VectorLerp::STREAMING_VECTOR_DELTA_MESSAGE, arg3.Get(), Caller<>(arg3.Get(), &ScalableObject::DisplaceScale));
			}
			else
			{
				target.Get()->Disconnect(VectorLerp::STREAMING_VECTOR_DELTA_MESSAGE, arg3.Get());
		...
		else
		{
			if(arg1.Get()->GetValue())
			{
				target.Get()->Connect(VectorLerp::STREAMING_VECTOR_DELTA_MESSAGE, arg3.Get(), Caller<>(arg3.Get(), &ScalableObject::SetScale));
			}
			else
			{
				target.Get()->Disconnect(VectorLerp::STREAMING_VECTOR_DELTA_MESSAGE, arg3.Get());
...
void StreamingScalableDeltaAction::ObjectIsDestroyed(AbstractObject* _object)
{
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::ObjectIsCreated));
	valid = false;
}
...
void StreamingScalableDeltaAction::TargetIsRenamed(AbstractObject::NameInfo* _info)
{
	TargetIsLost();
}
...
void StreamingScalableDeltaAction::Arg1IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg1IsLost();
}
...
void StreamingScalableDeltaAction::Arg2IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg2IsLost();
}


void StreamingScalableDeltaAction::Arg3IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg3IsLost();
}
...
void StreamingScalableDeltaAction::ObjectIsCreated(AbstractObject* _object)
{
	if(target.IsEmpty())
	{
		if(state[TEMPLATE][TARGET])
		{
			...
			{ 
				if(templateTarget.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateTarget.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::TargetIsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG1])
		{
			if(_object->IsClassPropertyExist(Variable<bool>::BOOLEAN_VARIABLE_CLASS))
			{
				if(templateArg1.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg1.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::Arg1IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG2])
		{
			if(_object->IsClassPropertyExist(Variable<bool>::BOOLEAN_VARIABLE_CLASS))
			{
				if(templateArg2.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg2.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::Arg2IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG3])
		{
			if(_object->IsClassPropertyExist(ScalableObject::SCALABLE_OBJECT_CLASS))
			{
				if(templateArg3.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg3.GetResult() == _object->GetName())
				{
					...
					if(arg3.Attach(dynamic_cast<ScalableObject*>(_object)))
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &StreamingScalableDeltaAction::Arg3IsRenamed));
						UpdateValid();
					}
					return;
				}
...
bool StreamingScalableDeltaAction::SaveToFile(StringANSI _path)			
{
	if(_path.empty())
	{
...
bool StreamingScalableDeltaAction::SaveToFile(File& _file)
{
...
AbstractAction* StreamingScalableDeltaAction::_LoadFromFile(File& _file)
{
	StreamingScalableDeltaAction* action = new StreamingScalableDeltaAction(VectorLerp::STREAMING_SCALABLE_DELTA_MESSAGE);
	StringANSI name;
	int32 length;
	_file.Read(length);
