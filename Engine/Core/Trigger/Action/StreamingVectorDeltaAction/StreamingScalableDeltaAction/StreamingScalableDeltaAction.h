#ifndef STREAMINGSCALABLEDELTAACTION_H
#define STREAMINGSCALABLEDELTAACTION_H
...
class StreamingScalableDeltaAction: public AbstractAction
{
    ...
    private: MagicPointer<ScalableObject> arg3;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<VectorLerp> target;
	private: StreamingScalableDeltaAction(void);
	private: StreamingScalableDeltaAction(int32 _type);
	public: virtual ~StreamingScalableDeltaAction(void);
