#ifndef STREAMINGCOLORABLEDELTAACTION_H
#define STREAMINGCOLORABLEDELTAACTION_H
...
class StreamingColorableDeltaAction: public AbstractAction
{
    ...
    private: MagicPointer<ColorableObject> arg3;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<VectorLerp> target;
	private: StreamingColorableDeltaAction(void);
	private: StreamingColorableDeltaAction(int32 _type);
	public: virtual ~StreamingColorableDeltaAction(void);
