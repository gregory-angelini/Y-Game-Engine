#ifndef STREAMINGVECTORDELTAACTION_H
#define STREAMINGVECTORDELTAACTION_H
...
class StreamingVectorDeltaAction: public AbstractAction
{
    ...
    private: MagicPointer<Variable<Vector3>> arg3;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<VectorLerp> target;
	private: StreamingVectorDeltaAction(void);
	private: StreamingVectorDeltaAction(int32 _type);
	public: virtual ~StreamingVectorDeltaAction(void);
