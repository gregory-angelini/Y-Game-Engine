#include "StreamingTranslatableDeltaAction.h"
#include <Engine/Core/AssetLibrary/AssetLibrary.h>
#include <Engine/Core/Trigger/Trigger.h>


StreamingTranslatableDeltaAction::StreamingTranslatableDeltaAction(void)
{}
 

StreamingTranslatableDeltaAction::StreamingTranslatableDeltaAction(int32 _type): AbstractAction(_type)
{}
...
void StreamingTranslatableDeltaAction::UpdateValid(void)
{
	valid = false; 
...
void StreamingTranslatableDeltaAction::SetVariableArg(int32 _index, StringANSI _name)
{
	switch(_index)
	{
		case ARG1:
			...
			if(arg1.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::Arg1IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg2.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::Arg2IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg3.IsEmpty())
			{
				if(object)
				{
					...
					{  
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::Arg3IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(target.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(VectorLerp::VECTOR_LERP_CLASS)) 
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::TargetIsRenamed));
							UpdateValid();
						}
						return;
					}
...
void StreamingTranslatableDeltaAction::SetTemplateArg(int32 _index, StringANSI _expr)
{
	switch(_index)
	{
		case ARG1:
		{
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::TemplateArg1IsCompleted));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::Arg1IsLost));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::TemplateArg1IsChanged));
		...
		case ARG2:
		{
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::TemplateArg2IsCompleted));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::Arg2IsLost));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::TemplateArg2IsChanged));
		...
		case ARG3:
		{
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::TemplateArg3IsCompleted));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::Arg3IsLost));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::TemplateArg3IsChanged));
		...
		case TARGET:
		{
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::TemplateTargetIsCompleted));
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::TargetIsLost));
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::TemplateTargetIsChanged));
...
void StreamingTranslatableDeltaAction::SetBooleanKeyArg(int32 _index, bool _value)
{
	switch(_index)
	{
		case ARG1:
...
void StreamingTranslatableDeltaAction::TemplateArg1IsCompleted(void)
{
...
void StreamingTranslatableDeltaAction::TemplateArg2IsCompleted(void)
{
...
void StreamingTranslatableDeltaAction::TemplateArg3IsCompleted(void)
{
...
void StreamingTranslatableDeltaAction::Arg1IsLost(void)
{
	if(arg1.IsNotEmpty())
	{ 
	...
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::ObjectIsCreated));
	valid = false;
}



void StreamingTranslatableDeltaAction::Arg2IsLost(void)
{
	if(arg2.IsNotEmpty())
	{ 
...
void StreamingTranslatableDeltaAction::Arg3IsLost(void)
{
	if(arg3.IsNotEmpty())
	{ 
...
void StreamingTranslatableDeltaAction::TemplateArg1IsChanged(void)
{
	Arg1IsLost();
...
void StreamingTranslatableDeltaAction::TemplateArg2IsChanged(void)
{
	Arg2IsLost();
...
void StreamingTranslatableDeltaAction::TemplateArg3IsChanged(void)
{
	Arg3IsLost();
...
void StreamingTranslatableDeltaAction::TemplateTargetIsCompleted(void)
{
...
void StreamingTranslatableDeltaAction::TargetIsLost(void)
{
	if(target.IsNotEmpty())
	{
		if(arg3.IsNotEmpty())
...
void StreamingTranslatableDeltaAction::TemplateTargetIsChanged(void)
{
	TargetIsLost();
...
StringANSI StreamingTranslatableDeltaAction::GetTemplateArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI StreamingTranslatableDeltaAction::GetVariableArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
bool StreamingTranslatableDeltaAction::GetBooleanKeyArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
void StreamingTranslatableDeltaAction::operator () (void)
{
	if(IsValid()) 
	{ 
		if(arg2.Get()->GetValue())
		{
			...
			{
				target.Get()->Connect(VectorLerp::STREAMING_VECTOR_DELTA_MESSAGE, arg3.Get(), Caller<>(arg3.Get(), &TranslatableObject::DisplacePosition));
			}
			else
			{
				target.Get()->Disconnect(VectorLerp::STREAMING_VECTOR_DELTA_MESSAGE, arg3.Get());
		...
		else
		{
			if(arg1.Get()->GetValue())
			{
				target.Get()->Connect(VectorLerp::STREAMING_VECTOR_DELTA_MESSAGE, arg3.Get(), Caller<>(arg3.Get(), &TranslatableObject::SetPosition));
			}
			else
			{
				target.Get()->Disconnect(VectorLerp::STREAMING_VECTOR_DELTA_MESSAGE, arg3.Get());
...
void StreamingTranslatableDeltaAction::ObjectIsDestroyed(AbstractObject* _object)
{
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::ObjectIsCreated));
	valid = false;
}
...
void StreamingTranslatableDeltaAction::TargetIsRenamed(AbstractObject::NameInfo* _info)
{
	TargetIsLost();
}
...
void StreamingTranslatableDeltaAction::Arg1IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg1IsLost();
}
...
void StreamingTranslatableDeltaAction::Arg2IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg2IsLost();
}


void StreamingTranslatableDeltaAction::Arg3IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg3IsLost();
}
...
void StreamingTranslatableDeltaAction::ObjectIsCreated(AbstractObject* _object)
{
	if(target.IsEmpty())
	{
		if(state[TEMPLATE][TARGET])
		{
			...
			{ 
				if(templateTarget.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateTarget.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::TargetIsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG1])
		{
			if(_object->IsClassPropertyExist(Variable<bool>::BOOLEAN_VARIABLE_CLASS))
			{
				if(templateArg1.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg1.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::Arg1IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG2])
		{
			if(_object->IsClassPropertyExist(Variable<bool>::BOOLEAN_VARIABLE_CLASS))
			{
				if(templateArg2.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg2.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::Arg2IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG3])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg3.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg3.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &StreamingTranslatableDeltaAction::Arg3IsRenamed));
						UpdateValid();
					}
					return;
				}
...
bool StreamingTranslatableDeltaAction::SaveToFile(StringANSI _path)			
{
	if(_path.empty())
	{
...
bool StreamingTranslatableDeltaAction::SaveToFile(File& _file)
{
...
AbstractAction* StreamingTranslatableDeltaAction::_LoadFromFile(File& _file)
{
	StreamingTranslatableDeltaAction* action = new StreamingTranslatableDeltaAction(VectorLerp::STREAMING_TRANSLATABLE_DELTA_MESSAGE);
	StringANSI name;
	int32 length;
	_file.Read(length);
