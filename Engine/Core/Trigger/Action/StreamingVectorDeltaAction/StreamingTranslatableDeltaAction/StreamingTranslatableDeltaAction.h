#ifndef STREAMINGTRANSLATABLEDELTAACTION_H
#define STREAMINGTRANSLATABLEDELTAACTION_H
...
class StreamingTranslatableDeltaAction: public AbstractAction
{
	...
	private: StreamingTranslatableDeltaAction(void);
	private: StreamingTranslatableDeltaAction(int32 _type);
	public: virtual ~StreamingTranslatableDeltaAction(void);
