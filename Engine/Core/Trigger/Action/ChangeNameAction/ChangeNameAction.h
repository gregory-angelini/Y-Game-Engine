#ifndef CHANGENAMEACTION_H
#define CHANGENAMEACTION_H
...
class ChangeNameAction: public AbstractAction
{
	...
	private: ChangeNameAction(void);
	private: ChangeNameAction(int32 _type);
	public: virtual ~ChangeNameAction(void);
