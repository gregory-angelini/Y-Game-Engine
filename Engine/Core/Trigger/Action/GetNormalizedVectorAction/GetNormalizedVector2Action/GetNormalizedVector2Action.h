#ifndef GETNORMALIZEDVECTOR2ACTION_H
#define GETNORMALIZEDVECTOR2ACTION_H
...
class GetNormalizedVector2Action: public AbstractAction
{
	...
	private: GetNormalizedVector2Action(void);
	private: GetNormalizedVector2Action(int32 _type);
	public: virtual ~GetNormalizedVector2Action(void);
