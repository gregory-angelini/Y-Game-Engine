#ifndef CHANGECOLORHSLACTION_H
#define CHANGECOLORHSLACTION_H
...
class ChangeColorHSLAction: public AbstractAction
{
	...
	private: ChangeColorHSLAction(void);
	private: ChangeColorHSLAction(int32 _type);
	public: virtual ~ChangeColorHSLAction(void);
