#ifndef CHANGECOLORRGBACTION_H
#define CHANGECOLORRGBACTION_H
...
class ChangeColorRGBAction: public AbstractAction
{
	...
	private: ChangeColorRGBAction(void);
	private: ChangeColorRGBAction(int32 _type);
	public: virtual ~ChangeColorRGBAction(void);
