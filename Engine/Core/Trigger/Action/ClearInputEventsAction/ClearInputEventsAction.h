#ifndef CLEARINPUTEVENTSACTION_H
#define CLEARINPUTEVENTSACTION_H
...
class ClearInputEventsAction: public AbstractAction
{
	...
	private: ClearInputEventsAction(void);
	private: ClearInputEventsAction(int32 _type);
	public: virtual ~ClearInputEventsAction(void);
