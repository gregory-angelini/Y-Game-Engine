#ifndef ENABLEZOOMACTION_H
#define ENABLEZOOMACTION_H
...
class EnableZoomAction: public AbstractAction
{
	...
	private: EnableZoomAction(void);
	private: EnableZoomAction(int32 _type);
	public: virtual ~EnableZoomAction(void);
