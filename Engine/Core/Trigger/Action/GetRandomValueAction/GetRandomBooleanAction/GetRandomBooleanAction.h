#ifndef GETRANDOMBOOLEANACTION_H
#define GETRANDOMBOOLEANACTION_H
...
class GetRandomBooleanAction: public AbstractAction
{
	...
	private: GetRandomBooleanAction(void);
	private: GetRandomBooleanAction(int32 _type);
	public: virtual ~GetRandomBooleanAction(void);
