#ifndef GETRANDOMFLOATACTION_H
#define GETRANDOMFLOATACTION_H
...
class GetRandomFloatAction: public AbstractAction
{
	...
	private: GetRandomFloatAction(void);
	private: GetRandomFloatAction(int32 _type);
	public: virtual ~GetRandomFloatAction(void);
