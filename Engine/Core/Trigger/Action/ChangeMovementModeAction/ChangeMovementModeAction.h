#ifndef CHANGEMOVEMENTMODEACTION_H
#define CHANGEMOVEMENTMODEACTION_H
...
class ChangeMovementModeAction: public AbstractAction
{
	...
	private: ChangeMovementModeAction(void);
	private: ChangeMovementModeAction(int32 _type);
	public: virtual ~ChangeMovementModeAction(void);
