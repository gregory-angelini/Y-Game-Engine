#ifndef CHANGEFLOATLERPFLOATTARGETACTION_H
#define CHANGEFLOATLERPFLOATTARGETACTION_H
...
class ChangeFloatLerpFloatTargetAction: public AbstractAction
{
	...
	private: ChangeFloatLerpFloatTargetAction(void);
	private: ChangeFloatLerpFloatTargetAction(int32 _type);
	public: virtual ~ChangeFloatLerpFloatTargetAction(void);
