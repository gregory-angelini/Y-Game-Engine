#ifndef CHANGEFLOATLERPINTEGERTARGETACTION_H
#define CHANGEFLOATLERPINTEGERTARGETACTION_H
...
class ChangeFloatLerpIntegerTargetAction: public AbstractAction
{
	...
	private: ChangeFloatLerpIntegerTargetAction(void);
	private: ChangeFloatLerpIntegerTargetAction(int32 _type);
	public: virtual ~ChangeFloatLerpIntegerTargetAction(void);
