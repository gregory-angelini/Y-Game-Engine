#ifndef CHECKTILESOLIDACTION_H
#define CHECKTILESOLIDACTION_H
...
class CheckTileSolidAction: public AbstractAction
{
	...
	private: CheckTileSolidAction(void);
	private: CheckTileSolidAction(int32 _type);
	public: virtual ~CheckTileSolidAction(void);
