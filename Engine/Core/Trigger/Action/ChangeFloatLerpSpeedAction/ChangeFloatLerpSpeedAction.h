#ifndef CHANGEFLOATLERPSPEEDACTION_H
#define CHANGEFLOATLERPSPEEDACTION_H
...
class ChangeFloatLerpSpeedAction: public AbstractAction
{
	...
	private: ChangeFloatLerpSpeedAction(void);
	private: ChangeFloatLerpSpeedAction(int32 _type);
	public: virtual ~ChangeFloatLerpSpeedAction(void);
