#ifndef CHANGEVIEWINGPOINTACTION_H
#define CHANGEVIEWINGPOINTACTION_H
...
class ChangeViewingPointAction: public AbstractAction
{
	...
	private: ChangeViewingPointAction(void);
	private: ChangeViewingPointAction(int32 _type);
	public: virtual ~ChangeViewingPointAction(void);
