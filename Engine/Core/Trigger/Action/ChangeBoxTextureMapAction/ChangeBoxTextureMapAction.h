#ifndef CHANGEBOXTEXTUREMAPACTION_H
#define CHANGEBOXTEXTUREMAPACTION_H
...
class ChangeBoxTextureMapAction: public AbstractAction
{
    ...
    private: MagicPointer<Texture2D> arg2;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<Texture2D> target;
	private: ChangeBoxTextureMapAction(void);
	private: ChangeBoxTextureMapAction(int32 _type);
	public: virtual ~ChangeBoxTextureMapAction(void);
