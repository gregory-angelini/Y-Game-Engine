#ifndef GETLINEANGLEZACTION_H
#define GETLINEANGLEZACTION_H
...
class GetLineAngleZAction: public AbstractAction
{
	...
	private: GetLineAngleZAction(void);
	private: GetLineAngleZAction(int32 _type);
	public: virtual ~GetLineAngleZAction(void);
