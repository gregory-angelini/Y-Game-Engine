...
GetLineAngleZAction::GetLineAngleZAction(void)
{}


GetLineAngleZAction::GetLineAngleZAction(int32 _type): AbstractAction(_type)
{}
...
void GetLineAngleZAction::UpdateValid(void)
{
	valid = false; 
...
void GetLineAngleZAction::SetVariableArg(int32 _index, StringANSI _name)
{
	switch(_index)
	{
		case ARG1:
			...
			if(arg1.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::Arg1IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg2.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::Arg2IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg3.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(Variable<float>::FLOAT_VARIABLE_CLASS)) 
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::Arg3IsRenamed));
							UpdateValid();
						}
						return;
					}
...
void GetLineAngleZAction::SetTemplateArg(int32 _index, StringANSI _expr)
{
	switch(_index)
	{
		case ARG1:
		{
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::TemplateArg1IsCompleted));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::Arg1IsLost));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::TemplateArg1IsChanged));
		...
		case ARG2:
		{
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::TemplateArg2IsCompleted));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::Arg2IsLost));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::TemplateArg2IsChanged));
		...
		case ARG3:
		{ 
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::TemplateArg3IsCompleted));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::Arg3IsLost));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::TemplateArg3IsChanged));
...
void GetLineAngleZAction::SetVector3KeyArg(int32 _index, Vector3 _value)
{
	switch(_index)
	{
		case ARG1:
...
void GetLineAngleZAction::TemplateArg1IsCompleted(void)
{
...
void GetLineAngleZAction::Arg1IsLost(void)
{
	if(arg1.IsNotEmpty())
	{ 
	...
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::ObjectIsCreated));
	valid = false;
}



void GetLineAngleZAction::TemplateArg1IsChanged(void)
{
	Arg1IsLost();
...
void GetLineAngleZAction::TemplateArg2IsCompleted(void)
{
...
void GetLineAngleZAction::Arg2IsLost(void)
{
	if(arg2.IsNotEmpty())
	{ 
...
void GetLineAngleZAction::TemplateArg2IsChanged(void)
{
	Arg2IsLost();
...
void GetLineAngleZAction::TemplateArg3IsCompleted(void)
{
...
void GetLineAngleZAction::Arg3IsLost(void)
{
	if(arg3.IsNotEmpty())
	{ 
...
void GetLineAngleZAction::TemplateArg3IsChanged(void)
{
	Arg3IsLost();
...
StringANSI GetLineAngleZAction::GetTemplateArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
Vector3 GetLineAngleZAction::GetVector3KeyArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI GetLineAngleZAction::GetVariableArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
void GetLineAngleZAction::operator () (void)
{
	if(IsValid())
	{
		Vector3 origin = arg1.Get()->GetPosition();
		Vector3 end = arg2.Get()->GetPosition();
		
		if((origin.x - end.x) != 0.0f || (origin.y - end.y) != 0.0f)
		{
			arg3.Get()->SetValue(Angle::_ClampRadians(Line::_GetAngleZ(origin, end)));
		}
	}
}
...
void GetLineAngleZAction::ObjectIsDestroyed(AbstractObject* _object)
{
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::ObjectIsCreated));
	valid = false;
}
...
void GetLineAngleZAction::Arg1IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg1IsLost();
}
...
void GetLineAngleZAction::Arg2IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg2IsLost();
}
...
void GetLineAngleZAction::Arg3IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg3IsLost();
}


void GetLineAngleZAction::ObjectIsCreated(AbstractObject* _object)
{
	if(arg1.IsEmpty())
	{ 
		if(state[TEMPLATE][ARG1])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg1.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg1.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::Arg1IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG2])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg2.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg2.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::Arg2IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG3])
		{
			if(_object->IsClassPropertyExist(Variable<float>::FLOAT_VARIABLE_CLASS))
			{
				if(templateArg3.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg3.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetLineAngleZAction::Arg3IsRenamed));
						UpdateValid();
					}
					return;
				}
...
bool GetLineAngleZAction::SaveToFile(StringANSI _path)			
{
	if(_path.empty())
	{
...
bool GetLineAngleZAction::SaveToFile(File& _file)
{
...
AbstractAction* GetLineAngleZAction::_LoadFromFile(File& _file)
{
	GetLineAngleZAction* action = new GetLineAngleZAction(Line::GET_LINE_ANGLE_Z_MESSAGE);
	StringANSI name;
	int32 length;
	_file.Read(length);
