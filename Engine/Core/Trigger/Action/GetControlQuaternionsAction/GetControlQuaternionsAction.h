#ifndef GETCONTROLQUATERNIONSACTION_H
#define GETCONTROLQUATERNIONSACTION_H
...
class GetControlQuaternionsAction: public AbstractAction
{
    ...
    private: MagicPointer<List<Quaternion>> arg2;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<QuaternionLerp> target;
	private: GetControlQuaternionsAction(void);
	private: GetControlQuaternionsAction(int32 _type);
	public: virtual ~GetControlQuaternionsAction(void);
