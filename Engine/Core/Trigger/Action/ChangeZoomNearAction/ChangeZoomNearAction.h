#ifndef CHANGEZOOMNEARACTION_H
#define CHANGEZOOMNEARACTION_H
...
class ChangeZoomNearAction: public AbstractAction
{
	...
	private: ChangeZoomNearAction(void);
	private: ChangeZoomNearAction(int32 _type);
	public: virtual ~ChangeZoomNearAction(void);
