#ifndef ENABLETEXTUREFLIPACTION_H
#define ENABLETEXTUREFLIPACTION_H
...
class EnableTextureFlipAction: public AbstractAction
{
	...
	private: EnableTextureFlipAction(void);
	private: EnableTextureFlipAction(int32 _type);
	public: virtual ~EnableTextureFlipAction(void);
