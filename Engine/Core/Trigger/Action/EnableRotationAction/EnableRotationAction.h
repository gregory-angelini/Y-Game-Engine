#ifndef ENABLEROTATIONACTION_H
#define ENABLEROTATIONACTION_H
...
class EnableRotationAction: public AbstractAction
{
	...
	private: EnableRotationAction(void);
	private: EnableRotationAction(int32 _type);
	public: virtual ~EnableRotationAction(void);
