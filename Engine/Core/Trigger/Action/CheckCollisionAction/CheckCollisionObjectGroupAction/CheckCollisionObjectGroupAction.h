#ifndef CHECKCOLLISIONOBJECTGROUPACTION_H
#define CHECKCOLLISIONOBJECTGROUPACTION_H
...
class CheckCollisionObjectGroupAction: public AbstractAction
{
	...
	private: CheckCollisionObjectGroupAction(void);
	private: CheckCollisionObjectGroupAction(int32 _type);
	public: virtual ~CheckCollisionObjectGroupAction(void);
