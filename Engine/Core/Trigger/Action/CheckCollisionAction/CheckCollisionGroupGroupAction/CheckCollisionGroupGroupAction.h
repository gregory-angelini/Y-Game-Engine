#ifndef CHECKCOLLISIONGROUPGROUPACTION_H
#define CHECKCOLLISIONGROUPGROUPACTION_H
...
class CheckCollisionGroupGroupAction: public AbstractAction
{
	...
	private: CheckCollisionGroupGroupAction(void);
	private: CheckCollisionGroupGroupAction(int32 _type);
	public: virtual ~CheckCollisionGroupGroupAction(void);
