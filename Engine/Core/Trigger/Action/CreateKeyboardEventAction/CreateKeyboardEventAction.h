#ifndef CREATEKEYBOARDEVENTACTION_H
#define CREATEKEYBOARDEVENTACTION_H
...
class CreateKeyboardEventAction: public AbstractAction
{
	...
	private: CreateKeyboardEventAction(void);
	private: CreateKeyboardEventAction(int32 _type);
	public: virtual ~CreateKeyboardEventAction(void);
