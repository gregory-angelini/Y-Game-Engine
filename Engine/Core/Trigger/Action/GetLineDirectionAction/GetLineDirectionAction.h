#ifndef GETLINEDIRECTIONACTION_H
#define GETLINEDIRECTIONACTION_H
...
class GetLineDirectionAction: public AbstractAction
{
	...
	private: GetLineDirectionAction(void);
	private: GetLineDirectionAction(int32 _type);
	public: virtual ~GetLineDirectionAction(void);
