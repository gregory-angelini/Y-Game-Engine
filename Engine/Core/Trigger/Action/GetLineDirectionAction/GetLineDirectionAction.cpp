#include "GetLineDirectionAction.h"
...
GetLineDirectionAction::GetLineDirectionAction(void)
{}


GetLineDirectionAction::GetLineDirectionAction(int32 _type): AbstractAction(_type)
{}
...
void GetLineDirectionAction::UpdateValid(void)
{
	valid = false; 
...
void GetLineDirectionAction::SetVariableArg(int32 _index, StringANSI _name)
{
	switch(_index)
	{
		case ARG1:
			...
			if(arg1.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::Arg1IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg2.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::Arg2IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg3.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(Variable<Vector3>::VECTOR_3_VARIABLE_CLASS)) 
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::Arg3IsRenamed));
							UpdateValid();
						}
						return;
					}
...
void GetLineDirectionAction::SetTemplateArg(int32 _index, StringANSI _expr)
{
	switch(_index)
	{
		case ARG1:
		{
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::TemplateArg1IsCompleted));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::Arg1IsLost));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::TemplateArg1IsChanged));
		...
		case ARG2:
		{
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::TemplateArg2IsCompleted));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::Arg2IsLost));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::TemplateArg2IsChanged));
		...
		case ARG3:
		{ 
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::TemplateArg3IsCompleted));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::Arg3IsLost));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::TemplateArg3IsChanged));
...
void GetLineDirectionAction::SetVector3KeyArg(int32 _index, Vector3 _value)
{
	switch(_index)
	{
		case ARG1:
...
void GetLineDirectionAction::TemplateArg1IsCompleted(void)
{
...
void GetLineDirectionAction::Arg1IsLost(void)
{
	if(arg1.IsNotEmpty())
	{ 
	...
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::ObjectIsCreated));
	valid = false;
}



void GetLineDirectionAction::TemplateArg1IsChanged(void)
{
	Arg1IsLost();
...
void GetLineDirectionAction::TemplateArg2IsCompleted(void)
{
...
void GetLineDirectionAction::Arg2IsLost(void)
{
	if(arg2.IsNotEmpty())
	{ 
...
void GetLineDirectionAction::TemplateArg2IsChanged(void)
{
	Arg2IsLost();
...
void GetLineDirectionAction::TemplateArg3IsCompleted(void)
{
...
void GetLineDirectionAction::Arg3IsLost(void)
{
	if(arg3.IsNotEmpty())
	{ 
...
void GetLineDirectionAction::TemplateArg3IsChanged(void)
{
	Arg3IsLost();
...
StringANSI GetLineDirectionAction::GetTemplateArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
Vector3 GetLineDirectionAction::GetVector3KeyArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI GetLineDirectionAction::GetVariableArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
void GetLineDirectionAction::operator () (void)
{
	if(IsValid())
	{
		arg3.Get()->SetValue(Line::_GetDirection(arg1.Get()->GetPosition(), arg2.Get()->GetPosition()));
	}
}



void GetLineDirectionAction::ObjectIsDestroyed(AbstractObject* _object)
{
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::ObjectIsCreated));
	valid = false;
}
...
void GetLineDirectionAction::Arg1IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg1IsLost();
}
...
void GetLineDirectionAction::Arg2IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg2IsLost();
}
...
void GetLineDirectionAction::Arg3IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg3IsLost();
}


void GetLineDirectionAction::ObjectIsCreated(AbstractObject* _object)
{
	if(arg1.IsEmpty())
	{ 
		if(state[TEMPLATE][ARG1])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg1.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg1.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::Arg1IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG2])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg2.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg2.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::Arg2IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG3])
		{
			if(_object->IsClassPropertyExist(Variable<Vector3>::VECTOR_3_VARIABLE_CLASS))
			{
				if(templateArg3.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg3.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &GetLineDirectionAction::Arg3IsRenamed));
						UpdateValid();
					}
					return;
				}
...
bool GetLineDirectionAction::SaveToFile(StringANSI _path)			
{
	if(_path.empty())
	{
...
bool GetLineDirectionAction::SaveToFile(File& _file)
{
...
AbstractAction* GetLineDirectionAction::_LoadFromFile(File& _file)
{
	GetLineDirectionAction* action = new GetLineDirectionAction(Line::GET_LINE_DIRECTION_MESSAGE);
	StringANSI name;
	int32 length;
	_file.Read(length);
