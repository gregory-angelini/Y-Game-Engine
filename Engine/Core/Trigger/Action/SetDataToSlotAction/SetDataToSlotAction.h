#ifndef SETDATATOSLOTACTION_H
#define SETDATATOSLOTACTION_H
...
class SetDataToSlotAction: public AbstractAction
{
	...
	private: SetDataToSlotAction(void);
	private: SetDataToSlotAction(int32 _type);
	public: virtual ~SetDataToSlotAction(void);
