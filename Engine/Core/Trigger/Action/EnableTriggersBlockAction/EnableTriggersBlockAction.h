#ifndef ENABLETRIGGERSBLOCKACTION_H
#define ENABLETRIGGERSBLOCKACTION_H
...
class EnableTriggersBlockAction: public AbstractAction
{
	...
	private: EnableTriggersBlockAction(void);
	private: EnableTriggersBlockAction(int32 _type);
	public: virtual ~EnableTriggersBlockAction(void);
