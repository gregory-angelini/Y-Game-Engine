#ifndef CREATETEXTUREACTION_H
#define CREATETEXTUREACTION_H
...
class CreateTextureAction: public AbstractAction
{
	...
	private: CreateTextureAction(void);
	private: CreateTextureAction(int32 _type);
	public: virtual ~CreateTextureAction(void);
