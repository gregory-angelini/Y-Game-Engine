#ifndef ENABLESHOWCURSORACTION_H
#define ENABLESHOWCURSORACTION_H
...
class EnableShowCursorAction: public AbstractAction
{
	...
	private: EnableShowCursorAction(void);
	private: EnableShowCursorAction(int32 _type);
	public: virtual ~EnableShowCursorAction(void);
