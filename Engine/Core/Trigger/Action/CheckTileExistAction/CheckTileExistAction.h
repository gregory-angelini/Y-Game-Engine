#ifndef CHECKTILEEXISTACTION_H
#define CHECKTILEEXISTACTION_H
...
class CheckTileExistAction: public AbstractAction
{
	...
	private: CheckTileExistAction(void);
	private: CheckTileExistAction(int32 _type);
	public: virtual ~CheckTileExistAction(void);
