#ifndef CHANGEZOOMSPEEDACTION_H
#define CHANGEZOOMSPEEDACTION_H
...
class ChangeZoomSpeedAction: public AbstractAction
{
	...
	private: ChangeZoomSpeedAction(void);
	private: ChangeZoomSpeedAction(int32 _type);
	public: virtual ~ChangeZoomSpeedAction(void);
