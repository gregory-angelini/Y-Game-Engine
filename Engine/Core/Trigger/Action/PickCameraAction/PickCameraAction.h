#ifndef PICKCAMERAACTION_H
#define PICKCAMERAACTION_H
...
class PickCameraAction: public AbstractAction
{
	...
	private: PickCameraAction(void);
	private: PickCameraAction(int32 _type);
	public: virtual ~PickCameraAction(void);
