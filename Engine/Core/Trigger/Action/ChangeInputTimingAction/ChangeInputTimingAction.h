#ifndef CHANGEINPUTTIMINGACTION_H
#define CHANGEINPUTTIMINGACTION_H
...
class ChangeInputTimingAction: public AbstractAction
{
	...
	private: ChangeInputTimingAction(void);
	private: ChangeInputTimingAction(int32 _type);
	public: virtual ~ChangeInputTimingAction(void);
