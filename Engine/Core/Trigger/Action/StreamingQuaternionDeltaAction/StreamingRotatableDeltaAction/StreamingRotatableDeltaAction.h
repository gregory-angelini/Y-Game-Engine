#ifndef STREAMINGROTATABLEDELTAACTION_H
#define STREAMINGROTATABLEDELTAACTION_H
...
class StreamingRotatableDeltaAction: public AbstractAction
{
	...
	private: StreamingRotatableDeltaAction(void);
	private: StreamingRotatableDeltaAction(int32 _type);
	public: virtual ~StreamingRotatableDeltaAction(void);
