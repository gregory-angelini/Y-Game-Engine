#ifndef GETPOSITIONACTION_H
#define GETPOSITIONACTION_H
...
class GetPositionAction: public AbstractAction
{
	...
	private: GetPositionAction(void);
	private: GetPositionAction(int32 _type);
	public: virtual ~GetPositionAction(void);
