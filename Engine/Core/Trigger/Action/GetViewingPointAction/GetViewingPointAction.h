#ifndef GETVIEWINGPOINTACTION_H
#define GETVIEWINGPOINTACTION_H
...
class GetViewingPointAction: public AbstractAction
{
	...
	private: GetViewingPointAction(void);
	private: GetViewingPointAction(int32 _type);
	public: virtual ~GetViewingPointAction(void);
