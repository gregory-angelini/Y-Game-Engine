#ifndef GETCOLORRGBACTION_H
#define GETCOLORRGBACTION_H
...
class GetColorRGBAction: public AbstractAction
{
	...
	private: GetColorRGBAction(void);
	private: GetColorRGBAction(int32 _type);
	public: virtual ~GetColorRGBAction(void);
