#ifndef GETCOLORHSLACTION_H
#define GETCOLORHSLACTION_H
...
class GetColorHSLAction: public AbstractAction
{
	...
	private: GetColorHSLAction(void);
	private: GetColorHSLAction(int32 _type);
	public: virtual ~GetColorHSLAction(void);
