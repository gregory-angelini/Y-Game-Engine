#ifndef SETTWOROTATABLESACTION_H
#define SETTWOROTATABLESACTION_H
...
class SetTwoRotatablesAction: public AbstractAction
{
	...
	private: SetTwoRotatablesAction(void);
	private: SetTwoRotatablesAction(int32 _type);
	public: virtual ~SetTwoRotatablesAction(void);
