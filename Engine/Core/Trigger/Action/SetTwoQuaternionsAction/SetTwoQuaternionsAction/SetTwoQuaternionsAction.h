#ifndef SETTWOQUATERNIONSACTION_H
#define SETTWOQUATERNIONSACTION_H
...
class SetTwoQuaternionsAction: public AbstractAction
{
	...
	private: SetTwoQuaternionsAction(void);
	private: SetTwoQuaternionsAction(int32 _type);
	public: virtual ~SetTwoQuaternionsAction(void);
