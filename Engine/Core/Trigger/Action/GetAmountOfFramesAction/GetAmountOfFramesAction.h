#ifndef GETAMOUNTOFFRAMESACTION_H
#define GETAMOUNTOFFRAMESACTION_H
...
class GetAmountOfFramesAction: public AbstractAction
{
	...
	private: GetAmountOfFramesAction(void);
	private: GetAmountOfFramesAction(int32 _type);
	public: virtual ~GetAmountOfFramesAction(void);
