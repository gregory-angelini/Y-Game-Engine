#ifndef CREATETILEDSPACEACTION_H
#define CREATETILEDSPACEACTION_H
...
class CreateTiledSpaceAction: public AbstractAction
{
	...
	private: CreateTiledSpaceAction(void);
	private: CreateTiledSpaceAction(int32 _type);
	public: virtual ~CreateTiledSpaceAction(void);
