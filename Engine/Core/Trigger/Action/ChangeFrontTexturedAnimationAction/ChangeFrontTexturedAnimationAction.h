#ifndef CHANGEFRONTTEXTUREDANIMATIONACTION_H
#define CHANGEFRONTTEXTUREDANIMATIONACTION_H
...
class ChangeFrontTexturedAnimationAction: public AbstractAction
{
	...
	private: ChangeFrontTexturedAnimationAction(void);
	private: ChangeFrontTexturedAnimationAction(int32 _type);
	public: virtual ~ChangeFrontTexturedAnimationAction(void);
