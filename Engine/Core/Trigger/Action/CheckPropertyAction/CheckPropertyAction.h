#ifndef CHECKPROPERTYACTION_H
#define CHECKPROPERTYACTION_H
...
class CheckPropertyAction: public AbstractAction
{
	...
	private: CheckPropertyAction(void);
	private: CheckPropertyAction(int32 _type);
	public: virtual ~CheckPropertyAction(void);
