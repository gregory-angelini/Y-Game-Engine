#ifndef GETAMOUNTOFITEMSACTION_H
#define GETAMOUNTOFITEMSACTION_H
...
class GetAmountOfItemsAction: public AbstractAction
{
	...
	private: GetAmountOfItemsAction(void);
	private: GetAmountOfItemsAction(int32 _type);
	public: virtual ~GetAmountOfItemsAction(void);
