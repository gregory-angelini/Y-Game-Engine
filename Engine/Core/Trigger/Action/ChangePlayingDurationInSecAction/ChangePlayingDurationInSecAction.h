#ifndef CHANGEPLAYINGDURATIONINSECACTION_H
#define CHANGEPLAYINGDURATIONINSECACTION_H
...
class ChangePlayingDurationInSecAction: public AbstractAction
{
	...
	private: MagicPointer<PlayingObject> target;
	private: ChangePlayingDurationInSecAction(void);
	private: ChangePlayingDurationInSecAction(int32 _type);
	public: virtual ~ChangePlayingDurationInSecAction(void);
