#ifndef GETSCALEACTION_H
#define GETSCALEACTION_H
...
class GetScaleAction: public AbstractAction
{
	...
	private: MagicPointer<ScalableObject> target;
	private: GetScaleAction(void);
	private: GetScaleAction(int32 _type);
	public: virtual ~GetScaleAction(void);
