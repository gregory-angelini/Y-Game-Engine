#ifndef CHANGEFLOATLERPACTION_H
#define CHANGEFLOATLERPACTION_H
...
class ChangeFloatLerpAction: public AbstractAction
{
	...
	private: MagicPointer<LerpingObject> target;
	private: ChangeFloatLerpAction(void);
	private: ChangeFloatLerpAction(int32 _type);
	public: virtual ~ChangeFloatLerpAction(void);
