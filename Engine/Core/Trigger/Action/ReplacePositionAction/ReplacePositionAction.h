#ifndef REPLACEPOSITIONACTION_H
#define REPLACEPOSITIONACTION_H
...
class ReplacePositionAction: public AbstractAction
{
	...
	private: ReplacePositionAction(void);
	private: ReplacePositionAction(int32 _type);
	public: virtual ~ReplacePositionAction(void);
