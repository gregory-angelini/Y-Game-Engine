#ifndef CREATESETACTION_H
#define CREATESETACTION_H
...
class CreateSetAction: public AbstractAction
{
	...
	private: CreateSetAction(void);
	private: CreateSetAction(int32 _type);
	public: virtual ~CreateSetAction(void);
