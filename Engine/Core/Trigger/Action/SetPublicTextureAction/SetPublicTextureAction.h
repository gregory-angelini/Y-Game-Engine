#ifndef SETPUBLICTEXTUREACTION_H
#define SETPUBLICTEXTUREACTION_H
...
class SetPublicTextureAction: public AbstractAction
{
	...
	private: SetPublicTextureAction(void);
	private: SetPublicTextureAction(int32 _type);
	public: virtual ~SetPublicTextureAction(void);
