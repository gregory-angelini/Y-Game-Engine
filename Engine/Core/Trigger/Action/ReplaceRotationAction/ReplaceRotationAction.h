#ifndef REPLACEROTATIONACTION_H
#define REPLACEROTATIONACTION_H
...
class ReplaceRotationAction: public AbstractAction
{
	...
	private: ReplaceRotationAction(void);
	private: ReplaceRotationAction(int32 _type);
	public: virtual ~ReplaceRotationAction(void);
