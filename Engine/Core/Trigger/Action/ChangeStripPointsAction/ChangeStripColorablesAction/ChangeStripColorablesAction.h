#ifndef CHANGESTRIPCOLORABLESACTION_H
#define CHANGESTRIPCOLORABLESACTION_H
...
class ChangeStripColorablesAction: public AbstractAction
{
    ...
    private: MagicPointer<List<ColorableObject>> arg2;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<GraphicsStrip> target;
	private: ChangeStripColorablesAction(void);
	private: ChangeStripColorablesAction(int32 _type);
	public: virtual ~ChangeStripColorablesAction(void);
