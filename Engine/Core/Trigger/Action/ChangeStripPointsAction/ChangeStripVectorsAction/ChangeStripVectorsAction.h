#ifndef CHANGESTRIPVECTORSACTION_H
#define CHANGESTRIPVECTORSACTION_H
...
class ChangeStripVectorsAction: public AbstractAction
{
    ...
    private: MagicPointer<List<Vector3>> arg2;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<GraphicsStrip> target;
	private: ChangeStripVectorsAction(void);
	private: ChangeStripVectorsAction(int32 _type);
	public: virtual ~ChangeStripVectorsAction(void);
