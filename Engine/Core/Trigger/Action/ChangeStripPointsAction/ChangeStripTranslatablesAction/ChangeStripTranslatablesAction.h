#ifndef CHANGESTRIPTRANSLATABLESACTION_H
#define CHANGESTRIPTRANSLATABLESACTION_H
...
class ChangeStripTranslatablesAction: public AbstractAction
{
    ...
    private: MagicPointer<List<TranslatableObject>> arg2;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<GraphicsStrip> target;
	private: ChangeStripTranslatablesAction(void);
	private: ChangeStripTranslatablesAction(int32 _type);
	public: virtual ~ChangeStripTranslatablesAction(void);
