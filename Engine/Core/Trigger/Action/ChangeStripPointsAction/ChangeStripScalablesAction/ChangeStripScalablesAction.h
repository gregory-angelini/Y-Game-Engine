#ifndef CHANGESTRIPSCALABLESACTION_H
#define CHANGESTRIPSCALABLESACTION_H
...
class ChangeStripScalablesAction: public AbstractAction
{
    ...
    private: MagicPointer<List<ScalableObject>> arg2;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<GraphicsStrip> target;
	private: ChangeStripScalablesAction(void);
	private: ChangeStripScalablesAction(int32 _type);
	public: virtual ~ChangeStripScalablesAction(void);
