#ifndef ENABLEPOSITIONOFFSETACTION_H
#define ENABLEPOSITIONOFFSETACTION_H
...
class EnablePositionOffsetAction: public AbstractAction
{
	...
	private: MagicPointer<TexturedAnimation> target;
	private: EnablePositionOffsetAction(void);
	private: EnablePositionOffsetAction(int32 _type);
	public: virtual ~EnablePositionOffsetAction(void);
