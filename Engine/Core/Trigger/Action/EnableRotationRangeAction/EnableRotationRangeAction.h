#ifndef ENABLEROTATIONRANGEACTION_H
#define ENABLEROTATIONRANGEACTION_H
...
class EnableRotationRangeAction: public AbstractAction
{
	...
	private: EnableRotationRangeAction(void);
	private: EnableRotationRangeAction(int32 _type);
	public: virtual ~EnableRotationRangeAction(void);
