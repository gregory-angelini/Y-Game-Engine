#ifndef CHANGETILEPASSACTION_H
#define CHANGETILEPASSACTION_H
...
class ChangeTilePassAction: public AbstractAction
{
	...
	private: ChangeTilePassAction(void);
	private: ChangeTilePassAction(int32 _type);
	public: virtual ~ChangeTilePassAction(void);
