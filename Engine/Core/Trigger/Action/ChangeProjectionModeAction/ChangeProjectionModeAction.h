#ifndef CHANGEPROJECTIONMODEACTION_H
#define CHANGEPROJECTIONMODEACTION_H
...
class ChangeProjectionModeAction: public AbstractAction
{
	...
	private: ChangeProjectionModeAction(void);
	private: ChangeProjectionModeAction(int32 _type);
	public: virtual ~ChangeProjectionModeAction(void);
