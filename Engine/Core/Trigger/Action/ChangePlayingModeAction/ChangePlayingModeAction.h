#ifndef CHANGEPLAYINGMODEACTION_H
#define CHANGEPLAYINGMODEACTION_H
...
class ChangePlayingModeAction: public AbstractAction
{
	...
	private: ChangePlayingModeAction(void);
	private: ChangePlayingModeAction(int32 _type);
	public: virtual ~ChangePlayingModeAction(void);
