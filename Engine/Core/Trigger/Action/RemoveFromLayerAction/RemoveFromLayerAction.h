#ifndef REMOVEFROMLAYERACTION_H
#define REMOVEFROMLAYERACTION_H
...
class RemoveFromLayerAction: public AbstractAction
{
	...
	private: MagicPointer<ObjectScene> target;
	private: RemoveFromLayerAction(void);
	private: RemoveFromLayerAction(int32 _type);
	public: virtual ~RemoveFromLayerAction(void);
