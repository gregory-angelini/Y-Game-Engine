#ifndef CHECKLINEINIMAGEACTION_H
#define CHECKLINEINIMAGEACTION_H
...
class CheckLineInImageAction: public AbstractAction
{
    ...
    private: MagicPointer<Variable<Vector2>> arg4;

	private: StringANSI arg5Name;
    private: StringExprParserEx templateArg5;
    private: MagicPointer<ColorableObject> arg5;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<TexturingSurface> target;
	
    private: Vector2 pixelPosition;
	private: RGBA pixelColor;
	private: CheckLineInImageAction(void);
	private: CheckLineInImageAction(int32 _type);
	public: virtual ~CheckLineInImageAction(void);
