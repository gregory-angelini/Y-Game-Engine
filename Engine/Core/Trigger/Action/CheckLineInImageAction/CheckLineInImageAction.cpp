#include "CheckLineInImageAction.h"
#include <Engine/Core/AssetLibrary/AssetLibrary.h>
#include <Engine/Core/Trigger/Trigger.h>


CheckLineInImageAction::CheckLineInImageAction(void)
{}


CheckLineInImageAction::CheckLineInImageAction(int32 _type): AbstractAction(_type)
{}
...
void CheckLineInImageAction::UpdateValid(void)
{
	valid = false; 
...
void CheckLineInImageAction::SetVariableArg(int32 _index, StringANSI _name)
{
	switch(_index)
	{
		case ARG1:
			...
			if(arg1.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::Arg1IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg2.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::Arg2IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg3.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::Arg3IsRenamed));
							UpdateValid();
						}
						return;
					}
		...
		case ARG4:
		{
			...
			if(arg4.IsEmpty())
			{
				if(object)
				{
					...
					{
						if(arg4.Attach(dynamic_cast<Variable<Vector2>*>(object)))
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::Arg4IsRenamed));
							UpdateValid();
						}
						return;
					}
		...
		case ARG5:
		{
			...
			if(arg5.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						if(loadArgsEnable) { state[ASSET_TYPE][_index] = AssetLibrary::_GetAssetType(object->GetClassProperties()); }
						if(arg5.Attach(dynamic_cast<ColorableObject*>(object)))
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::Arg5IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(target.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(TexturingSurface::TEXTURING_SURFACE_CLASS))
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::TargetIsRenamed));
							UpdateValid();
						}
						return;
					}
...
void CheckLineInImageAction::SetTemplateArg(int32 _index, StringANSI _expr)
{
	switch(_index)
	{
		case ARG1:
		{
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::TemplateArg1IsCompleted));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::Arg1IsLost));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::TemplateArg1IsChanged));
		...
		case ARG2:
		{
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::TemplateArg2IsCompleted));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::Arg2IsLost));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::TemplateArg2IsChanged));
		...
		case ARG3:
		{
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::TemplateArg3IsCompleted));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::Arg3IsLost));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::TemplateArg3IsChanged));
		...
		case ARG4: 
		{
			templateArg4.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::TemplateArg4IsCompleted));
			templateArg4.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::Arg4IsLost));
			templateArg4.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::TemplateArg4IsChanged));
		...
		case ARG5:
		{ 
			templateArg5.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::TemplateArg5IsCompleted));
			templateArg5.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::Arg5IsLost));
			templateArg5.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::TemplateArg5IsChanged));
		...
		case TARGET:
		{
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::TemplateTargetIsCompleted));
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::TargetIsLost));
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::TemplateTargetIsChanged));
...
void CheckLineInImageAction::SetVector3KeyArg(int32 _index, Vector3 _value)
{
	switch(_index)
	{
		case ARG1:
...
void CheckLineInImageAction::TemplateArg1IsCompleted(void)
{
...
void CheckLineInImageAction::TemplateArg2IsCompleted(void)
{
...
void CheckLineInImageAction::TemplateArg3IsCompleted(void)
{
...
void CheckLineInImageAction::TemplateArg4IsCompleted(void)
{
...
void CheckLineInImageAction::TemplateArg5IsCompleted(void)
{
...
void CheckLineInImageAction::Arg1IsLost(void)
{
	if(arg1.IsNotEmpty())
	{ 
	...
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::ObjectIsCreated));
	valid = false;
}


void CheckLineInImageAction::Arg2IsLost(void)
{
	if(arg2.IsNotEmpty())
	{ 
...
void CheckLineInImageAction::Arg3IsLost(void)
{
	if(arg3.IsNotEmpty())
	{ 
...
void CheckLineInImageAction::Arg4IsLost(void)
{
	if(arg4.IsNotEmpty())
	{ 
...
void CheckLineInImageAction::Arg5IsLost(void)
{
	if(arg5.IsNotEmpty())
	{ 
...
void CheckLineInImageAction::TemplateArg1IsChanged(void)
{
	Arg1IsLost();
...
void CheckLineInImageAction::TemplateArg2IsChanged(void)
{
	Arg2IsLost();
...
void CheckLineInImageAction::TemplateArg3IsChanged(void)
{
	Arg3IsLost();
...
void CheckLineInImageAction::TemplateArg4IsChanged(void)
{
	Arg4IsLost();
...
void CheckLineInImageAction::TemplateArg5IsChanged(void)
{
	Arg5IsLost();
...
void CheckLineInImageAction::TemplateTargetIsCompleted(void)
{
...
void CheckLineInImageAction::TargetIsLost(void)
{
...
void CheckLineInImageAction::TemplateTargetIsChanged(void)
{
	TargetIsLost();
...
StringANSI CheckLineInImageAction::GetTemplateArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI CheckLineInImageAction::GetVariableArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
Vector3 CheckLineInImageAction::GetVector3KeyArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
void CheckLineInImageAction::operator () (void)
{
	if(IsValid())
	{
		if(target.Get()->IsIntersected(Line(arg1.Get()->GetPosition(), arg2.Get()->GetPosition()), &pixelPosition, &pixelColor))
		{
			arg3.Get()->SetValue(true);
			arg4.Get()->SetValue(pixelPosition);
			arg5.Get()->SetColorRGBA(pixelColor.GetRGBAf());
		}
		else
		{
	...
	else if(target.IsNotEmpty() && arg1.IsNotEmpty() && arg2.IsNotEmpty())
	{
		if(arg3.IsNotEmpty() || arg4.IsNotEmpty() || arg5.IsNotEmpty())
		{
			if(target.Get()->IsIntersected(Line(arg1.Get()->GetPosition(), arg2.Get()->GetPosition()), &pixelPosition, &pixelColor))
			{
				...
				if(arg4.IsNotEmpty()) { arg4.Get()->SetValue(pixelPosition); }
				if(arg5.IsNotEmpty()) { arg5.Get()->SetColorRGBA(pixelColor.GetRGBAf()); }
			}
			else
			{
...
void CheckLineInImageAction::ObjectIsDestroyed(AbstractObject* _object)
{
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::ObjectIsCreated));
	valid = false;
}
...
void CheckLineInImageAction::TargetIsRenamed(AbstractObject::NameInfo* _info)
{
	TargetIsLost();
}
...
void CheckLineInImageAction::Arg1IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg1IsLost();
}


void CheckLineInImageAction::Arg2IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg2IsLost();
}


void CheckLineInImageAction::Arg3IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg3IsLost();
}


void CheckLineInImageAction::Arg4IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg4IsLost();
}

void CheckLineInImageAction::Arg5IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg5IsLost();
}
...
void CheckLineInImageAction::ObjectIsCreated(AbstractObject* _object)
{
	if(target.IsEmpty())
	{
		if(state[TEMPLATE][TARGET])
		{
			if(_object->IsClassPropertyExist(TexturingSurface::TEXTURING_SURFACE_CLASS))
			{
				if(templateTarget.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateTarget.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::TargetIsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG1])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg1.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg1.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::Arg1IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG2])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg2.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg2.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::Arg2IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG3])
		{
			if(_object->IsClassPropertyExist(Variable<bool>::BOOLEAN_VARIABLE_CLASS))
			{
				if(templateArg3.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg3.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::Arg3IsRenamed));
						UpdateValid();
					}
					return;
				}
	...
	{ 
		if(state[TEMPLATE][ARG4])
		{
			if(_object->IsClassPropertyExist(Variable<Vector2>::VECTOR_2_VARIABLE_CLASS))
			{
				...
				{
					if(arg4.Attach(dynamic_cast<Variable<Vector2>*>(_object)))
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::Arg4IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG5])
		{
			if(_object->IsClassPropertyExist(ColorableObject::COLORABLE_OBJECT_CLASS)) 
			{
				if(templateArg5.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg5.GetResult() == _object->GetName())
				{
					...
					if(arg5.Attach(dynamic_cast<ColorableObject*>(_object)))
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInImageAction::Arg5IsRenamed));
						UpdateValid();
					}
					return;
				}
...
bool CheckLineInImageAction::SaveToFile(StringANSI _path)			
{
	if(_path.empty())
	{
...
bool CheckLineInImageAction::SaveToFile(File& _file)
{
...
AbstractAction* CheckLineInImageAction::_LoadFromFile(File& _file)
{
	CheckLineInImageAction* action = new CheckLineInImageAction(TexturingSurface::CHECK_LINE_IN_IMAGE_MESSAGE);
	StringANSI name;
	int32 length;
	_file.Read(length);
