#ifndef GETTEXTURESIZEACTION_H
#define GETTEXTURESIZEACTION_H
...
class GetTextureSizeAction: public AbstractAction
{
	...
	private: GetTextureSizeAction(void);
	private: GetTextureSizeAction(int32 _type);
	public: virtual ~GetTextureSizeAction(void);
