#ifndef GETDATAFROMCONTROLCOLORABLEACTION_H
#define GETDATAFROMCONTROLCOLORABLEACTION_H
...
class GetDataFromControlColorableAction: public AbstractAction
{
    ...
    private: MagicPointer<ColorableObject> arg2;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<VectorLerp> target;
	private: GetDataFromControlColorableAction(void);
	private: GetDataFromControlColorableAction(int32 _type);
	public: virtual ~GetDataFromControlColorableAction(void);
