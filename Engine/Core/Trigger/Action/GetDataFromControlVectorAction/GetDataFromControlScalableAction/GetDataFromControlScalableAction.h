#ifndef GETDATAFROMCONTROLSCALABLEACTION_H
#define GETDATAFROMCONTROLSCALABLEACTION_H
...
class GetDataFromControlScalableAction: public AbstractAction
{
	...
	private: GetDataFromControlScalableAction(void);
	private: GetDataFromControlScalableAction(int32 _type);
	public: virtual ~GetDataFromControlScalableAction(void);
