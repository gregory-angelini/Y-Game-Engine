#ifndef GETDATAFROMCONTROLTRANSLATABLEACTION_H
#define GETDATAFROMCONTROLTRANSLATABLEACTION_H
...
class GetDataFromControlTranslatableAction: public AbstractAction
{
	...
	private: GetDataFromControlTranslatableAction(void);
	private: GetDataFromControlTranslatableAction(int32 _type);
	public: virtual ~GetDataFromControlTranslatableAction(void);
