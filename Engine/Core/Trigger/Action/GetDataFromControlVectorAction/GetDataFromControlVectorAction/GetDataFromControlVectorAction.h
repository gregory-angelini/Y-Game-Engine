#ifndef GETDATAFROMCONTROLVECTORACTION_H
#define GETDATAFROMCONTROLVECTORACTION_H
...
class GetDataFromControlVectorAction: public AbstractAction
{
    ...
    private: MagicPointer<Variable<Vector3>> arg2;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<VectorLerp> target;
	private: GetDataFromControlVectorAction(void);
	private: GetDataFromControlVectorAction(int32 _type);
	public: virtual ~GetDataFromControlVectorAction(void);
