#ifndef CHANGESTRINGVALUEACTION_H
#define CHANGESTRINGVALUEACTION_H
...
class ChangeStringValueAction: public AbstractAction
{
	...
	private: MagicPointer<Variable<StringANSI>> target;
	private: ChangeStringValueAction(void);
	private: ChangeStringValueAction(int32 _type);
	public: virtual ~ChangeStringValueAction(void);
