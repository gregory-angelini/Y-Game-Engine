#ifndef CHANGEBOOLEANVALUEACTION_H
#define CHANGEBOOLEANVALUEACTION_H
...
class ChangeBooleanValueAction: public AbstractAction
{
	...
	private: MagicPointer<Variable<bool>> target;
	private: ChangeBooleanValueAction(void);
	private: ChangeBooleanValueAction(int32 _type);
	public: virtual ~ChangeBooleanValueAction(void);
