#ifndef DISPLACEROTATIONACTION_H
#define DISPLACEROTATIONACTION_H
...
class DisplaceRotationAction: public AbstractAction
{
	friend class Trigger;
	friend class AbstractAction;
	private: StringANSI argName;
    private: StringExprParserEx templateArg;
    private: MagicPointer<RotatableObject> arg;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<RotatableObject> target;
	private: DisplaceRotationAction(void);
	private: DisplaceRotationAction(int32 _type);
	public: virtual ~DisplaceRotationAction(void);
