#ifndef GETFLOATLERPCURRENTACTION_H
#define GETFLOATLERPCURRENTACTION_H
...
class GetFloatLerpCurrentAction: public AbstractAction
{
	...
	private: GetFloatLerpCurrentAction(void);
	private: GetFloatLerpCurrentAction(int32 _type);
	public: virtual ~GetFloatLerpCurrentAction(void);
