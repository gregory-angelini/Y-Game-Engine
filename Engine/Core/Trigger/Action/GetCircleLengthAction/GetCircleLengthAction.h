#ifndef GETCIRCLELENGTHACTION_H
#define GETCIRCLELENGTHACTION_H
...
class GetCircleLengthAction: public AbstractAction
{
	...
	private: GetCircleLengthAction(void);
	private: GetCircleLengthAction(int32 _type);
	public: virtual ~GetCircleLengthAction(void);
