#ifndef ENABLEPROPERTYACTION_H
#define ENABLEPROPERTYACTION_H
...
class EnablePropertyAction: public AbstractAction
{
	...
	private: EnablePropertyAction(void);
	private: EnablePropertyAction(int32 _type);
	public: virtual ~EnablePropertyAction(void);
