#ifndef STREAMINGFLOATCURRENTACTION_H
#define STREAMINGFLOATCURRENTACTION_H
...
class StreamingFloatCurrentAction: public AbstractAction
{
    ...
    private: MagicPointer<Variable<float>> arg2;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<FloatLerp> target;
	private: StreamingFloatCurrentAction(void);
	private: StreamingFloatCurrentAction(int32 _type);
	public: virtual ~StreamingFloatCurrentAction(void);
