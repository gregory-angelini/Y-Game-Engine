#ifndef CREATEROTATIONACTION_H
#define CREATEROTATIONACTION_H
...
class CreateRotationAction: public AbstractAction
{
	...
	private: CreateRotationAction(void);
	private: CreateRotationAction(int32 _type);
	public: virtual ~CreateRotationAction(void);
