#ifndef CHANGEVECTORLERPMODEACTION_H
#define CHANGEVECTORLERPMODEACTION_H
...
class ChangeVectorLerpModeAction: public AbstractAction
{
	...
	private: ChangeVectorLerpModeAction(void);
	private: ChangeVectorLerpModeAction(int32 _type);
	public: virtual ~ChangeVectorLerpModeAction(void);
