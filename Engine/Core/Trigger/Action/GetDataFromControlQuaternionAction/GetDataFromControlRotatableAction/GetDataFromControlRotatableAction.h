#ifndef GETDATAFROMCONTROLROTATABLEACTION_H
#define GETDATAFROMCONTROLROTATABLEACTION_H
...
class GetDataFromControlRotatableAction: public AbstractAction
{
	...
	private: GetDataFromControlRotatableAction(void);
	private: GetDataFromControlRotatableAction(int32 _type);
	public: virtual ~GetDataFromControlRotatableAction(void);
