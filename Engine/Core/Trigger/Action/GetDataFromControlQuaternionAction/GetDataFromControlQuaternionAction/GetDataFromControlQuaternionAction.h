#ifndef GETDATAFROMCONTROLQUATERNIONACTION_H
#define GETDATAFROMCONTROLQUATERNIONACTION_H
...
class GetDataFromControlQuaternionAction: public AbstractAction
{
    ...
    private: MagicPointer<Variable<Quaternion>> arg2;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<QuaternionLerp> target;
	private: GetDataFromControlQuaternionAction(void);
	private: GetDataFromControlQuaternionAction(int32 _type);
	public: virtual ~GetDataFromControlQuaternionAction(void);
