#ifndef SETDATATOCONTROLROTATABLEACTION_H
#define SETDATATOCONTROLROTATABLEACTION_H
...
class SetDataToControlRotatableAction: public AbstractAction
{
	...
	private: SetDataToControlRotatableAction(void);
	private: SetDataToControlRotatableAction(int32 _type);
	public: virtual ~SetDataToControlRotatableAction(void);
