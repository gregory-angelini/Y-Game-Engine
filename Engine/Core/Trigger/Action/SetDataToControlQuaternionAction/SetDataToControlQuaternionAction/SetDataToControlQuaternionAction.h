#ifndef SETDATATOCONTROLQUATERNIONACTION_H
#define SETDATATOCONTROLQUATERNIONACTION_H
...
class SetDataToControlQuaternionAction: public AbstractAction
{
	...
	private: SetDataToControlQuaternionAction(void);
	private: SetDataToControlQuaternionAction(int32 _type);
	public: virtual ~SetDataToControlQuaternionAction(void);
