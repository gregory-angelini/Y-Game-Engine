#ifndef CHANGELISTBOOLEANACTION_H
#define CHANGELISTBOOLEANACTION_H
...
class ChangeListBooleanAction: public AbstractAction
{
	...
	private: ChangeListBooleanAction(void);
	private: ChangeListBooleanAction(int32 _type);
	public: virtual ~ChangeListBooleanAction(void);
