#ifndef CHANGELISTCOLORABLEACTION_H
#define CHANGELISTCOLORABLEACTION_H
...
class ChangeListColorableAction: public AbstractAction
{
	...
	private: ChangeListColorableAction(void);
	private: ChangeListColorableAction(int32 _type);
	public: virtual ~ChangeListColorableAction(void);
