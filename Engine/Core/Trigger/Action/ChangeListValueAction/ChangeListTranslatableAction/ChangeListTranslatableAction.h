#ifndef CHANGELISTTRANSLATABLEACTION_H
#define CHANGELISTTRANSLATABLEACTION_H
...
#include <Engine/Core/Parser/List/TranslatableObjectList/TranslatableObjectList.h>
class ChangeListTranslatableAction: public AbstractAction
{
	friend class Trigger;
	friend class AbstractAction;
	private: Vector3 argValue;
	private: StringANSI argName;
	private: MagicPointer<TranslatableObject> arg;
	...
	private: MagicPointer<List<TranslatableObject>> target;
	private: ChangeListTranslatableAction(void);
	private: ChangeListTranslatableAction(int32 _type);
	public: virtual ~ChangeListTranslatableAction(void);
