#ifndef CHANGELISTINTEGERACTION_H
#define CHANGELISTINTEGERACTION_H
...
class ChangeListIntegerAction: public AbstractAction
{
	...
	private: ChangeListIntegerAction(void);
	private: ChangeListIntegerAction(int32 _type);
	public: virtual ~ChangeListIntegerAction(void);
