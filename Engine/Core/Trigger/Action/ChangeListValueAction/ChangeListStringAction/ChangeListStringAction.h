#ifndef CHANGELISTSTRINGACTION_H
#define CHANGELISTSTRINGACTION_H
...
class ChangeListStringAction: public AbstractAction
{
	...
	private: ChangeListStringAction(void);
	private: ChangeListStringAction(int32 _type);
	public: virtual ~ChangeListStringAction(void);
