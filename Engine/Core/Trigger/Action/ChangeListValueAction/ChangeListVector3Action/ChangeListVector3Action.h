#ifndef CHANGELISTVECTOR3ACTION_H
#define CHANGELISTVECTOR3ACTION_H
...
#include <Engine/Core/Parser/List/Vector3List/Vector3List.h>
#include <Engine/Core/Parser/List/Vector3List/Vector3List.h>
class ChangeListVector3Action: public AbstractAction
{
	...
	private: ChangeListVector3Action(void);
	private: ChangeListVector3Action(int32 _type);
	public: virtual ~ChangeListVector3Action(void);
