#ifndef CHANGELISTROTATABLEACTION_H
#define CHANGELISTROTATABLEACTION_H
...
class ChangeListRotatableAction: public AbstractAction
{
	...
	private: ChangeListRotatableAction(void);
	private: ChangeListRotatableAction(int32 _type);
	public: virtual ~ChangeListRotatableAction(void);
