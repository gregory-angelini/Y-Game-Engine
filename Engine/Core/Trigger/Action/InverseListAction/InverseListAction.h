#ifndef INVERSELISTACTION_H
#define INVERSELISTACTION_H
...
class InverseListAction: public AbstractAction
{
	...
	private: InverseListAction(void);
	private: InverseListAction(int32 _type);
	public: virtual ~InverseListAction(void);
