#ifndef GETQUATERNIONLERPPATHACTION_H
#define GETQUATERNIONLERPPATHACTION_H
...
class GetQuaternionLerpPathAction: public AbstractAction
{
	...
	private: GetQuaternionLerpPathAction(void);
	private: GetQuaternionLerpPathAction(int32 _type);
	public: virtual ~GetQuaternionLerpPathAction(void);
