#ifndef CHANGEFLOATLERPTACTION_H
#define CHANGEFLOATLERPTACTION_H
...
class ChangeFloatLerpTAction: public AbstractAction
{
	...
	private: ChangeFloatLerpTAction(void);
	private: ChangeFloatLerpTAction(int32 _type);
	public: virtual ~ChangeFloatLerpTAction(void);
