#ifndef STREAMINGFLOATTACTION_H
#define STREAMINGFLOATTACTION_H
...
class StreamingFloatTAction: public AbstractAction
{
	...
	private: StreamingFloatTAction(void);
	private: StreamingFloatTAction(int32 _type);
	public: virtual ~StreamingFloatTAction(void);
