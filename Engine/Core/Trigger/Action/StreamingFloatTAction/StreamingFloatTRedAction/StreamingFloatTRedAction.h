#ifndef STREAMINGFLOATTREDACTION_H
#define STREAMINGFLOATTREDACTION_H
...
class StreamingFloatTRedAction: public AbstractAction
{
	...
	private: StreamingFloatTRedAction(void);
	private: StreamingFloatTRedAction(int32 _type);
	public: virtual ~StreamingFloatTRedAction(void);
