#ifndef STREAMINGFLOATTBLUEACTION_H
#define STREAMINGFLOATTBLUEACTION_H
...
class StreamingFloatTBlueAction: public AbstractAction
{
	...
	private: StreamingFloatTBlueAction(void);
	private: StreamingFloatTBlueAction(int32 _type);
	public: virtual ~StreamingFloatTBlueAction(void);
