#ifndef STREAMINGFLOATTANIMATIONFRAMEACTION_H
#define STREAMINGFLOATTANIMATIONFRAMEACTION_H
...
class StreamingFloatTAnimationFrameAction: public AbstractAction
{
    ...
    private: MagicPointer<AbstractAnimation> arg2;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<FloatLerp> target;
	private: StreamingFloatTAnimationFrameAction(void);
	private: StreamingFloatTAnimationFrameAction(int32 _type);
	public: virtual ~StreamingFloatTAnimationFrameAction(void);
