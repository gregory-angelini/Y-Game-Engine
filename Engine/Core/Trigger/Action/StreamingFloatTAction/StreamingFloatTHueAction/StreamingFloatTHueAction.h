#ifndef STREAMINGFLOATTHUEACTION_H
#define STREAMINGFLOATTHUEACTION_H
...
class StreamingFloatTHueAction: public AbstractAction
{
	...
	private: StreamingFloatTHueAction(void);
	private: StreamingFloatTHueAction(int32 _type);
	public: virtual ~StreamingFloatTHueAction(void);
