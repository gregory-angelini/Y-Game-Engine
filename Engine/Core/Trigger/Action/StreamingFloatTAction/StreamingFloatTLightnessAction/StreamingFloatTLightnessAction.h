#ifndef STREAMINGFLOATTLIGHTNESSACTION_H
#define STREAMINGFLOATTLIGHTNESSACTION_H
...
class StreamingFloatTLightnessAction: public AbstractAction
{
	...
	private: StreamingFloatTLightnessAction(void);
	private: StreamingFloatTLightnessAction(int32 _type);
	public: virtual ~StreamingFloatTLightnessAction(void);
