#ifndef STREAMINGFLOATTSATURATIONACTION_H
#define STREAMINGFLOATTSATURATIONACTION_H
...
class StreamingFloatTSaturationAction: public AbstractAction
{
	...
	private: StreamingFloatTSaturationAction(void);
	private: StreamingFloatTSaturationAction(int32 _type);
	public: virtual ~StreamingFloatTSaturationAction(void);
