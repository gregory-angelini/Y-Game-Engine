#ifndef STREAMINGFLOATTDELTASCALEACTION_H
#define STREAMINGFLOATTDELTASCALEACTION_H
...
class StreamingFloatTDeltaScaleAction: public AbstractAction
{
    ...
    private: MagicPointer<LogicObject> arg2;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<FloatLerp> target;
	private: StreamingFloatTDeltaScaleAction(void);
	private: StreamingFloatTDeltaScaleAction(int32 _type);
	public: virtual ~StreamingFloatTDeltaScaleAction(void);
