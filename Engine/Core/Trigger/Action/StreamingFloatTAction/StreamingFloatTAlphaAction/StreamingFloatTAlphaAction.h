#ifndef STREAMINGFLOATTALPHAACTION_H
#define STREAMINGFLOATTALPHAACTION_H
...
class StreamingFloatTAlphaAction: public AbstractAction
{
	...
	private: StreamingFloatTAlphaAction(void);
	private: StreamingFloatTAlphaAction(int32 _type);
	public: virtual ~StreamingFloatTAlphaAction(void);
