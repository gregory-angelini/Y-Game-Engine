#ifndef STREAMINGFLOATTGREENACTION_H
#define STREAMINGFLOATTGREENACTION_H
...
class StreamingFloatTGreenAction: public AbstractAction
{
	...
	private: StreamingFloatTGreenAction(void);
	private: StreamingFloatTGreenAction(int32 _type);
	public: virtual ~StreamingFloatTGreenAction(void);
