#ifndef ENABLECOLLISIONINFOACTION_H
#define ENABLECOLLISIONINFOACTION_H
...
class EnableCollisionPolygonsInfoAction: public AbstractAction
{
	...
	private: EnableCollisionPolygonsInfoAction(void);
	private: EnableCollisionPolygonsInfoAction(int32 _type);
	public: virtual ~EnableCollisionPolygonsInfoAction(void);
