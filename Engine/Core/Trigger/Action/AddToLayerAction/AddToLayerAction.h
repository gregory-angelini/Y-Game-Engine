#ifndef ADDTOLAYERACTION_H
#define ADDTOLAYERACTION_H
...
class AddToLayerAction: public AbstractAction
{
	...
	private: AddToLayerAction(void);
	private: AddToLayerAction(int32 _type);
	public: virtual ~AddToLayerAction(void);
