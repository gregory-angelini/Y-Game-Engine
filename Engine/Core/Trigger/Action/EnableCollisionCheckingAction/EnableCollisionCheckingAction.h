#ifndef ENABLECOLLISIONCHECKINGACTION_H
#define ENABLECOLLISIONCHECKINGACTION_H
...
class EnableCollisionCheckingAction: public AbstractAction
{
	...
	private: EnableCollisionCheckingAction(void);
	private: EnableCollisionCheckingAction(int32 _type);
	public: virtual ~EnableCollisionCheckingAction(void);
