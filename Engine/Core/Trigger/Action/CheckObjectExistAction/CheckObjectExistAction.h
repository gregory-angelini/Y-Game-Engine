#ifndef CHECKOBJECTEXISTACTION_H
#define CHECKOBJECTEXISTACTION_H
...
class CheckObjectExistAction: public AbstractAction
{
	...
	private: CheckObjectExistAction(void);
	private: CheckObjectExistAction(int32 _type);
	public: virtual ~CheckObjectExistAction(void);
