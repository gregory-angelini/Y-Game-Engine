#ifndef REMOVEBRUSHACTION_H
#define REMOVEBRUSHACTION_H
...
class RemoveBrushAction: public AbstractAction
{
	...
	private: RemoveBrushAction(void);
	private: RemoveBrushAction(int32 _type);
	public: virtual ~RemoveBrushAction(void);
