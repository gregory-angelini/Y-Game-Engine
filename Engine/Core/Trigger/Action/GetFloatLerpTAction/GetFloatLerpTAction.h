#ifndef GETFLOATLERPTACTION_H
#define GETFLOATLERPTACTION_H
...
class GetFloatLerpTAction: public AbstractAction
{
	...
	private: GetFloatLerpTAction(void);
	private: GetFloatLerpTAction(int32 _type);
	public: virtual ~GetFloatLerpTAction(void);
