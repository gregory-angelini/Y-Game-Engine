#ifndef CREATESOLIDTILEACTION_H
#define CREATESOLIDTILEACTION_H
...
class CreateSolidTileAction: public AbstractAction
{
	...
	private: CreateSolidTileAction(void);
	private: CreateSolidTileAction(int32 _type);
	public: virtual ~CreateSolidTileAction(void);
