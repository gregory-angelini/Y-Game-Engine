#ifndef ADDINPUTEVENTACTION_H
#define ADDINPUTEVENTACTION_H
...
class AddInputEventAction: public AbstractAction
{
	...
	private: AddInputEventAction(void);
	private: AddInputEventAction(int32 _type);
	public: virtual ~AddInputEventAction(void);
