#ifndef CREATEVECTORLERPACTION_H
#define CREATEVECTORLERPACTION_H
...
class CreateVectorLerpAction: public AbstractAction
{
	...
	private: CreateVectorLerpAction(void);
	private: CreateVectorLerpAction(int32 _type);
	public: virtual ~CreateVectorLerpAction(void);
