#ifndef CHANGETILEDSPACESIZEACTION_H
#define CHANGETILEDSPACESIZEACTION_H
...
class ChangeTiledSpaceSizeAction: public AbstractAction
{
	...
	private: ChangeTiledSpaceSizeAction(void);
	private: ChangeTiledSpaceSizeAction(int32 _type);
	public: virtual ~ChangeTiledSpaceSizeAction(void);
