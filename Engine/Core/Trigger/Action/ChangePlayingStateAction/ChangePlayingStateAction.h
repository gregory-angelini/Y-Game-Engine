#ifndef CHANGEPLAYINGSTATEACTION_H
#define CHANGEPLAYINGSTATEACTION_H
...
class ChangePlayingStateAction: public AbstractAction
{
	...
	private: ChangePlayingStateAction(void);
	private: ChangePlayingStateAction(int32 _type);
	public: virtual ~ChangePlayingStateAction(void);
