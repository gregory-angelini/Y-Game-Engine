#ifndef GETROTATIONACTION_H
#define GETROTATIONACTION_H
...
class GetRotationAction: public AbstractAction
{
	...
	private: GetRotationAction(void);
	private: GetRotationAction(int32 _type);
	public: virtual ~GetRotationAction(void);
