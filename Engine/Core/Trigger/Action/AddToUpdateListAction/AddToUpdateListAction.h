#ifndef ADDTOUPDATELISTACTION_H
#define ADDTOUPDATELISTACTION_H
...
class AddToUpdateListAction: public AbstractAction
{
	...
	private: AddToUpdateListAction(void);
	private: AddToUpdateListAction(int32 _type);
	public: virtual ~AddToUpdateListAction(void);
