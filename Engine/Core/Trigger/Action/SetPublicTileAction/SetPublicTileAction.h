#ifndef SETPUBLICTILEACTION_H
#define SETPUBLICTILEACTION_H
...
class SetPublicTileAction: public AbstractAction
{
	...
	private: SetPublicTileAction(void);
	private: SetPublicTileAction(int32 _type);
	public: virtual ~SetPublicTileAction(void);
