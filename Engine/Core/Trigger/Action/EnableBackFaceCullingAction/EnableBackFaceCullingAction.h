#ifndef ENABLEBACKFACECULLINGACTION_H
#define ENABLEBACKFACECULLINGACTION_H
...
class EnableBackFaceCullingAction: public AbstractAction
{
	...
	private: EnableBackFaceCullingAction(void);
	private: EnableBackFaceCullingAction(int32 _type);
	public: virtual ~EnableBackFaceCullingAction(void);
