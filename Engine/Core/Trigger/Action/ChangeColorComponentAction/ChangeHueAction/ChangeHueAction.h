#ifndef CHANGEHUEACTION_H
#define CHANGEHUEACTION_H
...
class ChangeHueAction: public AbstractAction
{
	...
	private: ChangeHueAction(void);
	private: ChangeHueAction(int32 _type);
	public: virtual ~ChangeHueAction(void);
