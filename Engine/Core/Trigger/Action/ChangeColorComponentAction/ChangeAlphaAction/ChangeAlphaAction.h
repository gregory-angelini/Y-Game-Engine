#ifndef CHANGEALPHAACTION_H
#define CHANGEALPHAACTION_H
...
class ChangeAlphaAction: public AbstractAction
{
	...
	private: ChangeAlphaAction(void);
	private: ChangeAlphaAction(int32 _type);
	public: virtual ~ChangeAlphaAction(void);
