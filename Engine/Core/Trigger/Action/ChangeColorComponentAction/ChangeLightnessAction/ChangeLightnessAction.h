#ifndef CHANGELIGHTNESSACTION_H
#define CHANGELIGHTNESSACTION_H
...
class ChangeLightnessAction: public AbstractAction
{
	...
	private: ChangeLightnessAction(void);
	private: ChangeLightnessAction(int32 _type);
	public: virtual ~ChangeLightnessAction(void);
