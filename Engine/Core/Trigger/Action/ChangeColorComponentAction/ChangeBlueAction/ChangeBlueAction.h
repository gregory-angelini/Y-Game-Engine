#ifndef CHANGEBLUEACTION_H
#define CHANGEBLUEACTION_H
...
class ChangeBlueAction: public AbstractAction
{
	...
	private: ChangeBlueAction(void);
	private: ChangeBlueAction(int32 _type);
	public: virtual ~ChangeBlueAction(void);
