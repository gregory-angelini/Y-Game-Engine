#ifndef CHANGEGREENACTION_H
#define CHANGEGREENACTION_H
...
class ChangeGreenAction: public AbstractAction
{
	...
	private: ChangeGreenAction(void);
	private: ChangeGreenAction(int32 _type);
	public: virtual ~ChangeGreenAction(void);
