#ifndef CHANGESATURATIONACTION_H
#define CHANGESATURATIONACTION_H
...
class ChangeSaturationAction: public AbstractAction
{
	...
	private: ChangeSaturationAction(void);
	private: ChangeSaturationAction(int32 _type);
	public: virtual ~ChangeSaturationAction(void);
