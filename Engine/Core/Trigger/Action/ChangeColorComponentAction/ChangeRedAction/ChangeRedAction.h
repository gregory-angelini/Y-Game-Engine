#ifndef CHANGEREDACTION_H
#define CHANGEREDACTION_H
...
class ChangeRedAction: public AbstractAction
{
	...
	private: ChangeRedAction(void);
	private: ChangeRedAction(int32 _type);
	public: virtual ~ChangeRedAction(void);
