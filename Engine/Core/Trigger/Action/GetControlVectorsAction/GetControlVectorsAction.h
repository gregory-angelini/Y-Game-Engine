#ifndef GETCONTROLVECTORSACTION_H
#define GETCONTROLVECTORSACTION_H
...
class GetControlVectorsAction: public AbstractAction
{
	...
	private: GetControlVectorsAction(void);
	private: GetControlVectorsAction(int32 _type);
	public: virtual ~GetControlVectorsAction(void);
