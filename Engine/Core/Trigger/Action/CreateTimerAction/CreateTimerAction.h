#ifndef CREATETIMERACTION_H
#define CREATETIMERACTION_H
...
class CreateTimerAction: public AbstractAction
{
	...
	private: CreateTimerAction(void);
	private: CreateTimerAction(int32 _type);
	public: virtual ~CreateTimerAction(void);
