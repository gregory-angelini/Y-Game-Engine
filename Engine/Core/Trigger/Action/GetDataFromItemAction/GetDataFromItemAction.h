#ifndef GETDATAFROMITEMACTION_H
#define GETDATAFROMITEMACTION_H
...
class GetDataFromItemAction: public AbstractAction
{
	...
	private: GetDataFromItemAction(void);
	private: GetDataFromItemAction(int32 _type);
	public: virtual ~GetDataFromItemAction(void);
