#ifndef CREATETEXTUREDANIMATIONACTION_H
#define CREATETEXTUREDANIMATIONACTION_H
...
class CreateTexturedAnimationAction: public AbstractAction
{
	...
	private: CreateTexturedAnimationAction(void);
	private: CreateTexturedAnimationAction(int32 _type);
	public: virtual ~CreateTexturedAnimationAction(void);
