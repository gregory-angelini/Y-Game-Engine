#ifndef CHECKLINEINSURFACEACTION_H
#define CHECKLINEINSURFACEACTION_H
...
class CheckLineInSurfaceAction: public AbstractAction
{
    ...
    private: MagicPointer<TranslatableObject> arg4;

	private: StringANSI arg5Name;
    private: StringExprParserEx templateArg5;
    private: MagicPointer<Variable<int32>> arg5;

	private: StringANSI targetName;
	private: StringExprParserEx templateTarget;
	private: MagicPointer<AbstractSurface> target;
	
	private: Vector3 intersectionPoint;
	private: int32 intersectedTriangle;
	private: CheckLineInSurfaceAction(void);
	private: CheckLineInSurfaceAction(int32 _type);
	public: virtual ~CheckLineInSurfaceAction(void);
