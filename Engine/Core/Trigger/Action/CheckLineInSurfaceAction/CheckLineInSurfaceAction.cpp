#include "CheckLineInSurfaceAction.h"
#include <Engine/Core/AssetLibrary/AssetLibrary.h>
#include <Engine/Core/Trigger/Trigger.h>


CheckLineInSurfaceAction::CheckLineInSurfaceAction(void)
{}


CheckLineInSurfaceAction::CheckLineInSurfaceAction(int32 _type): AbstractAction(_type)
{}
...
void CheckLineInSurfaceAction::UpdateValid(void)
{
	valid = false; 
...
void CheckLineInSurfaceAction::SetVariableArg(int32 _index, StringANSI _name)
{
	switch(_index)
	{
		case ARG1:
			...
			if(arg1.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::Arg1IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg2.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::Arg2IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg3.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::Arg3IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg4.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::Arg4IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg5.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(Variable<int32>::INTEGER_VARIABLE_CLASS)) 
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::Arg5IsRenamed));
							UpdateValid();
						}
						return;
					}
		...
		{  
			...
			if(target.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(AbstractSurface::ABSTRACT_SURFACE_CLASS))
					{
						if(target.Attach(dynamic_cast<AbstractSurface*>(object)))
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::TargetIsRenamed));
							UpdateValid();
						}
						return;
					}
...
void CheckLineInSurfaceAction::SetTemplateArg(int32 _index, StringANSI _expr)
{
	switch(_index)
	{
		case ARG1:
		{
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::TemplateArg1IsCompleted));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::Arg1IsLost));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::TemplateArg1IsChanged));
		...
		case ARG2:
		{
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::TemplateArg2IsCompleted));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::Arg2IsLost));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::TemplateArg2IsChanged));
		...
		case ARG3:
		{
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::TemplateArg3IsCompleted));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::Arg3IsLost));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::TemplateArg3IsChanged));
		...
		case ARG4: 
		{
			templateArg4.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::TemplateArg4IsCompleted));
			templateArg4.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::Arg4IsLost));
			templateArg4.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::TemplateArg4IsChanged));
		...
		case ARG5:
		{
			templateArg5.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::TemplateArg5IsCompleted));
			templateArg5.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::Arg5IsLost));
			templateArg5.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::TemplateArg5IsChanged));
		...
		case TARGET:
		{
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::TemplateTargetIsCompleted));
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::TargetIsLost));
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::TemplateTargetIsChanged));
...
void CheckLineInSurfaceAction::SetVector3KeyArg(int32 _index, Vector3 _value)
{
	switch(_index)
	{
		case ARG1:
...
void CheckLineInSurfaceAction::TemplateArg1IsCompleted(void)
{
...
void CheckLineInSurfaceAction::TemplateArg2IsCompleted(void)
{
...
void CheckLineInSurfaceAction::TemplateArg3IsCompleted(void)
{
...
void CheckLineInSurfaceAction::TemplateArg4IsCompleted(void)
{
...
void CheckLineInSurfaceAction::TemplateArg5IsCompleted(void)
{
...
void CheckLineInSurfaceAction::Arg1IsLost(void)
{
	if(arg1.IsNotEmpty())
	{ 
	...
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::ObjectIsCreated));
	valid = false;
}


void CheckLineInSurfaceAction::Arg2IsLost(void)
{
	if(arg2.IsNotEmpty())
	{ 
...
void CheckLineInSurfaceAction::Arg3IsLost(void)
{
	if(arg3.IsNotEmpty())
	{ 
...
void CheckLineInSurfaceAction::Arg4IsLost(void)
{
	if(arg4.IsNotEmpty())
	{ 
...
void CheckLineInSurfaceAction::Arg5IsLost(void)
{
	if(arg5.IsNotEmpty())
	{ 
...
void CheckLineInSurfaceAction::TemplateArg1IsChanged(void)
{
	Arg1IsLost();
...
void CheckLineInSurfaceAction::TemplateArg2IsChanged(void)
{
	Arg2IsLost();
...
void CheckLineInSurfaceAction::TemplateArg3IsChanged(void)
{
	Arg3IsLost();
...
void CheckLineInSurfaceAction::TemplateArg4IsChanged(void)
{
	Arg4IsLost();
...
void CheckLineInSurfaceAction::TemplateArg5IsChanged(void)
{
	Arg5IsLost();
...
void CheckLineInSurfaceAction::TemplateTargetIsCompleted(void)
{
...
void CheckLineInSurfaceAction::TargetIsLost(void)
{
...
void CheckLineInSurfaceAction::TemplateTargetIsChanged(void)
{
	TargetIsLost();
...
StringANSI CheckLineInSurfaceAction::GetTemplateArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI CheckLineInSurfaceAction::GetVariableArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
Vector3 CheckLineInSurfaceAction::GetVector3KeyArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
void CheckLineInSurfaceAction::operator () (void)
{
	if(IsValid())
	{
		intersectedTriangle = target.Get()->IsIntersected(Line(arg1.Get()->GetPosition(), arg2.Get()->GetPosition()), &intersectionPoint);
		...
		else
		{
			...
			arg5.Get()->SetValue(intersectedTriangle);
		}
	}
	else if(target.IsNotEmpty() && arg1.IsNotEmpty() && arg2.IsNotEmpty())
	{
		if(arg3.IsNotEmpty() || arg4.IsNotEmpty() || arg5.IsNotEmpty())
		{
			intersectedTriangle = target.Get()->IsIntersected(Line(arg1.Get()->GetPosition(), arg2.Get()->GetPosition()), &intersectionPoint);
			...
			else
			{
				...
				if(arg5.IsNotEmpty()) { arg5.Get()->SetValue(intersectedTriangle); }
			}
		}
	}
}
...
void CheckLineInSurfaceAction::ObjectIsDestroyed(AbstractObject* _object)
{
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::ObjectIsCreated));
	valid = false;
}
...
void CheckLineInSurfaceAction::TargetIsRenamed(AbstractObject::NameInfo* _info)
{
	TargetIsLost();
}
...
void CheckLineInSurfaceAction::Arg1IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg1IsLost();
}


void CheckLineInSurfaceAction::Arg2IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg2IsLost();
}


void CheckLineInSurfaceAction::Arg3IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg3IsLost();
}


void CheckLineInSurfaceAction::Arg4IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg4IsLost();
}

void CheckLineInSurfaceAction::Arg5IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg5IsLost();
}
...
void CheckLineInSurfaceAction::ObjectIsCreated(AbstractObject* _object)
{
	if(target.IsEmpty())
	{
		if(state[TEMPLATE][TARGET])
		{
			if(_object->IsClassPropertyExist(AbstractSurface::ABSTRACT_SURFACE_CLASS))
			{
				if(templateTarget.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateTarget.GetResult() == _object->GetName())
				{
					if(target.Attach(dynamic_cast<AbstractSurface*>(_object)))
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::TargetIsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG1])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg1.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg1.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::Arg1IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG2])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg2.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg2.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::Arg2IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG3])
		{
			if(_object->IsClassPropertyExist(Variable<bool>::BOOLEAN_VARIABLE_CLASS))
			{
				if(templateArg3.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg3.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::Arg3IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG4])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg4.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg4.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::Arg4IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG5])
		{
			if(_object->IsClassPropertyExist(Variable<int32>::INTEGER_VARIABLE_CLASS)) 
			{
				if(templateArg5.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg5.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &CheckLineInSurfaceAction::Arg5IsRenamed));
						UpdateValid();
					}
					return;
				}
...
bool CheckLineInSurfaceAction::SaveToFile(StringANSI _path)			
{
	if(_path.empty())
	{
...
bool CheckLineInSurfaceAction::SaveToFile(File& _file)
{
...
AbstractAction* CheckLineInSurfaceAction::_LoadFromFile(File& _file)
{
	CheckLineInSurfaceAction* action = new CheckLineInSurfaceAction(AbstractSurface::CHECK_LINE_IN_SURFACE_MESSAGE);
	StringANSI name;
	int32 length;
	_file.Read(length);
