#ifndef CHANGEACTIVATIONLIMITACTION_H
#define CHANGEACTIVATIONLIMITACTION_H
...
class ChangeActivationLimitAction: public AbstractAction
{
	...
	private: ChangeActivationLimitAction(void);
	private: ChangeActivationLimitAction(int32 _type);
	public: virtual ~ChangeActivationLimitAction(void);
