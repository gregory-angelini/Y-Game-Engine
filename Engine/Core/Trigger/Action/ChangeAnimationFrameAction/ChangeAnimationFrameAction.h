#ifndef CHANGEANIMATIONFRAMEACTION_H
#define CHANGEANIMATIONFRAMEACTION_H
...
class ChangeAnimationFrameAction: public AbstractAction
{
	...
	private: MagicPointer<AbstractAnimation> target;
	private: ChangeAnimationFrameAction(void);
	private: ChangeAnimationFrameAction(int32 _type);
	public: virtual ~ChangeAnimationFrameAction(void);
