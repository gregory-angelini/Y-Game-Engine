#ifndef REMOVEFROMUPDATELISTACTION_H
#define REMOVEFROMUPDATELISTACTION_H
...
class RemoveFromUpdateListAction: public AbstractAction
{
	...
	private: MagicPointer<LogicScene> target;
	private: RemoveFromUpdateListAction(void);
	private: RemoveFromUpdateListAction(int32 _type);
	public: virtual ~RemoveFromUpdateListAction(void);
