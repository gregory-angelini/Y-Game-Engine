#ifndef CREATEROTATIONFROMQUATERNIONTOQUATERNIONACTION_H
#define CREATEROTATIONFROMQUATERNIONTOQUATERNIONACTION_H
...
class CreateRotationFromQuaternionToQuaternionAction: public AbstractAction
{
	friend class Trigger;
	friend class AbstractAction;
	private: StringANSI arg1Name;
    private: StringExprParserEx templateArg1;
    private: MagicPointer<RotatableObject> arg1;
	...
	private: MagicPointer<RotatableObject> target;
	private: CreateRotationFromQuaternionToQuaternionAction(void);
	private: CreateRotationFromQuaternionToQuaternionAction(int32 _type);
	public: virtual ~CreateRotationFromQuaternionToQuaternionAction(void);
