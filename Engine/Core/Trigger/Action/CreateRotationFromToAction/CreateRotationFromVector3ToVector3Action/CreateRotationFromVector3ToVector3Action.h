#ifndef CREATEROTATIONFROMVECTOR3TOVECTOR3ACTION_H
#define CREATEROTATIONFROMVECTOR3TOVECTOR3ACTION_H
...
class CreateRotationFromVector3ToVector3Action: public AbstractAction
{
	...
	private: CreateRotationFromVector3ToVector3Action(void);
	private: CreateRotationFromVector3ToVector3Action(int32 _type);
	public: virtual ~CreateRotationFromVector3ToVector3Action(void);
