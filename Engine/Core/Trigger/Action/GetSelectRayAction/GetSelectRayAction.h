#ifndef GETSELECTRAYACTION_H
#define GETSELECTRAYACTION_H
...
class GetSelectRayAction: public AbstractAction
{
	...
	private: GetSelectRayAction(void);
	private: GetSelectRayAction(int32 _type);
	public: virtual ~GetSelectRayAction(void);
