#ifndef CREATECAMERAACTION_H
#define CREATECAMERAACTION_H
...
class CreateCameraAction: public AbstractAction
{
	...
	private: CreateCameraAction(void);
	private: CreateCameraAction(int32 _type);
	public: virtual ~CreateCameraAction(void);
