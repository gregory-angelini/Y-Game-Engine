#ifndef CHANGEFLOATRANGEACTION_H
#define CHANGEFLOATRANGEACTION_H
...
class ChangeFloatValueRangeAction: public AbstractAction
{
	...
	private: ChangeFloatValueRangeAction(void);
	private: ChangeFloatValueRangeAction(int32 _type);
	public: virtual ~ChangeFloatValueRangeAction(void);
