#ifndef CHANGEINTEGERRANGEACTION_H
#define CHANGEINTEGERRANGEACTION_H
...
class ChangeIntegerValueRangeAction: public AbstractAction
{
	...
	private: ChangeIntegerValueRangeAction(void);
	private: ChangeIntegerValueRangeAction(int32 _type);
	public: virtual ~ChangeIntegerValueRangeAction(void);
