#ifndef CHANGEROTATIONMODEACTION_H
#define CHANGEROTATIONMODEACTION_H
...
class ChangeRotationModeAction: public AbstractAction
{
	...
	private: ChangeRotationModeAction(void);
	private: ChangeRotationModeAction(int32 _type);
	public: virtual ~ChangeRotationModeAction(void);
