#ifndef GETTILECENTERACTION_H
#define GETTILECENTERACTION_H
...
class GetTileCenterAction: public AbstractAction
{
	...
	private: GetTileCenterAction(void);
	private: GetTileCenterAction(int32 _type);
	public: virtual ~GetTileCenterAction(void);
