#ifndef CHANGEPLANENORMALACTION_H
#define CHANGEPLANENORMALACTION_H
...
class ChangePlaneNormalAction: public AbstractAction
{
	...
	private: MagicPointer<Plane> target;
	private: ChangePlaneNormalAction(void);
	private: ChangePlaneNormalAction(int32 _type);
	public: virtual ~ChangePlaneNormalAction(void);
