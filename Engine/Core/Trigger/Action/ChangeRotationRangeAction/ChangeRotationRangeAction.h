#ifndef CHANGEROTATIONRANGEACTION_H
#define CHANGEROTATIONRANGEACTION_H
...
class ChangeRotationRangeAction: public AbstractAction
{
	...
	private: ChangeRotationRangeAction(void);
	private: ChangeRotationRangeAction(int32 _type);
	public: virtual ~ChangeRotationRangeAction(void);
