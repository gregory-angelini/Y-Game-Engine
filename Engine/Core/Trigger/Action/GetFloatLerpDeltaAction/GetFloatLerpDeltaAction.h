#ifndef GETFLOATLERPDELTAACTION_H
#define GETFLOATLERPDELTAACTION_H
...
class GetFloatLerpDeltaAction: public AbstractAction
{
	...
	private: GetFloatLerpDeltaAction(void);
	private: GetFloatLerpDeltaAction(int32 _type);
	public: virtual ~GetFloatLerpDeltaAction(void);
