#ifndef VECTOR2TOSPHERICALACTION_H
#define VECTOR2TOSPHERICALACTION_H
...
class Vector2ToSphericalAction: public AbstractAction
{
	...
	private: Vector2ToSphericalAction(void);
	private: Vector2ToSphericalAction(int32 _type);
	public: virtual ~Vector2ToSphericalAction(void);
