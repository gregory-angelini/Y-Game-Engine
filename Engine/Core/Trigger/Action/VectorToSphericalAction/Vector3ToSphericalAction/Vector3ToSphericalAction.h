#ifndef	VECTOR3TOSPHERICALACTION_H
#define VECTOR3TOSPHERICALACTION_H
...
class Vector3ToSphericalAction: public AbstractAction
{
	...
	private: Vector3ToSphericalAction(void);
	private: Vector3ToSphericalAction(int32 _type);
	public: virtual ~Vector3ToSphericalAction(void);
