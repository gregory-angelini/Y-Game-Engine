#ifndef ENABLESHOWACTION_H
#define ENABLESHOWACTION_H
...
class EnableShowAction: public AbstractAction
{
	...
	private: MagicPointer<GraphicsObject> target;
	private: EnableShowAction(void);
	private: EnableShowAction(int32 _type);
	public: virtual ~EnableShowAction(void);
