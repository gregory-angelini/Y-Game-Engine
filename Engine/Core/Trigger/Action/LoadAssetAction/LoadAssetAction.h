#ifndef LOADASSETACTION_H
#define LOADASSETACTION_H
...
class LoadAssetAction: public AbstractAction
{
	...
	private: LoadAssetAction(void);
	private: LoadAssetAction(int32 _type);
	public: virtual ~LoadAssetAction(void);
