#include "LoadAssetAction.h"
#include <Engine/Core/AssetLibrary/AssetLibrary.h>
#include <Engine/Core/Trigger/Trigger.h>


LoadAssetAction::LoadAssetAction(void)
{}


LoadAssetAction::LoadAssetAction(int32 _type): AbstractAction(_type)
{}
...
void LoadAssetAction::UpdateValid(void)
{
	valid = false; 
...
void LoadAssetAction::SetVariableArg(int32 _index, StringANSI _name)
{
	switch(_index)
	{
		case ARG1:
			...
			if(arg1.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(Variable<StringANSI>::STRING_VARIABLE_CLASS)) 
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &LoadAssetAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &LoadAssetAction::Arg1IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg2.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(Variable<int32>::INTEGER_VARIABLE_CLASS)) 
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &LoadAssetAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &LoadAssetAction::Arg2IsRenamed));
							UpdateValid();
						}
						return;
					}
...
void LoadAssetAction::SetTemplateArg(int32 _index, StringANSI _expr)
{
	switch(_index)
	{
		case ARG1:
		{
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &LoadAssetAction::TemplateArg1IsCompleted));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &LoadAssetAction::Arg1IsLost));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &LoadAssetAction::TemplateArg1IsChanged));
		...
		case ARG2:
		{
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &LoadAssetAction::TemplateArg2IsCompleted));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &LoadAssetAction::Arg2IsLost));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &LoadAssetAction::TemplateArg2IsChanged));
...
void LoadAssetAction::SetStringKeyArg(int32 _index, StringANSI _value)
{
	switch(_index)
	{
		case ARG1:
...
void LoadAssetAction::SetIntegerKeyArg(int32 _index, int32 _value)
{
	switch(_index)
	{
		case ARG2:
...
void LoadAssetAction::TemplateArg1IsCompleted(void)
{
...
void LoadAssetAction::Arg1IsLost(void)
{
	if(arg1.IsNotEmpty())
	{ 
	...
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &LoadAssetAction::ObjectIsCreated));
	valid = false;
}



void LoadAssetAction::TemplateArg1IsChanged(void)
{
	Arg1IsLost();
...
void LoadAssetAction::TemplateArg2IsCompleted(void)
{
...
void LoadAssetAction::Arg2IsLost(void)
{
	if(arg2.IsNotEmpty())
	{ 
...
void LoadAssetAction::TemplateArg2IsChanged(void)
{
	Arg2IsLost();
...
StringANSI LoadAssetAction::GetTemplateArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI LoadAssetAction::GetVariableArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI LoadAssetAction::GetStringKeyArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
int32 LoadAssetAction::GetIntegerKeyArg(int32 _index)
{
	switch(_index)
	{
		case ARG2:
...
void LoadAssetAction::operator () (void)
{
	if(IsValid()) 
	{
		AssetLibrary::_LoadCommonAsset(arg1.Get()->GetValue(), arg2.Get()->GetValue());
	}
}



void LoadAssetAction::ObjectIsDestroyed(AbstractObject* _object)
{
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &LoadAssetAction::ObjectIsCreated));
	valid = false;
}
...
void LoadAssetAction::Arg1IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg1IsLost();
}
...
void LoadAssetAction::Arg2IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg2IsLost();
}
...
void LoadAssetAction::ObjectIsCreated(AbstractObject* _object)
{
	if(arg1.IsEmpty())
	{ 
		if(state[TEMPLATE][ARG1])
		{
			if(_object->IsClassPropertyExist(Variable<StringANSI>::STRING_VARIABLE_CLASS))
			{
				if(templateArg1.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg1.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &LoadAssetAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &LoadAssetAction::Arg1IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG2])
		{
			if(_object->IsClassPropertyExist(Variable<int32>::INTEGER_VARIABLE_CLASS))
			{
				if(templateArg2.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg2.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &LoadAssetAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &LoadAssetAction::Arg2IsRenamed));
						UpdateValid();
					}
					return;
				}
...
bool LoadAssetAction::SaveToFile(StringANSI _path)			
{
	if(_path.empty())
	{
...
bool LoadAssetAction::SaveToFile(File& _file)
{
...
AbstractAction* LoadAssetAction::_LoadFromFile(File& _file)
{
	LoadAssetAction* action = new LoadAssetAction(AssetLibrary::LOAD_ASSET_MESSAGE);
	StringANSI name;
	int32 length;
	_file.Read(length);
