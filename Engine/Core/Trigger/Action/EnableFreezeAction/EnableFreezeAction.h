#ifndef ENABLEFREEZEACTION_H
#define ENABLEFREEZEACTION_H
...
class EnableFreezeAction: public AbstractAction
{
	...
	private: EnableFreezeAction(void);
	private: EnableFreezeAction(int32 _type);
	public: virtual ~EnableFreezeAction(void);
