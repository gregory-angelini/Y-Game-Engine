#ifndef DISPLACESCALEACTION_H
#define DISPLACESCALEACTION_H
...
class DisplaceScaleAction: public AbstractAction
{
	...
	private: DisplaceScaleAction(void);
	private: DisplaceScaleAction(int32 _type);
	public: virtual ~DisplaceScaleAction(void);
