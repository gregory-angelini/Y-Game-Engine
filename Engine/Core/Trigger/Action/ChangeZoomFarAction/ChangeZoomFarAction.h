#ifndef CHANGEZOOMFARACTION_H
#define CHANGEZOOMFARACTION_H
...
class ChangeZoomFarAction: public AbstractAction
{
	...
	private: ChangeZoomFarAction(void);
	private: ChangeZoomFarAction(int32 _type);
	public: virtual ~ChangeZoomFarAction(void);
