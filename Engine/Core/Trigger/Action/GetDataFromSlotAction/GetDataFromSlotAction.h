#ifndef GETDATAFROMSLOTACTION_H
#define GETDATAFROMSLOTACTION_H
...
class GetDataFromSlotAction: public AbstractAction
{
	...
	private: MagicPointer<Set> target;
	private: GetDataFromSlotAction(void);
	private: GetDataFromSlotAction(int32 _type);
	public: virtual ~GetDataFromSlotAction(void);
