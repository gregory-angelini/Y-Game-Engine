#ifndef MOVETILEFROMTOACTION_H
#define MOVETILEFROMTOACTION_H
...
class MoveTileFromToAction: public AbstractAction
{
	...
	private: MoveTileFromToAction(void);
	private: MoveTileFromToAction(int32 _type);
	public: virtual ~MoveTileFromToAction(void);
