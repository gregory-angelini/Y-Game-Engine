#include "MoveTileFromToAction.h"
...
MoveTileFromToAction::MoveTileFromToAction(void)
{}


MoveTileFromToAction::MoveTileFromToAction(int32 _type): AbstractAction(_type)
{}
...
void MoveTileFromToAction::UpdateValid(void)
{
	valid = false; 
...
void MoveTileFromToAction::SetVariableArg(int32 _index, StringANSI _name)
{
	switch(_index)
	{
		case ARG1:
			...
			if(arg1.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::Arg1IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg2.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::Arg2IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(arg3.IsEmpty())
			{
				if(object)
				{
					...
					{ 
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::Arg3IsRenamed));
							UpdateValid();
						}
						return;
					}
			...
			if(target.IsEmpty())
			{
				if(object)
				{
					if(object->IsClassPropertyExist(TiledSpace3D::TILED_SPACE_3D_CLASS)) 
					{
						...
						{
							object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::ObjectIsDestroyed));
							object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::TargetIsRenamed));
							UpdateValid();
						}
						return;
					}
...
void MoveTileFromToAction::SetTemplateArg(int32 _index, StringANSI _expr)
{
	switch(_index)
	{
		case ARG1:
		{
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::TemplateArg1IsCompleted));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::Arg1IsLost));
			templateArg1.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::TemplateArg1IsChanged));
		...
		case ARG2:
		{
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::TemplateArg2IsCompleted));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::Arg2IsLost));
			templateArg2.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::TemplateArg2IsChanged));
		...
		case ARG3:
		{ 
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::TemplateArg3IsCompleted));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::Arg3IsLost));
			templateArg3.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::TemplateArg3IsChanged));
		...
		case TARGET:
		{
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_COMPLETED_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::TemplateTargetIsCompleted));
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_VARIABLE_LOSS_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::TargetIsLost));
			templateTarget.Connect(StringExprParserEx::STRING_EXPR_CHANGE_VALUE_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::TemplateTargetIsChanged));
...
void MoveTileFromToAction::SetVector3KeyArg(int32 _index, Vector3 _value)
{
	switch(_index)
	{
		case ARG1:
...
void MoveTileFromToAction::TemplateArg1IsCompleted(void)
{
...
void MoveTileFromToAction::Arg1IsLost(void)
{
	if(arg1.IsNotEmpty())
	{ 
	...
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::ObjectIsCreated));
	valid = false;
}



void MoveTileFromToAction::TemplateArg1IsChanged(void)
{
	Arg1IsLost();
...
void MoveTileFromToAction::TemplateArg2IsCompleted(void)
{
...
void MoveTileFromToAction::Arg2IsLost(void)
{
	if(arg2.IsNotEmpty())
	{ 
...
void MoveTileFromToAction::TemplateArg2IsChanged(void)
{
	Arg2IsLost();
...
void MoveTileFromToAction::TemplateArg3IsCompleted(void)
{
...
void MoveTileFromToAction::Arg3IsLost(void)
{
	if(arg3.IsNotEmpty())
	{ 
...
void MoveTileFromToAction::TemplateArg3IsChanged(void)
{
	Arg3IsLost();
...
void MoveTileFromToAction::TemplateTargetIsCompleted(void)
{
...
void MoveTileFromToAction::TargetIsLost(void)
{
...
void MoveTileFromToAction::TemplateTargetIsChanged(void)
{
	TargetIsLost();
...
StringANSI MoveTileFromToAction::GetTemplateArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
Vector3 MoveTileFromToAction::GetVector3KeyArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
StringANSI MoveTileFromToAction::GetVariableArg(int32 _index)
{
	switch(_index)
	{
		case ARG1:
...
void MoveTileFromToAction::operator () (void)
{
	if(IsValid())
	{
		arg3.Get()->SetValue(target.Get()->MoveTileFromTo(arg1.Get()->GetPosition(), arg2.Get()->GetPosition()));
	} 
	else if(target.IsNotEmpty() && arg1.IsNotEmpty() && arg2.IsNotEmpty())
	{
		target.Get()->MoveTileFromTo(arg1.Get()->GetPosition(), arg2.Get()->GetPosition());
	}
}



void MoveTileFromToAction::ObjectIsDestroyed(AbstractObject* _object)
{
	AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::ObjectIsCreated));
	valid = false;
}
...
void MoveTileFromToAction::Arg1IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg1IsLost();
}
...
void MoveTileFromToAction::Arg2IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg2IsLost();
}


void MoveTileFromToAction::Arg3IsRenamed(AbstractObject::NameInfo* _info)
{
	Arg3IsLost();
}


void MoveTileFromToAction::TargetIsRenamed(AbstractObject::NameInfo* _info)
{
	TargetIsLost();
}


void MoveTileFromToAction::ObjectIsCreated(AbstractObject* _object)
{
	if(target.IsEmpty())
	{
		if(state[TEMPLATE][TARGET])
		{
			...
			{ 
				if(templateTarget.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateTarget.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::TargetIsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG1])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg1.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg1.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::Arg1IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG2])
		{
			if(_object->IsClassPropertyExist(TranslatableObject::TRANSLATABLE_OBJECT_CLASS))
			{
				if(templateArg2.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg2.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::Arg2IsRenamed));
						UpdateValid();
					}
					return;
				}
		...
		if(state[TEMPLATE][ARG3])
		{
			if(_object->IsClassPropertyExist(Variable<bool>::BOOLEAN_VARIABLE_CLASS))
			{
				if(templateArg3.GetCurrentError() == StringExprParserEx::NO_ERRORS && templateArg3.GetResult() == _object->GetName())
				{
					...
					{
						_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::ObjectIsDestroyed));
						_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &MoveTileFromToAction::Arg3IsRenamed));
						UpdateValid();
					}
					return;
				}
...
bool MoveTileFromToAction::SaveToFile(StringANSI _path)			
{
	if(_path.empty())
	{
...
bool MoveTileFromToAction::SaveToFile(File& _file)
{
...
AbstractAction* MoveTileFromToAction::_LoadFromFile(File& _file)
{
	MoveTileFromToAction* action = new MoveTileFromToAction(TiledSpace3D::MOVE_TILE_FROM_TO_MESSAGE);
	StringANSI name;
	int32 length;
	_file.Read(length);
