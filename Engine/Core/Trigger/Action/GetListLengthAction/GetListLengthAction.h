#ifndef GETLISTLENGTHACTION_H
#define GETLISTLENGTHACTION_H
...
class GetListLengthAction: public AbstractAction
{
	...
	private: GetListLengthAction(void);
	private: GetListLengthAction(int32 _type);
	public: virtual ~GetListLengthAction(void);
