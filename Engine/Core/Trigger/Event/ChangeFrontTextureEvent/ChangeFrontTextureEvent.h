#ifndef CHANGEFRONTTEXTUREEVENT_H
#define CHANGEFRONTTEXTUREEVENT_H
...
class ChangeFrontTextureEvent: public AbstractEvent
{
	...
	private: ChangeFrontTextureEvent(void);
	private: ChangeFrontTextureEvent(int32 _type);
	public: virtual ~ChangeFrontTextureEvent(void);
