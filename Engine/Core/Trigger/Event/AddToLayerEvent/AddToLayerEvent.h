#ifndef ADDTOLAYEREVENT_H
#define ADDTOLAYEREVENT_H
...
class AddToLayerEvent: public AbstractEvent
{
	...
	private: AddToLayerEvent(void);
	private: AddToLayerEvent(int32 _type);
	public: virtual ~AddToLayerEvent(void);
