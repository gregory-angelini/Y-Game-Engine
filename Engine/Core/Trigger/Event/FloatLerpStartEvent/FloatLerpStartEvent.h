#ifndef FLOATLERPSTARTEVENT_H
#define FLOATLERPSTARTEVENT_H
...
class FloatLerpStartEvent: public AbstractEvent
{
	...
	private: FloatLerpStartEvent(void);
	private: FloatLerpStartEvent(int32 _type);
	public: virtual ~FloatLerpStartEvent(void);
