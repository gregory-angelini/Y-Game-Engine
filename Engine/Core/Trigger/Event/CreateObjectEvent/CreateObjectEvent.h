#ifndef CREATEOBJECTEVENT_H
#define CREATEOBJECTEVENT_H
...
class CreateObjectEvent: public AbstractEvent
{
	...
	private: CreateObjectEvent(void);
	private: CreateObjectEvent(int32 _type);
	public: virtual ~CreateObjectEvent(void);
