#ifndef CHANGEPLAYINGSTATEEVENT_H
#define CHANGEPLAYINGSTATEEVENT_H
...
class ChangePlayingStateEvent: public AbstractEvent
{
	...
	private: ChangePlayingStateEvent(void);
	private: ChangePlayingStateEvent(int32 _type);
	public: virtual ~ChangePlayingStateEvent(void);
