#ifndef CHANGEFRONTTEXTUREDANIMATIONEVENT_H
#define CHANGEFRONTTEXTUREDANIMATIONEVENT_H
...
class ChangeFrontTexturedAnimationEvent: public AbstractEvent
{
	...
	private: ChangeFrontTexturedAnimationEvent(void);
	private: ChangeFrontTexturedAnimationEvent(int32 _type);
	public: virtual ~ChangeFrontTexturedAnimationEvent(void);
