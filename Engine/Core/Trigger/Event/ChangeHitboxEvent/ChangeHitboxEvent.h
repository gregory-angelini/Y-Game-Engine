#ifndef CHANGEHITBOXEVENT_H
#define CHANGEHITBOXEVENT_H
...
class ChangeHitboxEvent: public AbstractEvent
{
	...
	private: ChangeHitboxEvent(void);
	private: ChangeHitboxEvent(int32 _type);
	public: virtual ~ChangeHitboxEvent(void);
