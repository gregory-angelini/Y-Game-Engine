#ifndef ADDTORENDERLISTEVENT_H
#define ADDTORENDERLISTEVENT_H
...
class AddToRenderListEvent: public AbstractEvent
{
	...
	private: AddToRenderListEvent(void);
	private: AddToRenderListEvent(int32 _type);
	public: virtual ~AddToRenderListEvent(void);
