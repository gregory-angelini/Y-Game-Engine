#ifndef CHANGEATLASEVENT_H
#define CHANGEATLASEVENT_H
...
class ChangeAtlasEvent: public AbstractEvent
{
	...
	private: ChangeAtlasEvent(void);
	private: ChangeAtlasEvent(int32 _type);
	public: virtual ~ChangeAtlasEvent(void);
