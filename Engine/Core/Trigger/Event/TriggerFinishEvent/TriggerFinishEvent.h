#ifndef TRIGGERFINISHEVENT_H
#define TRIGGERFINISHEVENT_H
...
class TriggerFinishEvent: public AbstractEvent
{
	friend class Trigger;
	friend class AbstractEvent;
	private: StringANSI sourceName;
	private: StringExprParserEx templateSource;
	private: MagicPointer<Trigger> source;
	private: TriggerFinishEvent(void);
	private: TriggerFinishEvent(int32 _type);
	public: virtual ~TriggerFinishEvent(void);
