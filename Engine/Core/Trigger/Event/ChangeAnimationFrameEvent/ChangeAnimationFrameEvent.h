#ifndef CHANGEANIMATIONFRAMEEVENT_H
#define CHANGEANIMATIONFRAMEEVENT_H
...
class ChangeAnimationFrameEvent: public AbstractEvent
{
	...
	private: MagicPointer<AbstractAnimation> source;
	private: ChangeAnimationFrameEvent(void);
	private: ChangeAnimationFrameEvent(int32 _type);
	public: virtual ~ChangeAnimationFrameEvent(void);
