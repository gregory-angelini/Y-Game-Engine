#ifndef CHANGEBACKTEXTUREEVENT_H
#define CHANGEBACKTEXTUREEVENT_H
...
class ChangeBackTextureEvent: public AbstractEvent
{
	...
	private: ChangeBackTextureEvent(void);
	private: ChangeBackTextureEvent(int32 _type);
	public: virtual ~ChangeBackTextureEvent(void);
