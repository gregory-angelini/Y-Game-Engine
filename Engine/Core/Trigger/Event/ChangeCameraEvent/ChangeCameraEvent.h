#ifndef CHANGECAMERAEVENT_H
#define CHANGECAMERAEVENT_H
...
class ChangeCameraEvent: public AbstractEvent
{
	...
	private: MagicPointer<GraphicsContainer> source;
	private: ChangeCameraEvent(void);
	private: ChangeCameraEvent(int32 _type);
	public: virtual ~ChangeCameraEvent(void);
