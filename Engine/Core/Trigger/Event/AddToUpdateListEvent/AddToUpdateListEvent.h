#ifndef ADDTOUPDATELISTEVENT_H
#define ADDTOUPDATELISTEVENT_H
...
class AddToUpdateListEvent: public AbstractEvent
{
	...
	private: AddToUpdateListEvent(void);
	private: AddToUpdateListEvent(int32 _type);
	public: virtual ~AddToUpdateListEvent(void);
