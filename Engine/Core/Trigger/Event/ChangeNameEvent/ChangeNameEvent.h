#ifndef CHANGENAMEEVENT_H
#define CHANGENAMEEVENT_H
...
class ChangeNameEvent: public AbstractEvent
{
	...
	private: ChangeNameEvent(void);
	private: ChangeNameEvent(int32 _type);
	public: virtual ~ChangeNameEvent(void);
