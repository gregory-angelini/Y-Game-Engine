#ifndef ARITHMETICEXPRPARSEREX_H
#define ARITHMETICEXPRPARSEREX_H
...
class ArithmeticExprParserEx: public AbstractObject
{
	...
	public: class Token
	{
		...
		friend class ArithmeticExprParserEx;
    ...
    private: Type result;
	public: ArithmeticExprParserEx(void)
	{
	...
	private: void VariableIsDestroyed(AbstractObject* _object)
	{
		...
		AssetLibrary::_GetAssets().Connect(AssetLibrary::CREATE_OBJECT_MESSAGE, this, Caller<>(this, &ArithmeticExprParserEx::VariableIsCreated));
	}
	...
	private: void VariableIsCreated(AbstractObject* _object)
	{
		if(IsUndefinedVariable(_object->GetName()))
		{
			...
			{
				_object->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &ArithmeticExprParserEx::VariableIsDestroyed));
				_object->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &ArithmeticExprParserEx::VariableIsRenamed));
	...
	{ 
		...
		for(SimpleList<Token>::Node* token = tokens.GetHead(); token != NIL; token = token->GetRight())
		{
			...
			{ 
				...
				if(it)
				{
					it->Connect(AbstractObject::DESTROY_OBJECT_MESSAGE, this, Caller<>(this, &ArithmeticExprParserEx::VariableIsDestroyed));
					it->Connect(AbstractObject::CHANGE_NAME_MESSAGE, this, Caller<>(this, &ArithmeticExprParserEx::VariableIsRenamed));
...
template<> class ArithmeticExprParserEx<float>: public AbstractObject
{
	private: class Operation
	{
		public: StringANSI value;
...
template<> class ArithmeticExprParserEx<int32>: public AbstractObject
{
	private: class Operation
	{
		public: StringANSI value;
