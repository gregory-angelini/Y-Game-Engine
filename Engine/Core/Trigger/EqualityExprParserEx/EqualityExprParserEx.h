#ifndef EQUALITYEXPRPARSEREX_H
#define EQUALITYEXPRPARSEREX_H
...
class EqualityExprParserEx: public AbstractObject
{
	...
	public: class Token
	{
		...
		friend class EqualityExprParserEx;
    ...
    private: bool result;
	public: EqualityExprParserEx(void);
	public: ~EqualityExprParserEx(void);
